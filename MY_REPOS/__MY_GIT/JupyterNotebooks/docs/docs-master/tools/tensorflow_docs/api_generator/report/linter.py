...
def lint_description(page_info: parser.PageInfo) -> api_report_pb2.DescriptionLint:
...
def lint_usage_example(page_info: parser.PageInfo) -> api_report_pb2.UsageExampleLint:
...
def lint_returns(page_info: parser.PageInfo) -> Optional[api_report_pb2.ReturnLint]:
