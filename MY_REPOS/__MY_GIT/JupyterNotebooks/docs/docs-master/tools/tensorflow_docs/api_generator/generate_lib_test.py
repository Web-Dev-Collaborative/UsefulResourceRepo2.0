...
class GenerateTest(absltest.TestCase):
    ...
    def get_test_objects(self):
        ...
        index = {
            ...
            "tf.TestModule.TestClass.ChildClass.GrandChildClass": TestClass.ChildClass.GrandChildClass,
        }
    ...
    def test_write(self):
        ...
        self.assertEqual(
            test_function_toc["path"], "/api_docs/python/tf/TestModule/test_function"
        )
        ...
        self.assertTrue((output_dir / "tf/TestModule/TestClass/ChildClass.md").exists())
        self.assertTrue(
            (
    ...
    def test_replace_refes(self):
        ...
        generate_lib.replace_refs(
            test_in_dir, test_out_dir, [reference_resolver], ["api_docs/python"], "*.md"
        )
