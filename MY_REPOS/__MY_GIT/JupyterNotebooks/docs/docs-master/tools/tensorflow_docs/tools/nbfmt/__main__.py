...
flags.DEFINE_bool("remove_outputs", False, "Remove output cells from the notebook")
flags.DEFINE_bool("test", False, "Test if the notebook is formatted (useful for CI).")
...
def _clean_metadata_colab(cell_metadata: Dict[str, Any], remove_outputs: bool) -> None:
...
def clean_cells(data: Dict[str, Any], nb_source: str, remove_outputs: bool) -> None:
