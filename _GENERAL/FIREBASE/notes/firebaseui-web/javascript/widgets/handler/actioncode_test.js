...
function testHandlePasswordReset() {
  ...
  app
    ...
    .then(function () {
      ...
      app
        .getAuth()
        .assertConfirmPasswordReset(["PASSWORD_RESET_ACTION_CODE", "123123"]);
...
function testHandlePasswordReset_weakPasswordError() {
  ...
  app
    ...
    .then(function () {
      ...
      app
        .getAuth()
        .assertConfirmPasswordReset(
          ["PASSWORD_RESET_ACTION_CODE", "123"],
          null,
          error
        );
      return app.getAuth().process();
  ...
  return app
    ...
    .then(function () {
      ...
      assertInfoBarMessage(
        firebaseui.auth.soy2.strings.errorSendPasswordReset().toString()
      );
      // Reset current rendered widget page.
      app.getAuth().assertSignOut([]);
      app.reset();
...
function testHandleRevertSecondFactorAddition_resetPassword_success() {
  ...
  app
    .getAuth()
    .assertCheckActionCode(["REVERT_SECOND_FACTOR_ADDITION_ACTION_CODE"], {
      data: {
        email: "user@example.com",
  ...
  app
    .getAuth()
    .assertApplyActionCode(["REVERT_SECOND_FACTOR_ADDITION_ACTION_CODE"]);
  return app
    .getAuth()
    .process()
    .then(() => {
