      ...
      if (results && results.length) {
        ...
        $.each(results, function (index, value) {
          ...
          this_li = find_value_and_highlight_term(
            this_li,
            value[settings.propertyToSearch],
            query
          );
      ...
      if (cached_results) {
        ...
        if (settings.url) {
          ...
          ajax_params.success = function (results) {
            ...
            cache.add(
              cache_key,
              settings.jsonContainer ? results[settings.jsonContainer] : results
            );
            ...
            if (input_box.val().toLowerCase() === query) {
              populate_dropdown(
                query,
                settings.jsonContainer
                  ? results[settings.jsonContainer]
                  : results
              );
            }
          };
