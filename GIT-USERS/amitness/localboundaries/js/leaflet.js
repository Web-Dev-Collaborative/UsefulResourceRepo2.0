  ...
  (o.Mixin = {}),
      ...
      removeClass: function (t, e) {
        t.classList !== i
          ...
          : o.DomUtil._setClass(
              t,
              o.Util.trim(
                (" " + o.DomUtil._getClass(t) + " ").replace(" " + e + " ", " ")
              )
            );
      },
    ...
    (o.Map = o.Class.extend({
      ...
      fitBounds: function (t, e) {
        ...
        return (
          (s = e && e.maxZoom ? Math.min(e.maxZoom, s) : s),
          this.setView(l, s, e)
        );
      },
      fitWorld: function (t) {
    ...
    (o.TileLayer = o.Class.extend({
      ...
      bringToFront: function () {
        ...
        return (
          this._container &&
            (t.appendChild(this._container), this._setAutoZIndex(t, Math.max)),
          this
        );
      },
      ...
      _setAutoZIndex: function (t, e) {
        ...
        for (n = 0, o = s.length; o > n; n++)
          s[n] !== this._container &&
            ((i = parseInt(s[n].style.zIndex, 10)), isNaN(i) || (a = e(a, i)));
    ...
    (o.Icon = o.Class.extend({
      ...
      _setIconStyles: function (t, e) {
        var i,
          ...
          s = o.point(n[e + "Size"]);
        (i = o.point(
          "shadow" === e ? n.shadowAnchor || n.iconAnchor : n.iconAnchor
        )),
    ...
    (o.Polyline = o.Path.extend({
      ...
      closestLayerPoint: function (t) {
        for (
          var e, i, n = 1 / 0, s = this._parts, a = null, r = 0, h = s.length;
          h > r;
          r++
        )
  ...
  o.Marker.include(a),
    ...
    (o.DomEvent = {
      ...
      disableClickPropagation: function (t) {
        for (
          var e = o.DomEvent.stopPropagation, i = o.Draggable.START.length - 1;
          i >= 0;
          i--
        )
    ...
    o.extend(o.DomEvent, {
      ...
      addDoubleTapListener: function (t, i, n) {
        ...
        return (
          ...
          o.Browser.pointer &&
            m.addEventListener(o.DomEvent.POINTER_CANCEL, a, !1),
          this
        );
      },
      ...
      run: function (t, e, i, n) {
        this.stop(),
          ...
          (t.style[o.DomUtil.TRANSITION] =
            "all " + (i || 0.25) + "s cubic-bezier(0,0," + (n || 0.5) + ",1)"),
          o.DomEvent.on(
            t,
            o.DomUtil.TRANSITION_END,
...
(function (t, e) {
  "function" == typeof define && define.amd
    ...
    e !== void 0 && e.L && (e.LeafletLabel = t(L));
})(function (t) {
  t.labelVersion = "0.2.4";
  var e = t.Class.extend({
    ...
    onAdd: function (e) {
      (this._map = e),
        (this._pane = this.options.pane
          ? e._panes[this.options.pane]
          : this._source instanceof t.Marker
          ? e._panes.markerPane
          : e._panes.popupPane),
        ...
        t.Browser.touch &&
          !this.options.noHide &&
          (t.DomEvent.on(this._container, "click", this.close, this),
          e.on("click", this.close, this));
    },
    onRemove: function (t) {
    ...
    setLatLng: function (e) {
      return (
        (this._latlng = t.latLng(e)), this._map && this._updatePosition(), this
      );
    },
    setContent: function (t) {
      return (
    ...
    close: function () {
      ...
      e &&
        (t.Browser.touch &&
          !this.options.noHide &&
          (t.DomEvent.off(this._container, "click", this.close),
          e.off("click", this.close, this)),
        e.removeLayer(this));
    },
    ...
    setOpacity: function (e) {
      (this.options.opacity = e),
        this._container && t.DomUtil.setOpacity(this._container, e);
    },
    _initLayout: function () {
    ...
    _setPosition: function (e) {
      var i = this._map,
        ...
        s = i.layerPointToContainerPoint(e),
        a = this.options.direction,
        l = this._labelWidth,
        h = t.point(this.options.offset);
      "right" === a || ("auto" === a && s.x < o.x)
        ? (t.DomUtil.addClass(n, "leaflet-label-right"),
          t.DomUtil.removeClass(n, "leaflet-label-left"),
          (e = e.add(h)))
        : (t.DomUtil.addClass(n, "leaflet-label-left"),
          t.DomUtil.removeClass(n, "leaflet-label-right"),
          (e = e.add(t.point(-h.x - l, h.y)))),
        t.DomUtil.setPosition(n, e);
    },
    _zoomAnimation: function (t) {
      var e = this._map
        ._latLngToNewLayerPoint(this._latlng, t.zoom, t.center)
    ...
    _initInteraction: function () {
      if (this.options.clickable) {
        ...
        t.DomUtil.addClass(e, "leaflet-clickable"),
          t.DomEvent.on(e, "click", this._onMouseClick, this);
        for (var n = 0; i.length > n; n++)
          t.DomEvent.on(e, i[n], this._fireMouseEvent, this);
      }
    },
    _removeInteraction: function () {
      if (this.options.clickable) {
        var e = this._container,
          i = ["dblclick", "mousedown", "mouseover", "mouseout", "contextmenu"];
        t.DomUtil.removeClass(e, "leaflet-clickable"),
          t.DomEvent.off(e, "click", this._onMouseClick, this);
        for (var n = 0; i.length > n; n++)
          t.DomEvent.off(e, i[n], this._fireMouseEvent, this);
      }
    },
    _onMouseClick: function (e) {
      this.hasEventListeners(e.type) && t.DomEvent.stopPropagation(e),
  ...
  return (
    (t.BaseMarkerMethods = {
      ...
      bindLabel: function (i, n) {
        var o = this.options.icon
            ? this.options.icon.options.labelAnchor
            : this.options.labelAnchor,
          s = t.point(o) || t.point(0, 0);
        return (
          (s = s.add(e.prototype.options.offset)),
          n && n.offset && (s = s.add(n.offset)),
          (n = t.Util.extend({ offset: s }, n)),
          (this._labelNoHide = n.noHide),
          this.label ||
          ...
          (this.label = new e(n, this).setContent(i)),
          this
        );
      },
      ...
      _addLabelRevealHandlers: function () {
        this.on("mouseover", this.showLabel, this).on(
          ...
          t.Browser.touch && this.on("click", this.showLabel, this);
      },
      _removeLabelRevealHandlers: function () {
        this.off("mouseover", this.showLabel, this).off(
          ...
          t.Browser.touch && this.off("click", this.showLabel, this);
      },
    ...
    t.Path.include({
      bindLabel: function (i, n) {
        return (
          (this.label && this.label.options === n) ||
            (this.label = new e(n, this)),
          this.label.setContent(i),
