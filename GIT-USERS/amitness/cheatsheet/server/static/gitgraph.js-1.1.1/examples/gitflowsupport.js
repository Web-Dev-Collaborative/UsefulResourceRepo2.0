...
master
  ...
  .merge(develop, { messageDisplay: false });
...
feature1
  .commit("A feature to go into v1.0.0")
  .commit({ messageDisplay: false });
...
feature2
  .commit("Another feature to go into v1.0.0")
  .commit({ messageDisplay: false });
...
develop.commit({ messageDisplay: false });
feature3
  .commit("A feature to go into v1.1.0")
  .commit({ messageDisplay: false });
...
develop.commit({ messageDisplay: false });
feature4
  .commit("A feature to go into v1.2.0")
  .commit({ messageDisplay: false });
...
support_11x
  .commit(bugfixCommit)
  .commit({ dotStrokeWidth: 10, message: "Release v1.1.2", tag: "v1.1.2" });
support_11x.merge(develop);
develop.commit({ messageDisplay: false });
...
develop.commit({ messageDisplay: false });
feature5
  .commit("Another feature to go into v1.2.0")
  .commit({ messageDisplay: false });
