!(function (e) {
  ...
  function s(e, t, a, o) {
    ...
    function m(e, t) {
      ...
      if (f(t, w))
        throw new Error(
          'Illegal lexeme "' + t + '" for mode "' + (w.cN || "<unnamed>") + '"'
        );
...
hljs.registerLanguage("matlab", function (e) {
  ...
  return {
    ...
    c: [
      ...
      { cN: "cell", b: "\\{", e: /\}/, c: a, r: 0, i: /:/, starts: s },
      { b: /\)/, r: 0, starts: s },
      { cN: "comment", b: "\\%", e: "$" },
    ].concat(a),
  };
...
hljs.registerLanguage("lisp", function (e) {
  var b =
    ...
    g = { eW: !0, r: 0 };
  return (
    (v.c = [{ cN: "keyword", v: [{ b: b }, { b: c }] }, g]),
    (g.c = [s, f, v, a, i, l, n, N, d, o]),
    { i: /\S/, c: [i, t, a, l, n, s, f, v] }
  );
});
