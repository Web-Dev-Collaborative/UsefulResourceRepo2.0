...
accuracyGraph.prototype.initializeGraph = function (containerElement, data) {
  ...
  var x0 = d3.scaleBand().rangeRound([0, this.width]).paddingInner(0.1);
  ...
  var y0 = d3.scaleBand().rangeRound([this.height, 0]).paddingInner(0.1);
  ...
  this.g
    ...
    .attr("transform", function (d) {
      return "translate(0, " + y0(d.hiddenNodes) + ")";
    })
    .selectAll("rect")
    .data(function (d) {
...
var accuracyScores = [
  { hiddenNodes: 0, score: 68.0, validationScore: 70.79 },
