(function (root, factory) {
  ...
  d3.selection.prototype.translate = function (xy) {
    return this.attr("transform", function (d, i) {
      return (
        "translate(" +
        [typeof xy == "function" ? xy.call(this, d, i) : xy] +
        ")"
      );
    });
  };
  ...
  d3.selection.prototype.append = function (name) {
    ...
    for (var name in n.attr) {
      s.attr(name, n.attr[name]);
    }
    return s;
  };
  ...
  if (typeof window !== "undefined" && !window.hasOwnProperty("ƒ"))
    window.ƒ = d3.f;
