define([
  ...
  var Renderer = function () {
    ...
    var tplButton = function (label, options) {
      ...
      return (
        (dropdown
          ? '<div class="btn-group' + (className ? " " + className : "") + '">'
          : "") +
        '<button type="button"' +
    ...
    var tplButtonInfo = {
      ...
      fontname: function (lang, options) {
        ...
        var items = options.fontNames.reduce(function (memo, v) {
          if (
            !agent.isFontInstalled(v) &&
            !list.contains(options.fontNamesIgnoreCheck, v)
          ) {
            return memo;
          }
          realFontList.push(v);
        ...
        var defaultFontName = hasDefaultFont
          ? options.defaultFontName
          : realFontList[0];

        var label =
          '<span class="note-current-fontname">' + defaultFontName + "</span>";
      ...
      underline: function (lang, options) {
        return tplIconButton(
          options.iconPrefix + options.icons.font.underline,
          {
            event: "underline",
      ...
      strikethrough: function (lang, options) {
        return tplIconButton(
          options.iconPrefix + options.icons.font.strikethrough,
          {
            event: "strikethrough",
      ...
      superscript: function (lang, options) {
        return tplIconButton(
          options.iconPrefix + options.icons.font.superscript,
          {
            event: "superscript",
      ...
      subscript: function (lang, options) {
        return tplIconButton(
          options.iconPrefix + options.icons.font.subscript,
          {
            event: "subscript",
      ...
      ul: function (lang, options) {
        return tplIconButton(
          options.iconPrefix + options.icons.lists.unordered,
          {
      ...
      paragraph: function (lang, options) {
        var leftButton = tplIconButton(
          options.iconPrefix + options.icons.paragraph.left,
          {
        ...
        var centerButton = tplIconButton(
          options.iconPrefix + options.icons.paragraph.center,
          {
        ...
        var rightButton = tplIconButton(
          options.iconPrefix + options.icons.paragraph.right,
          {
        ...
        var justifyButton = tplIconButton(
          options.iconPrefix + options.icons.paragraph.justify,
          {
        ...
        var outdentButton = tplIconButton(
          options.iconPrefix + options.icons.paragraph.outdent,
          {
        ...
        var indentButton = tplIconButton(
          options.iconPrefix + options.icons.paragraph.indent,
          {
        ...
        return tplIconButton(
          options.iconPrefix + options.icons.paragraph.paragraph,
          {
      ...
      fullscreen: function (lang, options) {
        return tplIconButton(
          options.iconPrefix + options.icons.options.fullscreen,
          {
            event: "fullscreen",
      ...
      codeview: function (lang, options) {
        return tplIconButton(
          options.iconPrefix + options.icons.options.codeview,
          {
            event: "codeview",
    ...
    var tplPopovers = function (lang, options) {
      var tplLinkPopover = function () {
        var linkButton = tplIconButton(
          options.iconPrefix + options.icons.link.edit,
          {
        ...
        var unlinkButton = tplIconButton(
          options.iconPrefix + options.icons.link.unlink,
          {
      ...
      var tplImagePopover = function () {
        ...
        var leftButton = tplIconButton(
          options.iconPrefix + options.icons.image.floatLeft,
          {
        ...
        var rightButton = tplIconButton(
          options.iconPrefix + options.icons.image.floatRight,
          {
        ...
        var justifyButton = tplIconButton(
          options.iconPrefix + options.icons.image.floatNone,
          {
        ...
        var roundedButton = tplIconButton(
          options.iconPrefix + options.icons.image.shapeRounded,
          {
        ...
        var circleButton = tplIconButton(
          options.iconPrefix + options.icons.image.shapeCircle,
          {
        ...
        var thumbnailButton = tplIconButton(
          options.iconPrefix + options.icons.image.shapeThumbnail,
          {
        ...
        var noneButton = tplIconButton(
          options.iconPrefix + options.icons.image.shapeNone,
          {
        ...
        var removeButton = tplIconButton(
          options.iconPrefix + options.icons.image.remove,
          {
    ...
    var tplShortcut = function (title, keys) {
      ...
      return (
        '<div class="note-shortcut-row row"><div class="' +
        keyClass +
        'title col-xs-offset-6">' +
        title +
        "</div></div>" +
        '<div class="note-shortcut-row row">' +
        body.join('</div><div class="note-shortcut-row row">') +
        "</div>"
      );
    };
    ...
    var tplShortcutTable = function (lang, options) {
      ...
      if (options.extraKeys) {
        template.push(
          "<div " + colClass + ">" + tplExtraShortcuts(lang, options) + "</div>"
        );
      }
    ...
    var tplDialogInfo = {
      image: function (lang, options) {
        ...
        if (options.maximumImageFileSize) {
          ...
          var readableSize =
            (options.maximumImageFileSize / Math.pow(1024, unit)).toFixed(2) *
              1 +
            " " +
            " KMGTP"[unit] +
            "B";
