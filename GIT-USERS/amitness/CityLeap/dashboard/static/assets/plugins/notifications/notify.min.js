...
(function (t, i, n, e) {
  ...
  (S = "notify"),
    ...
    (F = ["t", "m", "b"]),
    (b = ["t", "b", "l", "r"]),
    (v = { t: "b", m: null, b: "t", l: "r", c: null, r: "l" }),
    (x = function (t) {
      var i;
      return (
        (i = []),
        n.each(t.split(/\W+/), function (t, n) {
          var o;
    ...
    (r = function (i, e) {
      ...
      return (
        (null != (a = D[i]) ? a.cssElem : void 0) &&
          (t.console &&
            console.warn("" + S + ": overwriting style '" + i + "'"),
          D[i].cssElem.remove()),
        (e.name = i),
        (D[i] = e),
        (o = ""),
        e.classes &&
          n.each(e.classes, function (t, i) {
            return (
              (o += "." + C + "-" + e.name + "-" + t + " {\n"),
              n.each(i, function (t, i) {
                return (
                  H[t] &&
                    n.each(H[t], function (n, e) {
                      return (o += "  " + e + t + ": " + i + ";\n");
                    }),
                  (o += "  " + t + ": " + i + ";\n")
                );
        ...
        o && ((e.cssElem = y(o)), e.cssElem.attr("id", "notify-" + e.name)),
        (s = {}),
        (r = n(e.html)),
        u("html", r, s),
        u("text", r, s),
    ...
    (o = (function () {
      function t(t, i, e) {
        "string" == typeof e && (e = { className: e }),
          (this.options = g(E, n.isPlainObject(e) ? e : {})),
          this.loadHTML(),
          (this.wrapper = n(a.html)),
          this.wrapper.data(C, this),
          (this.arrow = this.wrapper.find("." + C + "-arrow")),
          (this.container = this.wrapper.find("." + C + "-container")),
          this.container.append(this.userContainer),
          t &&
            t.length &&
            ((this.elementType = t.attr("type")),
            (this.originalElement = t),
            (this.elem = d(t)),
            this.elem.data(C, this),
      ...
      return (
        ...
        (t.prototype.show = function (t, i) {
          ...
          if (
            ...
            (a = this.container.parent().parents(":hidden").length > 0),
            (r = this.container.add(this.arrow)),
            (n = []),
            a && t)
          )
            s = "show";
          ...
          return (
            ...
            i ||
              ...
              "middle" === t
                ...
                ? (e.left = "45%")
                : (e[t] = 0),
              i.css(e).addClass("" + C + "-corner"),
              n("body").append(i)),
            i.prepend(this.wrapper)
          );
        }),
        (t.prototype.setElementPosition = function () {
          ...
          for (
            ...
            (H = U[B]),
              (g = parseInt(this.elem.css("margin-" + H), 10)),
              g && w(l, H, g);
          if (
            ((f = Math.max(
              0,
            ...
            for (
              ...
              (H = b[R]),
                ...
                H !== y &&
                  ((r = D === A ? t : "transparent"),
                  (i["border-" + D] = "" + o + "px solid " + r));
            w(l, M[y], o), T.call(b, C) >= 0 && w(i, M[C], 2 * o);
          } else this.arrow.hide();
          return (
            T.call(F, E) >= 0
              ? (w(l, "left", k(C, a, d)), i && w(i, "left", k(C, o, p)))
              : T.call(m, E) >= 0 &&
                (w(l, "top", k(C, s, h)), i && w(i, "top", k(C, o, c))),
            this.container.is(":visible") && (l.display = "block"),
            this.container.removeAttr("style").css(l),
            i ? this.arrow.removeAttr("style").css(i) : e
          );
        }),
        (t.prototype.getPosition = function () {
          ...
          if (
            ...
            throw "Must be one of [" + b + "]";
          return (
            (1 === t.length ||
              ((e = t[0]),
              T.call(F, e) >= 0 && ((o = t[1]), 0 > T.call(m, o))) ||
              ((r = t[0]),
              T.call(m, r) >= 0 && ((s = t[1]), 0 > T.call(F, s)))) &&
              (t[1] = ((a = t[0]), T.call(m, a) >= 0 ? "m" : "l")),
            2 === t.length && (t[2] = t[1]),
            t
          );
        }),
        ...
        (t.prototype.updateClasses = function () {
          ...
          return (
            (t = ["base"]),
            n.isArray(this.options.className)
              ? (t = t.concat(this.options.className))
              : this.options.className && t.push(this.options.className),
            (i = this.getStyle()),
            (t = n
              .map(t, function (t) {
                return "" + C + "-" + i.name + "-" + t;
        ...
        (t.prototype.run = function (t, i) {
          ...
          if (
            (n.isPlainObject(i)
              ...
              : "string" === n.type(i) && (this.options.className = i),
            this.container && !t)
          )
            return this.show(!1), e;
          if (this.container || t) {
                ...
                l &&
                  ("text" === l &&
                    ...
                    this.options.breakNewLines &&
                      (o = o.replace(/\n/g, "<br/>"))),
                  (h = a === s ? "" : "=" + a),
                  p(this.userContainer, "[data-notify-" + l + h + "]").html(o));
            return (
              this.updateClasses(),
    ...
    (n[S] = function (t, i, e) {
      return (
        (t && t.nodeName) || t.jquery
          ? n(t)[S](i, e)
          : ((e = i), (i = t), new o(null, i, e)),
        t
      );
    }),
    (n.fn[S] = function (t, i) {
      return (
        n(this).each(function () {
          var e;
          return (
            (e = d(n(this)).data(C)), e ? e.run(t, i) : new o(n(this), t, i)
          );
        }),
        this
      );
    ...
    n(function () {
      return (
        y(a.css).attr("id", "core-notify"),
        n(i).on("click notify-hide", "." + C + "-wrapper", function (t) {
          var i;
          return (
            (i = n(this).data(C)),
            i && (i.options.clickToHide || "notify-hide" === t.type)
              ? i.show(!1)
              : e
          );
        })
