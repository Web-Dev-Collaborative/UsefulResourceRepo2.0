    ...
    _initField: function (field) {
      ...
      for (var i = 0; i < total; i++) {
        ...
        for (validatorName in this.options.fields[field].validators) {
          ...
          if (
            "function" ===
            typeof $.fn.bootstrapValidator.validators[validatorName].init
          ) {
          ...
          if ("object" === typeof validateResult && validateResult.resolve) {
            ...
            validateResult.done(function ($f, v, response) {
              ...
              that.updateStatus(
                ...
                response.valid ? that.STATUS_VALID : that.STATUS_INVALID,
                v
              );
          ...
          case this.STATUS_VALID:
            ...
            isValidField =
              $allErrors.filter(
                ...
                ? $allErrors.filter(
                    '[data-bv-result="' + this.STATUS_VALID + '"]'
      ...
      for (field in this.options.fields) {
        ...
        for (var i = 0; i < fields.length; i++) {
          ...
          for (validator in this.options.fields[field].validators) {
            ...
            if (
              "function" ===
              typeof $.fn.bootstrapValidator.validators[validator].destroy
            ) {
              $.fn.bootstrapValidator.validators[validator].destroy(
                this,
                $field,
                this.options.fields[field].validators[validator]
              );
