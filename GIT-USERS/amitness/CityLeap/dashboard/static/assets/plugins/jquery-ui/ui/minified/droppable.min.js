    ...
    (t.ui.intersect = (function () {
      ...
      return function (e, i, s, o) {
        ...
        var n = (e.positionAbs || e.position.absolute).left + e.margins.left,
          ...
          u = p + i.proportions().height;
        switch (s) {
          case "fit":
            return n >= h && c >= a && r >= p && u >= l;
          case "intersect":
            return (
              n + e.helperProportions.width / 2 > h &&
              c > a - e.helperProportions.width / 2 &&
              r + e.helperProportions.height / 2 > p &&
              u > l - e.helperProportions.height / 2
            );
          case "pointer":
            return (
              t(o.pageY, p, i.proportions().height) &&
              t(o.pageX, h, i.proportions().width)
            );
          case "touch":
            return (
              ((r >= p && u >= r) || (l >= p && u >= l) || (p > r && l > u)) &&
              ((n >= h && c >= n) || (a >= h && c >= a) || (h > n && a > c))
            );
          default:
            return !1;
        }
        ...
        t: for (s = 0; n.length > s; s++)
          if (
            !(
              ...
              (e &&
                !n[s].accept.call(n[s].element[0], e.currentItem || e.element))
            )
          ) {
