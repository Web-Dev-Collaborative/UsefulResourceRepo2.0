      ...
      (d.style.cssText = "background-color:rgba(1,1,1,.5)"),
                ...
                ? (n instanceof l
                    ...
                    : f(c, function (e, s) {
                        ...
                        f(s.props, function (t, e) {
                          ...
                          p[o] &&
                            0 > t.inArray(null, p[o].slice(0, 3)) &&
                            ((p[o][3] = 1), s.from && (p._rgba = s.from(p[o])));
                      }),
                  this)
                : e
            );
          ...
          return (
            (e =
              h === a
                ...
                ? (60 * (o - s)) / l + 120
                : (60 * (s - n)) / l + 240),
            (i = 0 === l ? 0 : 0.5 >= p ? l / c : l / (2 - c)),
            [Math.round(e) % 360, i, p, null == r ? 1 : r]
          );
        }),
        ...
        f(c, function (s, n) {
          var o = n.props,
            ...
            c = n.from;
          (l.fn[s] = function (s) {
            if ((h && !this[r] && (this[r] = h(this._rgba)), s === e))
              return this[r].slice();
            var n,
              a = t.type(s),
              p = "array" === a || "object" === a ? s : arguments,
              u = this[r].slice();
            return (
              f(o, function (t, e) {
                var s = p["object" === a ? t : e.idx];
                null == s && (s = u[e.idx]), (u[e.idx] = i(s, e));
              }),
              c ? ((n = l(c(u))), (n[r] = u), n) : l(u)
            );
          }),
            f(o, function (e, i) {
              l.fn[e] ||
    ...
    (function () {
      ...
      function s(e, i) {
        ...
        for (s in i)
          (n = i[s]),
            e[s] !== n &&
              (o[s] || ((t.fx.step[s] || !isNaN(parseFloat(n))) && (r[s] = n)));
        return r;
      }
        ...
        function (e, s) {
          t.fx.step[s] = function (t) {
            (("none" !== t.end && !t.setAttr) || (1 === t.pos && !t.setAttr)) &&
              (i.style(t.elem, s, t.end), (t.setAttr = !0));
          };
        }
      ),
        t.fn.addBack ||
