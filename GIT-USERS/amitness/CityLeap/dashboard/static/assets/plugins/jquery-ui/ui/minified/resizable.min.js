  ...
  return (
    t.widget("ui.resizable", t.ui.mouse, {
      ...
      _mouseCapture: function (e) {
        ...
        for (i in this.handles)
          (s = t(this.handles[i])[0]),
            (s === e.target || t.contains(s, e.target)) && (o = !0);
      ...
      _mouseStop: function (e) {
        ...
        return (
          this._helper &&
            ...
            (o = s && this._hasScroll(i[0], "left") ? 0 : p.sizeDiff.height),
      ...
      _respectSize: function (t) {
        ...
        return (
          ...
          r && p && (t.top = h - e.minHeight),
          o && p && (t.top = h - e.maxHeight),
      ...
      _getPaddingPlusBorderDimensions: function (t) {
        for (
          ...
          (i[e] = parseInt(s[e], 10) || 0), (i[e] += parseInt(o[e], 10) || 0);
    ...
    t.ui.plugin.add("resizable", "animate", {
      stop: function (e) {
        ...
        i.element.animate(t.extend(h, p && l ? { top: p, left: l } : {}), {
          ...
          step: function () {
            ...
            o && o.length && t(o[0]).css({ width: s.width, height: s.height }),
              i._updateCache(s),
    ...
    t.ui.plugin.add("resizable", "containment", {
      ...
      stop: function () {
        ...
        e._helper &&
          ...
          t(this).css({ left: a.left - o.left - s.left, width: h, height: l }),
          e._helper &&
            !i.animate &&
      ...
      resize: function (e, i) {
        ...
        t(o.alsoResize).each(function () {
          var e = t(this),
            ...
            o = {},
            n = e.parents(i.originalElement[0]).length
              ? ["width", "height"]
    ...
    t.ui.plugin.add("resizable", "grid", {
      resize: function () {
        var e,
          ...
          c = Math.round((o.height - n.height) / p) * p,
          u = n.width + d,
          f = n.height + c,
        ...
        (s.grid = h),
          ...
          /^(se|s|e)$/.test(a)
            ...
            : ((0 >= f - p || 0 >= u - l) &&
              ...
              u - l > 0
                ? ((i.size.width = u), (i.position.left = r.left - d))
                : ((u = l - e.width),
                  (i.size.width = u),
                  (i.position.left = r.left + n.width - u)));
      },
    }),
    t.ui.resizable
  );
