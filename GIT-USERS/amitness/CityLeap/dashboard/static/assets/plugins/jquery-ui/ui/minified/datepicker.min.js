  ...
  return (
    t.extend(i.prototype, {
        ...
        if (
          ...
          (s = t.datepicker._getInst(i)),
            ...
            r !== !1 &&
              ...
              t.datepicker._updateDatepicker(s),
              (h = t.datepicker._checkOffset(s, h, a)),
              s.dpDiv.css({
                position:
              ...
              s.inline ||
                ...
                t.datepicker._shouldFocusInput(s) && s.input.focus(),
                (t.datepicker._curInst = s)));
        }
      },
      ...
      parseDate: function (e, i, s) {
        ...
        if (
          ((a = this._daylightSavingAdjust(new Date(g, m - 1, v))),
      ...
      _generateHTML: function (t) {
        ...
        for (
          t.drawMonth = Z,
            ...
            a = this._get(t, "gotoCurrent") && t.currentDay ? V : j,
          ...
          for (D = "", this.maxRows = 4, C = 0; q[1] > C; C++) {
            if (
              ((x = this._daylightSavingAdjust(new Date(te, Z, t.selectedDay))),
              (I = " ui-corner-all"),
              (P = ""),
              Q)
            ) {
            ...
            for (
              P +=
                ...
                I +
                "'>" +
                (/all|left/.test(I) && 0 === k ? (L ? o : s) : "") +
                (/all|right/.test(I) && 0 === k ? (L ? s : o) : "") +
            ...
            for (
              P += M + "</tr></thead><tbody>",
                z = this._getDaysInMonth(te, Z),
                te === t.selectedYear &&
                  Z === t.selectedMonth &&
                  (t.selectedDay = Math.min(t.selectedDay, z)),
                N = (this._getFirstDayOfMonth(te, Z) - c + 7) % 7,
                T = Math.ceil((N + z) / 7),
                E = Q ? (this.maxRows > T ? this.maxRows : T) : T,
                this.maxRows = E,
                H = this._daylightSavingAdjust(new Date(te, Z, 1 - N)),
                A = 0;
              E > A;
              A++
            ) {
                ...
                (W = m ? m.apply(t.input ? t.input[0] : null, [H]) : [!0, ""]),
                  ...
                  (O +=
                    ...
                    ((H.getTime() === x.getTime() &&
                      Z === t.selectedMonth &&
                      t._keyEvent) ||
                    (b.getTime() === H.getTime() && b.getTime() === x.getTime())
                      ? " " + this._dayOverClass
                      : "") +
                    (R
