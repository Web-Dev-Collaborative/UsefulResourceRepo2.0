  ...
  BootstrapTable.prototype.initHeader = function () {
    ...
    $.each(this.options.columns, function (i, column) {
      ...
      if (!column.filterControl) {
        ...
        html.push(
          '<div style="margin: 0px 2px 2px 2px;" class="filterControl">'
        );
        ...
        switch (column.filterControl.toLowerCase()) {
          case "input":
            html.push(
              sprintf(
                '<input type="text" class="form-control" style="width: 100%; visibility: %s">',
                isVisible
              )
            );
            break;
          case "select":
            html.push(
              sprintf(
                '<select class="%s form-control" style="width: 100%; visibility: %s"></select>',
                column.field,
                isVisible
              )
            );
      ...
      if (
        ...
        var filterDataSource = column.filterData.substring(
          4,
