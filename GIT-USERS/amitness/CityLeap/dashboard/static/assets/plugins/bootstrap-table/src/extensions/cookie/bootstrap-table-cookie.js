...
(function ($) {
  ...
  var setCookie = function (that, cookieName, sValue, sPath, sDomain, bSecure) {
    if (
      !that.options.stateSave ||
      !cookieEnabled() ||
      that.options.stateSaveIdTable === ""
    ) {
      return;
    }
  ...
  BootstrapTable.prototype.initStateSave = function () {
    ...
    var sortOrderStateSave = getCookie(
        this.options.stateSaveIdTable,
        idsStateSaveList.sortOrder
      ),
      sortOrderStateName = getCookie(
        this.options.stateSaveIdTable,
        idsStateSaveList.sortName
      ),
      pageNumberStateSave = getCookie(
        this.options.stateSaveIdTable,
        idsStateSaveList.pageNumber
      ),
      pageListStateSave = getCookie(
        this.options.stateSaveIdTable,
        idsStateSaveList.pageList
      ),
      columnsStateSave = JSON.parse(
        getCookie(this.options.stateSaveIdTable, idsStateSaveList.columns)
      ),
      searchStateSave = getCookie(
        this.options.stateSaveIdTable,
        idsStateSaveList.searchText
      );
    ...
    if (pageListStateSave) {
      this.options.pageSize =
        pageListStateSave === this.options.formatAllRows()
          ? pageListStateSave
          : +pageListStateSave;
    }
