...
(function (factory) {
  ...
  var Repeater = function (element, options) {
    ...
    this.$search.on(
      "searched.fu.search cleared.fu.search",
      function (e, value) {
    ...
    this.$views
      .find("input")
      .on("change.fu.repeater", $.proxy(this.viewChanged, this));
  ...
  Repeater.prototype = {
    ...
    clear: function (options) {
      ...
      viewChanged =
        options.viewChanged !== undefined ? options.viewChanged : false;
    ...
    getDataOptions: function (options) {
      ...
      opts.filter =
        this.$filters.length > 0
          ? this.$filters.selectlist("selectedItem")
          : {
              text: "All",
              value: "all",
            };
      ...
      if (!this.infiniteScrollingEnabled) {
        opts.pageSize =
          this.$pageSize.length > 0
            ? parseInt(this.$pageSize.selectlist("selectedItem").value, 10)
            : 25;
      }
      ...
      if (options.dataSourceOptions) {
        ...
        if (options.preserveDataSourceOptions) {
          this.storedDataSourceOpts = this.storedDataSourceOpts
            ? $.extend(this.storedDataSourceOpts, dataSourceOptions)
            : dataSourceOptions;
        }
      }
    ...
    infiniteScrollPaging: function (data, options) {
      var end =
        this.infiniteScrollingEnd !== true
          ? this.infiniteScrollingEnd
          : undefined;
      var page = data.page;
    ...
    render: function (options) {
      ...
      options.preserve =
        options.preserve !== undefined ? options.preserve : !viewChanged;
      this.clear(options);

      if (
        !this.infiniteScrollingEnabled ||
        (this.infiniteScrollingEnabled && viewChanged)
      ) {
    ...
    resize: function () {
      var staticHeight =
        this.viewOptions.staticHeight === -1
          ? this.$element.attr("data-staticheight")
          : this.viewOptions.staticHeight;
      var viewTypeObj = {};
      ...
      if (
        ...
        height =
          (staticHeight === "true" || staticHeight === true
            ? this.$element.height()
            : parseInt(staticHeight, 10)) -
          this.$element.find(".repeater-header").outerHeight() -
          this.$element.find(".repeater-footer").outerHeight() -
          (viewportMargins.bottom === "auto"
            ? 0
            : parseInt(viewportMargins.bottom, 10)) -
          (viewportMargins.top === "auto"
            ? 0
            : parseInt(viewportMargins.top, 10));
      ...
      function addItem($parent, resp) {
        ...
        if (resp) {
          ...
          if (action !== "none" && resp.item !== undefined) {
            $parent =
              resp.container !== undefined ? $(resp.container) : $parent;
        ...
        if (viewTypeObj.renderItem) {
          ...
          if (repeat[0] === "data" || repeat[0] === "this") {
            ...
            if (window.console && window.console.warn) {
              window.console.warn(
                'WARNING: Repeater plugin "repeat" value must start with either "data" or "this"'
              );
            }
          }
          ...
          for (i = 0, l = repeat.length; i < l; i++) {
            if (subset[repeat[i]] !== undefined) {
              ...
              if (window.console && window.console.warn) {
                window.console.warn(
                  "WARNING: Repeater unable to find property to iterate renderItem on."
                );
              }
              break;
            }
    ...
    setViewOptions: function (curView) {
      ...
      if (this.options.views) {
        opts =
          this.options.views[viewName] || this.options.views[curView] || {};
      } else {
        opts = {};
      }
