  ...
  Spinbox.prototype = {
    ...
    triggerChangedEvent: function () {
      ...
      this.$element.trigger(
        "changed.fu.spinbox",
        this.output(currentValue, false)
      ); // no DOM update
    },
    ...
    bindMousewheelListeners: function () {
      ...
      if (inputEl.addEventListener) {
        ...
        inputEl.addEventListener(
          "mousewheel",
          $.proxy(this.mousewheelHandler, this),
          false
        );
        // Firefox
        inputEl.addEventListener(
