  ...
  d("tinymce/spellcheckerplugin/DomTextMatcher", [], function () {
    return function (a, b) {
      ...
      function e(a, b, c) {
        ...
        a: for (;;) {
          if (
            ((w[k.nodeName] || y[k.nodeName]) && j++,
            3 === k.nodeType &&
              (!e && k.length + j >= h.end
                ? ((e = k), (g = h.end - j))
                : d && i.push(k),
              !d && k.length + j > h.start && ((d = k), (f = h.start - j)),
              (j += k.length)),
            d && e)
          ) {
            if (
      ...
      function f(a) {
        function b(b, c) {
          ...
          return (
            ...
            b && e.appendChild(A.doc.createTextNode(b)),
            e
          );
        }
        return function (a) {
      ...
      function q(a, b, c) {
        return (
          z.push({ start: a, end: a + b, text: v.substr(a, b), data: c }), this
        );
      }
      function r(a) {
        var c = h(i(a)),
      ...
      function s(a, c) {
        ...
        return (
          d.deleteContents(),
          c.length > 0 && d.insertNode(b.dom.doc.createTextNode(c)),
          d
        );
      }
      function t() {
      ...
      var u,
        ...
        A = b.dom;
      return (
        (w = b.schema.getBlockElements()),
        (x = b.schema.getWhiteSpaceElements()),
        (y = b.schema.getShortEndedElements()),
        (v = d(a)),
        {
          text: v,
          matches: z,
    ...
    d(
      "tinymce/spellcheckerplugin/Plugin",
      [
      ...
      function (a, b, c, d, e, f, g, h) {
        b.add("spellchecker", function (b, i) {
          function j() {
            return (
              E.textMatcher || (E.textMatcher = new a(b.getBody(), b)),
              E.textMatcher
            );
          }
          function k(a, b) {
            ...
            c.each(h, function (a) {
              ...
              (C = new d({
                ...
                onautohide: function (a) {
                  -1 != a.target.className.indexOf("spellchecker") &&
                    a.preventDefault();
                },
                onhide: function () {
                  C.remove(), (C = null);
          ...
          function o(a, b, d, e) {
            var j = { method: a },
              k = "";
            "spellcheck" == a &&
              ((j.text = b), (j.lang = F.spellchecker_language)),
              "addToDictionary" == a && (j.word = b),
              c.each(j, function (a, b) {
                  ...
                  (a = h.parse(a)),
                    a
                      ? a.error
                        ? e(a.error)
                        : d(a)
                      : e("Sever response wasn't proper JSON.");
                },
                error: function (a, b) {
          ...
          function t(a, d, e) {
            b.selection.collapse(),
              e
                ? c.each(
                    b.dom.select("span.mce-spellchecker-word"),
                    function (c) {
                      c.getAttribute("data-mce-word") == a &&
                        b.dom.remove(c, !0);
                    }
                  )
                : b.dom.remove(d, !0),
          ...
          function w(a) {
            var d,
              e = [];
            if (
              ((d = c.toArray(b.getBody().getElementsByTagName("span"))),
              d.length)
            )
          ...
          function y(a) {
            var c;
            return (
              a.words ? ((D = !!a.dictionary), (c = a.words)) : (c = a),
              b.setProgressState(!1),
              l(c)
                ? (b.windowManager.alert("No misspellings found"),
                  void (B = !1))
                : ((A = c),
                  j()
                    .find(n())
          ...
          z.length > 1 &&
            ...
            (F.spellchecker_language =
              F.spellchecker_language || F.language || "en");
        });
      }
    ),
