tinymce.PluginManager.add("link", function (a) {
  ...
  function d(b) {
    ...
    function e(b) {
      var c = [];
      return (
        tinymce.each(a.dom.select("a:not([href])"), function (a) {
          var d = a.name || a.id;
          d &&
            c.push({
              text: d,
    ...
    (i = v.getNode()),
      ...
      (m = h()),
      (u.text = k =
        j ? j.innerText || j.textContent : v.getContent({ format: "text" })),
      (u.href = j ? w.getAttrib(j, "href") : ""),
      j
        ? (u.target = w.getAttrib(j, "target"))
        : a.settings.default_link_target &&
          (u.target = a.settings.default_link_target),
          ...
          return (
            ...
            (e = u.href)
              ? e.indexOf("@") > 0 &&
                ...
                : (a.settings.link_assume_external_targets &&
                    !/^\w+:/i.test(e)) ||
                  (!a.settings.link_assume_external_targets &&
                    /^\s*www[\.|\d\.]/i.test(e))
                ? void c(
