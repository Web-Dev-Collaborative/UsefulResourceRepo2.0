  ...
  function e(d) {
    function e() {
      ...
      (a = l.find("#width")[0]),
        ...
        a &&
          ...
          ((c = a.value()),
          (d = b.value()),
          l.find("#constrain")[0].checked() &&
            m &&
            n &&
            c &&
            d &&
            (m != c
              ? ((d = Math.round((c / m) * d)), isNaN(d) || b.value(d))
              : ((c = Math.round((d / n) * c)), isNaN(c) || a.value(c))),
          (m = c),
          (n = d));
    }
    function f() {
      function b(b) {
        ...
        (b.onload = function () {
          q.width ||
            q.height ||
            !t ||
            r.setAttribs(b, { width: b.clientWidth, height: b.clientHeight }),
            c();
        }),
          (b.onerror = c);
      }
      j(),
        e(),
        (q = tinymce.extend(q, l.toJSON())),
        q.alt || (q.alt = ""),
        q.title || (q.title = ""),
        "" === q.width && (q.width = null),
        "" === q.height && (q.height = null),
        ...
        a.undoManager.transact(function () {
          return q.src
            ? ("" === q.title && (q.title = null),
              s
                ? (r.setAttribs(s, q), a.editorUpload.uploadImagesAuto())
                : ((q.id = "__mcenew"),
                  a.focus(),
              ...
              void b(s))
            : void (s && (r.remove(s), a.focus(), a.nodeChanged()));
        });
    }
    function g(a) {
    ...
    function h(c) {
      var d,
        ...
        f,
        g = c.meta || {};
      o && o.value(a.convertURL(this.value(), "src")),
        tinymce.each(g, function (a, b) {
          l.find("#" + b).value(a);
        }),
        g.width ||
          g.height ||
          ((d = a.convertURL(this.value(), "src")),
          ...
          b(a.documentBaseURI.toAbsolute(this.value()), function (a) {
            a.width &&
              ...
              ((m = a.width),
              (n = a.height),
              l.find("#width").value(m),
              l.find("#height").value(n));
          }));
    }
    function i(a) {
      if (a.margin) {
    ...
    function j() {
      ...
      if (a.settings.image_advtab) {
        ...
        (d = i(d)),
          ...
          l
            .find("#style")
            .value(r.serializeStyle(r.parseStyle(r.serializeStyle(d))));
      }
    }
    function k() {
      if (a.settings.image_advtab) {
        var b = l.toJSON(),
          c = r.parseStyle(b.style);
        l.find("#vspace").value(""),
          l.find("#hspace").value(""),
          (c = i(c)),
          ((c["margin-top"] && c["margin-bottom"]) ||
            ...
            (c["margin-top"] === c["margin-bottom"]
              ? l.find("#vspace").value(g(c["margin-top"]))
              : l.find("#vspace").value(""),
            c["margin-right"] === c["margin-left"]
              ? l.find("#hspace").value(g(c["margin-right"]))
              : l.find("#hspace").value("")),
          c["border-width"] && l.find("#border").value(g(c["border-width"])),
          l
            .find("#style")
            .value(r.serializeStyle(r.parseStyle(r.serializeStyle(c))));
      }
    }
    var l,
      m,
      ...
      q = {},
      r = a.dom,
      s = a.selection.getNode(),
      t = a.settings.image_dimensions !== !1;
    (m = r.getAttrib(s, "width")),
      (n = r.getAttrib(s, "height")),
      "IMG" != s.nodeName ||
      s.getAttribute("data-mce-object") ||
      s.getAttribute("data-mce-placeholder")
        ? (s = null)
        : (q = {
    ...
    a.settings.image_description !== !1 &&
      u.push({ name: "alt", type: "textbox", label: "Image description" }),
      a.settings.image_title &&
        u.push({ name: "title", type: "textbox", label: "Image Title" }),
      t &&
        u.push({
          type: "container",
          label: "Dimensions",
      ...
      u.push(p),
      a.settings.image_advtab
        ? (s &&
            (s.style.marginLeft &&
              s.style.marginRight &&
              s.style.marginLeft === s.style.marginRight &&
              (q.hspace = g(s.style.marginLeft)),
            s.style.marginTop &&
              s.style.marginBottom &&
              s.style.marginTop === s.style.marginBottom &&
              (q.vspace = g(s.style.marginTop)),
            s.style.borderWidth && (q.border = g(s.style.borderWidth)),
            (q.style = a.dom.serializeStyle(
              a.dom.parseStyle(a.dom.getAttrib(s, "style"))
            ))),
