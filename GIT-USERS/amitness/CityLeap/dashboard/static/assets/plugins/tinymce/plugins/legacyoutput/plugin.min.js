      ...
      b.on("init", function () {
        ...
        b.formatter.register({
          ...
          a.each(c.split(","), function (a) {
            ...
            b &&
              (b.attributes.align ||
                ((b.attributes.align = {}), b.attributesOrder.push("align")));
          });
      }),
        b.addButton("fontsizeselect", function () {
          ...
          return (
            b.$.each(d.split(" "), function (b, c) {
              var d = c,
                e = c,
                f = c.split("=");
              f.length > 1 && ((d = f[0]), (e = f[1])),
                a.push({ text: d, value: e });
            }),
            {
              type: "listbox",
              text: "Font Sizes",
              ...
              onclick: function (a) {
                a.control.settings.value &&
                  b.execCommand("FontSize", !1, a.control.settings.value);
              },
            }
          );
        }),
          ...
          return (
            d.each(f, function (a, b) {
              e.push({
                ...
                value: b[1],
                textStyle:
                  -1 == b[1].indexOf("dings") ? "font-family:" + b[1] : "",
              });
            }),
            {
              type: "listbox",
              ...
              onselect: function (a) {
                a.control.settings.value &&
                  b.execCommand("FontName", !1, a.control.settings.value);
              },
            }
          );
        });
