  ...
  r(l, [], function () {
    ...
    function n(e, t) {
      ...
      if (
        ...
        e && a.test(e.type) && e.pageX === l && e.clientX !== l)
      ) {
        ...
        (o.pageX =
          e.clientX +
          ((u && u.scrollLeft) || (d && d.scrollLeft) || 0) -
          ((u && u.clientLeft) || (d && d.clientLeft) || 0)),
          (o.pageY =
            e.clientY +
            ((u && u.scrollTop) || (d && d.scrollTop) || 0) -
            ((u && u.clientTop) || (d && d.clientTop) || 0));
      }
      return (
        (o.preventDefault = function () {
          (o.isDefaultPrevented = r),
            e && (e.preventDefault ? e.preventDefault() : (e.returnValue = !1));
        }),
        (o.stopPropagation = function () {
          (o.isPropagationStopped = r),
            e &&
        ...
        o.isDefaultPrevented ||
          ((o.isDefaultPrevented = n),
          (o.isPropagationStopped = n),
          (o.isImmediatePropagationStopped = n)),
    ...
    function r(n, r, i) {
      ...
      return i.domLoaded
        ...
        : (l.addEventListener
            ? "complete" === l.readyState
              ? o()
              : e(n, "DOMContentLoaded", o)
            : (e(l, "readystatechange", a),
              l.documentElement.doScroll && n.self === n.top && s()),
          void e(n, "load", o));
    }
    function i() {
      function i(e, t) {
          ...
          if (t && 3 !== t.nodeType && 8 !== t.nodeType) {
            for (
              ...
              (b = o[y]),
                (C = m),
                (x = w = !1),
                "DOMContentLoaded" === b && (b = "ready"),
                a.domLoaded && "ready" === b && "complete" == t.readyState
                  ? h.call(p, n({ type: b }))
                  : (d ||
                      ((x = f[b]),
                      x &&
                    ...
                    v
                      ? "ready" === b && a.domLoaded
                        ? h({ type: b })
                        : v.push({ func: h, scope: p })
                      : ((s[g][b] = v = [{ func: h, scope: p }]),
                        (v.fakeName = x),
                        (v.capture = w),
                        (v.nativeHandler = C),
                        "ready" === b ? r(t, C, a) : e(t, x || b, C, w)));
            return (t = v = 0), h;
          }
        }),
            ...
            if (((f = s[i]), n)) {
              for (n = n.split(" "), l = n.length; l--; )
                if (((d = n[l]), (o = f[d]))) {
                  ...
                  (r && 0 !== o.length) ||
                    (delete f[d],
                    t(e, o.fakeName || d, o.nativeHandler, o.capture));
                }
            } else {
              for (d in f)
    ...
    r(u, [], function () {
      ...
      (n = window.opera && window.opera.buildNumber),
        ...
        (o =
          -1 == t.indexOf("Trident/") ||
          (-1 == t.indexOf("rv:") && -1 == e.appName.indexOf("Netscape"))
            ? !1
            : 11),
        (a = -1 == t.indexOf("Edge/") || i || o ? !1 : 12),
        (i = i || o || a),
        (s = !r && !o && /Gecko/.test(t)),
        (l = -1 != t.indexOf("Mac")),
        (c = /(iPad|iPhone)/.test(t)),
        (d =
          "FormData" in window &&
    ...
    r(d, [], function () {
      ...
      function a(e, t, n, r) {
        var i = 0;
        for (arguments.length < 3 && ((n = e[0]), (i = 1)); i < e.length; i++)
          n = t.call(r, n, e[i], i);
        return n;
      }
      var s =
    ...
    r(f, [u, d], function (e, n) {
      ...
      function a(e, t, n) {
        ...
        if (
          ((e = /^((static) )?([\w.]+)(:([\w.]+))?/.exec(e)),
          (a = e[3].match(/(^|\.)(\w+)$/i)[2]),
          (o = r.createNS(e[3].replace(/\.\w+$/, ""), n)),
          !o[a])
        ) {
          if ("static" == e[2])
            return (
              (o[a] = t),
              void (this.onCreate && this.onCreate(e[2], e[3], o[a]))
            );
          t[a] || ((t[a] = function () {}), (c = 1)),
            (o[a] = t[a]),
            r.extend(o[a].prototype, t),
            e[5] &&
              ((i = r.resolve(e[5]).prototype),
              (s = e[5].match(/\.(\w+)$/i)[1]),
              (l = o[a]),
              c
                ? (o[a] = function () {
    ...
    r(h, [l, c, f, u], function (e, n, r, i) {
      ...
      function y(e, n, r) {
        var i = [],
          o = e[n];
        for (
          "string" != typeof r && r instanceof f && (r = r[0]);
          o && 9 !== o.nodeType;
        ...
        (f.fn = f.prototype =
          {
            ...
            add: function (e, t) {
              ...
              if (t !== !1)
                for (
                  r = f.unique(n.toArray().concat(f.makeArray(e))),
                    n.length = r.length,
                    i = 0;
                  i < r.length;
                  i++
          ...
          function (e, t) {
            f.fn[e] = function (n) {
              ...
              return (
                ...
                this.length > 1 &&
                  (T[e] || (i = f.unique(i)),
                  0 === e.indexOf("parents") && (i = i.reverse())),
                (i = f(i)),
                n ? i.filter(n) : i
              );
            };
    ...
    r(p, [], function () {
      return function (e, t) {
        ...
        for (
          e = e || {},
            t && ((d = t.getValidStyles()), (f = t.getInvalidStyles())),
            u = ("\\\" \\' \\; \\: ; : " + h).split(" "),
            l = 0;
          l < u.length;
          l++
          ...
          parse: function (t) {
            ...
            if (t) {
              for (
                ...
                if (
                  ((v = g[1].replace(a, "").toLowerCase()),
                  (y = g[2].replace(a, "")),
                  (y = y.replace(/\\[0-9a-f]+/g, function (e) {
                  ...
                  if (
                    !e.allow_script_urls &&
                    ("behavior" == v || /expression\s*\(|\/\*|\*\//.test(y))
                  )
                    continue;
                  "font-weight" === v && "700" === y
                    ? (y = "bold")
                    : ("color" === v || "background-color" === v) &&
                      (y = y.toLowerCase()),
                    (y = y.replace(r, n)),
                    (y = y.replace(i, p)),
                    (m[v] = b ? h(y, !0) : y);
      ...
      function t(n) {
        ...
        function v(e) {
          ...
          (3 !== t.nodeType && 4 !== t.nodeType) || !t.nodeValue
            ? (t.childNodes.length > 0 && (o = t.childNodes[r]),
              o
                ? t.insertBefore(e, o)
                : 3 == t.nodeType
                ? n.insertAfter(e, t)
        ...
        function _(e, t, r) {
          ...
          o == i
            ? w(H[V], H[W], H[U], H[$]) > 0 && H.collapse(e)
            : H.collapse(e),
            (H.collapsed = C()),
            (H.commonAncestorContainer = n.findCommonAncestor(H[V], H[U]));
        }
        function E(e) {
          var t,
            n = 0,
          ...
          for (
            l = a.parentNode, c = s.parentNode;
            l != c;
            l = l.parentNode, c = c.parentNode
          )
            (a = l), (s = c);
          return T(a, s, e);
        }
        ...
        function k(e, t) {
          ...
          for (i = e.previousSibling; a > 0; )
            (s = i.previousSibling),
              (l = D(i, t)),
              n && n.insertBefore(l, n.firstChild),
              --a,
              (i = s);
          return t != O && (H.setEndBefore(e), H.collapse(z)), n;
        }
        ...
        function T(e, t, n) {
          ...
          return (
            (i = R(t, n)),
            o && o.appendChild(i),
            n != O && (H.setStartAfter(e), H.collapse(F)),
            o
          );
        }
        function R(e, t) {
          ...
          for (r = n.parentNode, i = B(r, z, z, t); r; ) {
            for (; n; )
              (o = n.previousSibling),
                (a = B(n, l, z, t)),
                t != I && i.insertBefore(a, i.firstChild),
                (l = F),
                (n = o);
            if (r == e) return i;
            (n = r.previousSibling),
        ...
        function B(e, t, r, i) {
          ...
          if (3 == e.nodeType) {
            if (
              ((o = e.nodeValue),
              r
                ? ((l = H[W]), (a = o.substring(l)), (s = o.substring(0, l)))
                : ((l = H[$]), (a = o.substring(0, l)), (s = o.substring(l))),
              i != O && (e.nodeValue = s),
              i == I)
            )
              return;
      ...
      var f = {
        ...
        decode: function (e) {
          return e.replace(u, function (e, n) {
            return n
              ? ((n =
                  "x" === n.charAt(0).toLowerCase()
                    ? parseInt(n.substr(1), 16)
                    : parseInt(n, 10)),
                n > 65535
                  ? ((n -= 65536),
                    String.fromCharCode(55296 + (n >> 10), 56320 + (1023 & n)))
                  : d[n] || String.fromCharCode(n))
              : a[e] || i[e] || t(e);
          });
        },
      };
    ...
    r(y, [f], function (e) {
      return function (t, n) {
        ...
        function i(n, i, l) {
          ...
          function f(e, t) {
            e() ||
              (new Date().getTime() - v < s ? window.setTimeout(t, 0) : u());
          }
          function h() {
            f(function () {
          ...
          var m, g, v, y;
          if (
            ((n = e._addCacheSuffix(n)),
            a[n] ? (y = a[n]) : ((y = { passed: [], failed: [] }), (a[n] = y)),
            i && y.passed.push(i),
            l && y.failed.push(l),
            1 != y.status)
          ) {
            ...
            if (
              ...
              if (navigator.userAgent.indexOf("Firefox") > 0)
                return (
                  (g = t.createElement("style")),
                  (g.textContent = '@import "' + n + '"'),
                  p(),
                  void r(g)
                );
              h();
      ...
      function (e, n, r, i, o, a, s, l, c, u) {
        ...
        function h(e, t) {
          ...
          (o.doc = e),
            ...
            (o.files = {}),
            (o.counter = 0),
            (o.stdMode = !y || e.documentMode >= 8),
            (o.boxModel = !y || "CSS1Compat" == e.compatMode || o.stdMode),
          ...
          (h.prototype = {
            ...
            clone: function (e, t) {
              var n = this,
                r,
                i;
              return !y || 1 !== e.nodeType || t
                ? e.cloneNode(t)
                : ((i = n.doc),
                  t
                    ? r.firstChild
                    : ((r = i.createElement(e.nodeName)),
                      p(n.getAttribs(e), function (t) {
            ...
            getParents: function (e, n, r, i) {
              ...
              for (
                e = o.get(e),
                  ...
                  r =
                    r ||
                    ("BODY" != o.getRoot().nodeName
                      ? o.getRoot().parentNode
                      : null),
                  m(n, "string") &&
                    ((a = n),
                    (n =
            ...
            get: function (e) {
              ...
              return e &&
                this.doc &&
                "string" == typeof e &&
                ((t = e), (e = this.doc.getElementById(e)), e && e.id !== t)
            ...
            add: function (e, t, n, r, i) {
              ...
              return this.run(e, function (e) {
                var a;
                return (
                  (a = m(t, "string") ? o.doc.createElement(t) : t),
                  o.setAttribs(a, n),
            ...
            setAttrib: function (e, t, n) {
              ...
              "" === n && (n = null),
                ...
                e.length &&
                  ((o = r.attrHooks[t]),
                  o && o.set ? o.set(e, n, t) : e.attr(t, n),
                  i != n &&
                    a.onSetAttrib &&
                    a.onSetAttrib({ attrElm: e, attrName: t, attrValue: n }));
            },
            ...
            getPos: function (e, t) {
              ...
              if (((e = r.get(e)), (t = t || l), e)) {
                if (
                  ...
                  "static" === n(l).css("position")
                )
                  return (
                    (c = e.getBoundingClientRect()),
                    (t = r.boxModel ? s.documentElement : l),
                    (i =
                      c.left +
                      (s.documentElement.scrollLeft || l.scrollLeft) -
                      t.clientLeft),
                    (o =
                      c.top +
                      (s.documentElement.scrollTop || l.scrollTop) -
                      t.clientTop),
                    { x: i, y: o }
                  );
            ...
            loadCSS: function (e) {
              var t = this,
                n = t.doc,
                r;
              return t !== h.DOM && n === document
                ? void h.DOM.loadCSS(e)
                : (e || (e = ""),
                  (r = n.getElementsByTagName("head")[0]),
                  void p(e.split(","), function (e) {
                    ...
                    (e = c._addCacheSuffix(e)),
                      t.files[e] ||
                        ((t.files[e] = !0),
                        (i = t.create("link", { rel: "stylesheet", href: e })),
                        y &&
                          n.documentMode &&
                          n.recalc &&
                          (i.onload = function () {
            ...
            getOuterHTML: function (e) {
              return (
                (e = this.get(e)),
                1 == e.nodeType && "outerHTML" in e
                  ? e.outerHTML
                  : n("<div>").append(n(e).clone()).html()
              );
            },
            ...
            replace: function (e, t, n) {
              ...
              return r.run(t, function (t) {
                return (
                  m(t, "array") && (e = e.cloneNode(!0)),
                  n &&
                    p(g(t.childNodes), function (t) {
                      e.appendChild(t);
                    }),
            ...
            nodeIndex: function (e, t) {
              ...
              if (e)
                for (
                  r = e.nodeType, e = e.previousSibling;
                  e;
                  e = e.previousSibling
                )
                  (i = e.nodeType),
                    (!t || 3 != i || (i != r && e.nodeValue.length)) &&
                      (n++, (r = i));
              return n;
            },
            split: function (e, t, n) {
                  ...
                  if (9 != a) {
                    if (3 == a && e.nodeValue.length > 0) {
                      ...
                      1 == o.length &&
                        o[0] &&
                        1 == o[0].nodeType &&
                        "bookmark" == o[0].getAttribute("data-mce-type") &&
                        e.parentNode.insertBefore(o[0], e),
                      o.length || /^(br|hr|input|img)$/i.test(e.nodeName))
                    )
                      return;
                    i.remove(e);
                  }
              ...
              var i = this,
                ...
                l;
              return e && t
                ? (o.setStart(e.parentNode, i.nodeIndex(e)),
                  o.setEnd(t.parentNode, i.nodeIndex(t)),
                  (a = o.extractContents()),
                  (o = i.createRng()),
                  o.setStart(t.parentNode, i.nodeIndex(t) + 1),
                  o.setEnd(e.parentNode, i.nodeIndex(e) + 1),
                  (s = o.extractContents()),
                  (l = e.parentNode),
                  l.insertBefore(r(a), e),
                  n ? l.replaceChild(n, t) : l.insertBefore(t, e),
                  l.insertBefore(r(s), e),
                  i.remove(e),
                  n || t)
                : void 0;
            },
            ...
            getContentEditable: function (e) {
              ...
              return e && 1 == e.nodeType
                ? ((t = e.getAttribute("data-mce-contenteditable")),
                  t && "inherit" !== t
                    ? t
            ...
            getContentEditableParent: function (e) {
              for (
                ...
                e && e !== t && ((n = this.getContentEditable(e)), null === n);
                e = e.parentNode
              );
              return n;
            },
      ...
      return (
        (r.prototype = {
          ...
          add: function (e, t, n) {
            return (
              this.items.push(t),
              (this.lookup[e] = { instance: t, dependencies: n }),
              t
            );
          },
          ...
          load: function (n, o, a, s) {
            ...
            var c = this,
              u = o;
            c.urls[n] ||
              ("object" == typeof o && (u = o.prefix + o.resource + o.suffix),
              0 !== u.indexOf("/") &&
                -1 == u.indexOf("://") &&
                (u = r.baseURL + "/" + u),
      ...
      function r(e) {
        (this.walk = function (t, r) {
          ...
          var c = t.startContainer,
            ...
            b;
          if (
            ((b = e.select("td.mce-item-selected,th.mce-item-selected")),
            b.length > 0)
          )
          ...
          if (
            (1 == c.nodeType && c.hasChildNodes() && (c = c.childNodes[u]),
            1 == d.nodeType && d.hasChildNodes() && (d = n(d, f)),
            c == d)
          )
            return r(o([c]));
              ...
              n == i && 3 == n.nodeType
                ...
                : (3 == n.nodeType &&
                  ...
                  3 == i.nodeType &&
                    o > 0 &&
                    o < i.nodeValue.length &&
                    ((i = t(i, o).previousSibling), (o = i.nodeValue.length))),
              {
                startContainer: n,
                startOffset: r,
                endContainer: i,
          ...
          (this.normalize = function (n) {
            function r(r) {
              ...
              function l(n, r) {
                ...
                if (
                  ((r = r || c),
                  (l = e.getParent(r.parentNode, e.isBlock) || f),
                  n && "BR" == r.nodeName && g && e.isEmpty(l))
                )
                  return (
                    (c = r.parentNode), (u = e.nodeIndex(r)), void (i = !0)
                  );
                for (a = new t(r, l); (h = a[n ? "prev" : "next"]()); ) {
                  if ("false" === e.getContentEditableParent(h)) return;
                  if (3 === h.nodeType && h.nodeValue.length > 0)
                    return (
                      (c = h), (u = n ? h.nodeValue.length : 0), void (i = !0)
                    );
              ...
              var c,
                ...
                g;
              if (
                ((c = n[(r ? "start" : "end") + "Container"]),
                (u = n[(r ? "start" : "end") + "Offset"]),
                (g = 1 == c.nodeType && u === c.childNodes.length),
                (p = e.schema.getNonEmptyElements()),
                (m = r),
                1 == c.nodeType && u > c.childNodes.length - 1 && (m = !1),
                9 === c.nodeType && ((c = e.getRoot()), (u = 0)),
                c === f)
              ) {
                if (
                  m &&
                  ((h = c.childNodes[u > 0 ? u - 1 : 0]),
                  h && (p[h.nodeName] || "TABLE" == h.nodeName))
                )
                  return;
                if (
                  c.hasChildNodes() &&
                  ...
                  (c = c.childNodes[u]),
                  (u = 0),
                  c.hasChildNodes() && !/TABLE/.test(c.nodeName))
                ) {
                  (h = c), (d = new t(c, f));
                  do {
                    if (3 === h.nodeType && h.nodeValue.length > 0) {
              ...
              o &&
                (3 === c.nodeType && 0 === u && l(!0),
                1 === c.nodeType &&
                  ((h = c.childNodes[u]),
                  h || (h = c.childNodes[u - 1]),
                  !h ||
                    "BR" !== h.nodeName ||
                    s(h, "A") ||
                    a(h) ||
                ...
                m &&
                  ...
                  l(!1),
                i && n["set" + (r ? "Start" : "End")](c, u);
            }
            var i, o;
            return (
              (o = n.collapsed), r(!0), o || r(), i && o && n.collapse(!0), i
            );
          });
      }
      var i = e.each;
      return (
        (r.compareRanges = function (e, t) {
          if (e && t) {
    ...
    r(_, [w, u], function (e, t) {
      return function (n) {
        function r(e) {
          var t, r;
          if (
            ((r = n.$(e).parentsUntil(n.getBody()).add(e)),
            r.length === o.length)
          ) {
        ...
        var i,
          o = [];
        "onselectionchange" in n.getDoc() ||
          n.on("NodeChange Click MouseUp KeyUp Focus", function (t) {
            var r, o;
            (r = n.selection.getRng()),
              (o = {
              ...
              ("nodechange" != t.type && e.compareRanges(o, i)) ||
          ...
          n.on("SelectionChange", function () {
            ...
            (t.range || !n.selection.isCollapsed()) &&
              !r(e) &&
              n.dom.isChildOf(e, n.getBody()) &&
              n.nodeChanged({ selectionChange: !0 });
          }),
          n.on("MouseUp", function (e) {
            e.isDefaultPrevented() ||
              ("IMG" == n.selection.getNode().nodeName
                ? setTimeout(function () {
                    n.nodeChanged();
                  }, 0)
                : n.nodeChanged());
          ...
          (this.nodeChanged = function (e) {
            ...
            n.initialized &&
              t &&
              !n.settings.disable_nodechange &&
              !n.settings.readonly &&
              ((o = n.getBody()),
              (r = t.getStart() || o),
              (r = r.ownerDocument != n.getDoc() ? n.getBody() : r),
              "IMG" == r.nodeName && t.isCollapsed() && (r = r.parentNode),
              (i = []),
              n.dom.getParent(r, function (e) {
          ...
          clone: function () {
            ...
            if ((o = e.attributes)) {
              for (s = [], s.map = {}, r = 0, i = o.length; i > r; r++)
                (a = o[r]),
                  "id" !== a.name &&
                    ((s[s.length] = { name: a.name, value: a.value }),
              ...
              do {
                if (1 === i.type) {
                  ...
                  for (o = i.attributes.length; o--; )
                    if (
                      ((a = i.attributes[o].name),
                      "name" === a || 0 === a.indexOf("data-mce-bookmark"))
                    )
                      return !1;
                }
    ...
    r(N, [f], function (e) {
      ...
      function n(e) {
        function n(e, n, r) {
          ...
          var s,
            ...
            d = arguments;
          for (
            r = r || [], n = n || "", "string" == typeof r && (r = t(r)), c = 3;
            c < d.length;
            c++
          )
        ...
        return i[e]
          ? i[e]
          : ((l = t("id accesskey class dir lang style tabindex title")),
            (c = t(
            ...
            "html5-strict" != e &&
              (l.push("xml:lang"),
              (h = t("acronym applet basefont big font strike tt")),
              u.push.apply(u, h),
              s(h, function (e) {
                n(e, "", u);
              }),
              (f = t("center dir isindex noframes")),
              c.push.apply(c, f),
              (d = [].concat(c, u)),
              s(f, function (e) {
                n(e, "", d);
            ...
            n("q", "cite", u),
            n("ins del", "cite datetime", d),
            n("img", "src sizes srcset alt usemap ismap width height"),
            n("iframe", "src name width height", d),
            ...
            n("tr", "", "td th"),
            n("td", "colspan rowspan headers", d),
            n("th", "colspan rowspan headers scope abbr", d),
            n(
              "form",
              "accept-charset action autocomplete enctype method name novalidate target",
              d
            ),
            n("fieldset", "disabled form name", d, "legend"),
            n("label", "form for", u),
            n(
              "input",
            ...
            n("menu", "type label", d, "li"),
            n("noscript", "", d),
            "html4" != e &&
              (n("wbr"),
              n("ruby", "", u, "rt rp"),
              n("figcaption", "", d),
              n("mark rt rp summary bdi", "", u),
              n("canvas", "width height", d),
              n(
                "video",
              ...
              n("datalist", "", u, "option"),
              n("article section nav aside header footer", "", d),
              n("hgroup", "", "h1 h2 h3 h4 h5 h6"),
              n("figure", "", d, "figcaption"),
              n("time", "datetime", u),
              n("dialog", "open", d),
              n(
                "command",
              ...
              n("output", "for form name", u),
              n("progress", "value max", u),
              n("meter", "value min max low high optimum", u),
              n("details", "open", d, "summary"),
              n("keygen", "autofocus challenge disabled form keytype name")),
            "html5-strict" != e &&
              (r("script", "language xml:space"),
              r("style", "xml:space"),
              r(
                "object",
            ...
            "html4" != e &&
              (r("input button select textarea", "autofocus"),
            ...
            delete a.caption.children.table,
            delete a.script,
            (i[e] = a),
            a);
      }
      ...
      return function (e) {
        function o(t, n, r) {
          ...
          return (
            o
              ? (o = a(o, /[, ]/, a(o.toUpperCase(), /[, ]/)))
              : ((o = i[t]),
                o ||
                  ((o = a(n, " ", a(n.toUpperCase(), " "))),
                  (o = l(o, r)),
                  (i[t] = o))),
            o
          );
        ...
        function f(e) {
          ...
          if (e)
            for (
              e = t(e, ","),
                y["@"] &&
                  ((w = y["@"].attributes), (_ = y["@"].attributesOrder)),
                n = 0,
                r = e.length;
              r > n;
              n++
              ...
              if ((s = k.exec(e[n]))) {
                if (
                  ...
                  (g = {}),
                  (v = []),
                  (l = { attributes: g, attributesOrder: v }),
                  "#" === b && (l.paddEmpty = !0),
                  "-" === b && (l.removeEmpty = !0),
                  ...
                  for (f = t(f, "|"), i = 0, o = f.length; o > i; i++)
                    if ((s = S.exec(f[i]))) {
                      if (
                        ...
                        (N = s[4]),
                        "!" === m &&
                          ((l.attributesRequired = l.attributesRequired || []),
                      ...
                      b &&
                        ("=" === b &&
                          ((l.attributesDefault = l.attributesDefault || []),
                          l.attributesDefault.push({ name: p, value: N }),
                          (c.defaultValue = N)),
                        ":" === b &&
                          ((l.attributesForced = l.attributesForced || []),
                          l.attributesForced.push({ name: p, value: N }),
                          (c.forcedValue = N)),
                        "<" === b && (c.validValues = a(N, "?"))),
                        T.test(p)
                          ? ((l.attributePatterns = l.attributePatterns || []),
                            (c.pattern = d(p)),
                            l.attributePatterns.push(c))
                          : (g[p] || v.push(p), (g[p] = c));
                    }
                w || "@" != h || ((w = g), (_ = v)),
                  C && ((l.outputName = h), (y[C] = l)),
                  T.test(h) ? ((l.pattern = d(h)), x.push(l)) : (y[h] = l);
              }
        }
        function h(e) {
          (y = {}),
        ...
        function p(e) {
          var n = /^(~)?(.+)$/;
          e &&
            ((i.text_block_elements = i.block_elements = null),
            s(t(e, ","), function (e) {
              var t = n.exec(e),
                r = "~" === t[1],
                i = r ? "span" : "div",
        ...
        (e = e || {}),
          ...
          (A = o(
            "non_empty_elements",
            "td th iframe video audio object script",
            k
          )),
          ...
          s(
            (e.special || "script noscript style textarea").split(" "),
            function (e) {
              L[e] = new RegExp("</" + e + "[^>]*>", "gi");
            }
          ),
          e.valid_elements
            ...
            : (s(_, function (e, t) {
              ...
              "html5" != e.schema &&
                s(t("strong/b em/i"), function (e) {
                  (e = t(e, "/")), (y[e[1]].outputName = e[0]);
                }),
              (y.img.attributesDefault = [{ name: "alt", value: "" }]),
              s(
                t(
              ...
              s(
                t("p h1 h2 h3 h4 h5 h6 th td pre div address caption"),
                function (e) {
                  y[e].paddEmpty = !0;
                }
              ),
          ...
          m("+ol[ul|ol],+ul[ul|ol]"),
          e.invalid_elements &&
            s(c(e.invalid_elements), function (e) {
              y[e] && delete y[e];
            }),
          ...
          (l.parse = function (e) {
            ...
            for (
              L = new RegExp(
                ...
                P =
                  /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g,
                x = a.getShortEndedElements(),
                H = i.self_closing_elements || a.getSelfClosingElements(),
                C = a.getBoolAttrs(),
                _ = i.validate,
                b = i.remove_internals,
                W = i.fix_self_closing,
                O = a.getSpecialElements();
              (c = L.exec(e));

            ) {
              if (
                (u < c.index && l.text(z(e.substr(u, c.index - u))), (d = c[6]))
              )
                (d = d.toLowerCase()),
                ...
                if (
                  ...
                  W &&
                    ...
                    h[h.length - 1].name === d &&
                    o(d),
                  !_ || (E = a.getElementRule(d)))
                ) {
                  if (
                    ((N = !0),
                    _ && ((T = E.attributes), (R = E.attributePatterns)),
                    (S = c[8])
                      ? ((y = -1 !== S.indexOf("data-mce-type")),
                        y && b && (N = !1),
                        (p = []),
                        (p.map = {}),
                        S.replace(P, s))
                    ...
                    if (
                      ...
                      (B = E.attributesDefault),
                      (D = E.attributesForced),
                      (M = E.removeEmptyAttrs),
                      M && !p.length && (N = !1),
                      D)
                    )
                      for (m = D.length; m--; )
                ...
                if ((f = O[d])) {
                  (f.lastIndex = u = c.index + c[0].length),
                    (c = f.exec(e))
                      ? (N && (g = e.substr(u, c.index - u)),
                        (u = c.index + c[0].length))
                      : ((g = e.substr(u)), (u = e.length)),
                    N && (g.length > 0 && l.text(g, !0), l.end(d)),
                    (L.lastIndex = u);
                  continue;
                }
                w ||
                  (S && S.indexOf("/") == S.length - 1
                    ? N && l.end(d)
                    : h.push({ name: d, valid: N }));
              } else
                (d = c[1])
                  ? (">" === d.charAt(0) && (d = " " + d),
                    i.allow_conditional_comments ||
                      "[if" !== d.substr(0, 3) ||
                      (d = " " + d),
                    l.comment(d))
                  : (d = c[2])
            ...
            for (
              u < e.length && l.text(z(e.substr(u))), m = h.length - 1;
              m >= 0;
              m--
            )
    ...
    r(S, [E, N, k, f], function (e, t, n, r) {
      ...
      return function (r, l) {
        function c(t) {
          ...
          for (
            m = i("tr,td,th,tbody,thead,tfoot,table"),
              p = l.getNonEmptyElements(),
              g = l.getTextBlockElements(),
              v = l.getSpecialElements(),
              n = 0;
            n < t.length;
            n++
          )
            if (((r = t[n]), r.parent && !r.fixed))
              if (g[r.name] && "li" == r.parent.name) {
                ...
                for (
                  a = [r], o = r.parent;
                  o && !l.isValidChild(o.name, r.name) && !m[o.name];
                  o = o.parent
                )
                  a.push(o);
                if (o && a.length > 1) {
                  for (
                    a.reverse(), s = c = u.filterNode(a[0].clone()), h = 0;
                    h < a.length - 1;
                    h++
                  ) {
                    for (
                      l.isValidChild(c.name, a[h].name)
                        ? ((d = u.filterNode(a[h].clone())), c.append(d))
                        : (d = c),
                        f = a[h].firstChild;
                      f && f != a[h + 1];
                  ...
                  s.isEmpty(p)
                    ? o.insert(r, a[0], !0)
                    : (o.insert(s, a[0], !0), o.insert(r, s)),
                    (o = a[0]),
                    (o.isEmpty(p) ||
                      (o.firstChild === o.lastChild &&
                        "br" === o.firstChild.name)) &&
                      o.empty().remove();
                } else if (r.parent) {
                  if ("li" === r.name) {
                    if (
                      ((y = r.prev), y && ("ul" === y.name || "ul" === y.name))
                    ) {
                      y.append(r);
                      continue;
                    }
                    if (
                      ((y = r.next), y && ("ul" === y.name || "ul" === y.name))
                    ) {
                  ...
                  l.isValidChild(r.parent.name, "div") &&
                  l.isValidChild("div", r.name)
        ...
        (r = r || {}),
          ...
          (u.filterNode = function (e) {
            ...
            for (; t--; )
              (n = f[t].name),
                n in e.attributes.map &&
                  ((r = p[n]), r ? r.push(e) : (p[n] = [e]));
            return e;
          }),
          ...
          (u.parse = function (t, o) {
            function a() {
              function e(e) {
                e &&
                  ((t = e.firstChild),
                  t && 3 == t.type && (t.value = t.value.replace(R, "")),
                  (t = e.lastChild),
                  t && 3 == t.type && (t.value = t.value.replace(D, "")));
              }
              var t = y.firstChild,
                n,
                i;
                  ...
                  (n = t.next),
                    ...
                    (1 == t.type &&
                      ...
                      ? i
                        ? i.append(t)
                        : ((i = u(I, 1)),
                          i.attr(r.forced_root_block_attrs),
                          y.insert(i, t),
                          i.append(t))
                      : (e(i), (i = null)),
                    (t = n);
            ...
            if (
              ...
              (p = {}),
              (T = s(
                i("script,style,head,html,body,title,meta,param"),
                l.getBlockElements()
              )),
              (O = l.getNonEmptyElements()),
              (P = l.children),
              (S = r.validate),
              (I =
                "forced_root_block" in o
                  ? o.forced_root_block
                  : r.forced_root_block),
              (L = l.getWhiteSpaceElements()),
              (R = /^[ \t\r\n]+/),
              (D = /[ \t\r\n]+$/),
              (M = /[ \t\r\n]+/g),
              (H = /^[ \t\r\n]+$/),
              (v = new n(
                {
                  ...
                  start: function (e, t, n) {
                    ...
                    if ((o = S ? l.getElementRule(e) : {})) {
                      for (
                        r = u(o.outputName || e, 1),
                          r.attributes = t,
                          r.shortEnded = n,
                          b.append(r),
                          s = P[b.name],
                          s && P[r.name] && !s[r.name] && A.push(r),
                          i = f.length;
                        i--;
                    ...
                    if ((r = S ? l.getElementRule(t) : {})) {
                      ...
                      if (
                        (B && L[t] && (B = !1),
                        (r.removeEmpty || r.paddEmpty) && b.isEmpty(O))
                      )
                        if (r.paddEmpty)
                          ...
                          return (
                            (a = b.parent),
                            T[b.name] ? b.empty().remove() : b.unwrap(),
                            void (b = a)
                          );
                      b = b.parent;
                    }
              ...
              (y = b = new e(o.context || r.root_name, 11)),
              v.parse(t),
              S && A.length && (o.context ? (o.invalid = !0) : c(A)),
              I && ("body" == y.name || o.isRootContent) && a(),
              !o.invalid)
            ) {
              for (k in h) {
                for (N = d[k], x = h[k], _ = x.length; _--; )
          ...
          r.remove_trailing_brs &&
            u.addNodeFilter("br", function (t) {
              var n,
                r = t.length,
                i,
              ...
              for (o.body = 1, n = 0; r > n; n++)
                if (
                  ((i = t[n]),
                  (c = i.parent),
                  o[i.parent.name] && i === c.lastChild)
                ) {
                  for (d = i.prev; d; ) {
                    if (
                      ((f = d.name),
                      "span" !== f || "bookmark" !== d.attr("data-mce-type"))
                    ) {
                      if ("br" !== f) break;
                      if ("br" === f) {
                        i = null;
                  ...
                  i &&
                    (i.remove(),
                    c.isEmpty(a) &&
                      ((h = l.getElementRule(c.name)),
                      h &&
                        (h.removeEmpty
                          ? c.remove()
                          : h.paddEmpty &&
                            (c.empty().append(new e("#text", 3)).value =
                              "\xa0"))));
                } else {
                  for (
                    u = i;
                    ...
                    c = c.parent;
                  u === c &&
                    ((p = new e("#text", 3)), (p.value = "\xa0"), i.replace(p));
                }
            }),
          r.allow_html_in_named_anchor ||
            u.addAttributeFilter("id,name", function (e) {
          ...
          r.validate &&
            l.getValidClasses() &&
            u.addAttributeFilter("class", function (e) {
              for (
                var t = e.length, n, r, i, o, a, s = l.getValidClasses(), c, u;
                t--;

              ) {
                for (
                  n = e[t], r = n.attr("class").split(" "), a = "", i = 0;
                  i < r.length;
                  i++
                )
                  (o = r[i]),
              ...
              if (n) n(e);
                ...
                if (
                  ...
                  for (
                    f = [],
                      f.map = {},
                      m = r.getElementRule(e.name),
                      h = 0,
                      p = m.attributesOrder.length;
                    p > h;
                    h++
                  )
                    (u = m.attributesOrder[h]),
                      u in c.map &&
                        ((d = c.map[u]),
                        (f.map[u] = d),
                        f.push({ name: u, value: d }));
    ...
    r(A, [b, S, v, R, E, N, u, f], function (e, t, n, r, i, o, a, s) {
      ...
      return function (e, i) {
        ...
        return (
          ...
          (h = new t(e, f)),
          h.addAttributeFilter("data-mce-tabindex", function (e, t) {
          ...
          h.addAttributeFilter("src,href,style", function (t, n) {
            for (
              var r = t.length,
                ...
                a = "data-mce-" + n,
                l = e.url_converter,
                c = e.url_converter_scope,
                u;
              r--;

            )
              (i = t[r]),
                (o = i.attributes.map[a]),
                o !== u
                  ? (i.attr(n, o.length > 0 ? o : null), i.attr(a, null))
                  : ((o = i.attributes.map[n]),
                    "style" === n
                      ? (o = s.serializeStyle(s.parseStyle(o), i.name))
                      : l && (o = l.call(c, o, n, i.name)),
          ...
          h.addAttributeFilter("data-mce-type", function (e, t, n) {
            for (var r = e.length, i; r--; )
              (i = e[r]),
                "bookmark" !== i.attributes.map["data-mce-type"] ||
                  n.cleanup ||
                  i.remove();
          }),
                ...
                "script" === t
                  ? ((a = i.attr("type")),
                    a &&
                      i.attr(
                        "type",
                        "mce-no/type" == a ? null : a.replace(/^mce\-/, "")
                      ),
                    o.length > 0 &&
                      (i.firstChild.value =
                        "// <![CDATA[\n" + n(o) + "\n// ]]>"))
            ...
            for (var n = e.length, r; n--; )
              (r = e[n]),
                7 === r.type
                  ...
                  : 1 === r.type &&
                    ("input" !== t ||
                      "type" in r.attributes.map ||
                      r.attr("type", "text"));
          }),
          e.fix_list_elements &&
            h.addNodeFilter("ul,ol", function (e) {
              for (var t = e.length, n, r; t--; )
                (n = e[t]),
                  (r = n.parent),
                  ("ul" === r.name || "ol" === r.name) &&
          ...
          ),
          {
            ...
            serialize: function (t, n) {
              var i = this,
                ...
                v;
              return (
                a.ie && s.select("script,style,select,map").length > 0
                  ? ((g = t.innerHTML), (t = t.cloneNode(!1)), s.setHTML(t, g))
                  : (t = t.cloneNode(!0)),
                (o = t.ownerDocument.implementation),
                o.createHTMLDocument &&
                  ((d = o.createHTMLDocument("")),
                  c("BODY" == t.nodeName ? t.childNodes : [t], function (e) {
                    d.body.appendChild(d.importNode(e, !0));
                  }),
                  (t = "BODY" != t.nodeName ? d.body.firstChild : d.body),
                  (p = s.doc),
                  (s.doc = d)),
                (n = n || {}),
                ...
                (v = h.parse(
                  u(n.getInner ? t.innerHTML : s.getOuterHTML(t)),
                  n
                )),
                l(v),
                (m = new r(e, f)),
                (n.content = m.serialize(v)),
          ...
          if (
            ...
            for (s = f.children, o = s.length - 1; o >= i; )
              if (
                ((u = Math.floor((i + o) / 2)),
                (l = s[u]),
                r.moveToElementText(l),
                (d = r.compareEndPoints(n ? "StartToStart" : "EndToEnd", t)),
                d > 0)
              )
                o = u - 1;
              else {
            ...
            if (0 > d)
              for (
                l
                  ? r.collapse(!1)
                  : (r.moveToElementText(f), r.collapse(!0), (l = f), (a = !0)),
                  c = 0;
                0 !==
                  r.compareEndPoints(n ? "StartToStart" : "StartToEnd", t) &&
                0 !== r.move("character", 1) &&
                f == r.parentElement();
        ...
        function n() {
          function n(e) {
            ...
            if (n.position < 0) {
              ...
              if (!i)
                return void (3 == l.nodeType
                  ? a[e ? "setStart" : "setEnd"](l, 0)
                  : a[e ? "setStartBefore" : "setEndBefore"](l));
              for (; l; ) {
                if (
                  3 == l.nodeType &&
                  ((u = l.nodeValue), (s += u.length), s >= i)
                ) {
              ...
              if (!i)
                return void (3 == r.nodeType
                  ? a[e ? "setStart" : "setEnd"](l, r.nodeValue.length)
                  : a[e ? "setStartAfter" : "setEndAfter"](l));
              for (; l; ) {
          ...
          var o = e.getRng(),
            ...
            d;
          if (
            ((s = o.item ? o.item(0) : o.parentElement()),
            s.ownerDocument != i.doc)
          )
            return a;
          if (((l = e.isCollapsed()), o.item))
            return (
              a.setStart(s.parentNode, i.nodeIndex(s)),
              a.setEnd(a.startContainer, a.startOffset + 1),
              a
            );
          try {
            n(!0), l || n();
        ...
        (this.getBookmark = function (n) {
          function r(e) {
            var t,
              ...
              a = [];
            for (
              t = e.parentNode, n = i.getRoot().parentNode;
              t != n && 9 !== t.nodeType;
          ...
          return (
            2 === n &&
              (a.item
                ? (s.start = { ctrl: !0, indexes: r(a.item(0)) })
          ...
          (this.moveToBookmark = function (e) {
            ...
            function n(n) {
              ...
              i &&
                ((a = i.position > 0),
                (s = o.createTextRange()),
                s.moveToElementText(t(i.indexes)),
                (c = i.offset),
                c !== l
                  ? (s.collapse(i.inside || a),
                    s.moveStart("character", a ? -c : c))
                  : s.collapse(n),
                r.setEndPoint(n ? "StartToStart" : "EndToStart", s),
                n && r.collapse(!0));
            }
            var r,
              o = i.doc.body;
            e.start &&
              (e.start.ctrl
                ? ((r = o.createControlRange()),
                  r.addElement(t(e.start.indexes)),
                  r.select())
                : ((r = o.createTextRange()), n(!0), n(), r.select()));
          }),
              ...
              (a = i.create("a")),
                ...
                3 == t.nodeType
                  ? (t.parentNode.insertBefore(a, t),
                    ...
                    i.remove(a),
                    r.setEndPoint(e ? "StartToStart" : "EndToEnd", d))
                  : ((p = t.childNodes),
                    p.length
                      ? (n >= p.length
                          ? i.insertAfter(a, p[p.length - 1])
                          : t.insertBefore(a, p[n]),
                        d.moveToElementText(a))
                      : t.canHaveHTML &&
            ...
            if (
              ...
              if (l == u && !s.hasChildNodes()) {
                if (s.canHaveHTML)
                  return (
                    (d = s.previousSibling),
                    d && !d.hasChildNodes() && i.isBlock(d)
                      ? (d.innerHTML = "&#xFEFF;")
                      : (d = null),
                    (s.innerHTML =
                      "<span>&#xFEFF;</span><span>&#xFEFF;</span>"),
                    r.moveToElementText(s.lastChild),
                    r.select(),
    ...
    r(M, [D, f, u], function (e, t, n) {
      return function (r, i) {
        function o(e) {
          ...
          return t === !1 || n.iOS
            ? !1
            : ("string" != typeof t && (t = "table,img,div"),
        ...
        function a(t) {
          ...
          (n = t.screenX - T),
            ...
            (O = 5 > O ? 5 : O),
            (o =
              "IMG" == w.nodeName && i.settings.resize_img_proportional !== !1
                ? !e.modifierPressed(t)
                : e.modifierPressed(t) ||
                  ("IMG" == w.nodeName && k[2] * k[3] !== 0)),
            o &&
              (W(n) > W(r)
                ? ((O = V(P * H)), (P = V(O / H)))
                : ((P = V(O / H)), (O = V(P * H)))),
            x.setStyles(_, { width: P, height: O }),
            (a = k.startPos.x + n),
            (s = k.startPos.y + r),
            (a = a > 0 ? a : 0),
            (s = s > 0 ? s : 0),
            x.setStyles(E, { left: a, top: s, display: "block" }),
            (E.innerHTML = P + " &times; " + O),
            k[2] < 0 &&
              _.clientWidth <= P &&
              x.setStyle(_, "left", A + (D - P)),
            k[3] < 0 &&
              _.clientHeight <= O &&
              x.setStyle(_, "top", B + (M - O)),
            (n = U.scrollWidth - $),
            (r = U.scrollHeight - q),
            n + r !== 0 && x.setStyles(E, { left: a - n, top: s - r }),
            L ||
              (i.fire("ObjectResizeStart", { target: w, width: D, height: M }),
              (L = !0));
        }
        function s() {
          function e(e, t) {
            t &&
              (w.style[e] || !i.schema.isValid(w.nodeName.toLowerCase(), e)
                ? x.setStyle(w, e, t)
                : x.setAttrib(w, e, t));
          }
          (L = !1),
            e("width", P),
            e("height", O),
            x.unbind(I, "mousemove", a),
            x.unbind(I, "mouseup", s),
            F != I && (x.unbind(F, "mousemove", a), x.unbind(F, "mouseup", s)),
            x.remove(_),
            x.remove(E),
            (z && "TABLE" != w.nodeName) || l(w),
            i.fire("ObjectResized", { target: w, width: P, height: O }),
            x.setAttrib(w, "style", x.getAttrib(w, "style")),
            i.nodeChanged();
        }
        function l(e, t, r) {
          var l, u, d, f, h;
          g(),
            ...
            (u = h.width || h.right - h.left),
            (d = h.height || h.bottom - h.top),
            w != e && (m(), (w = e), (P = O = 0)),
            (f = i.fire("ObjectSelected", { target: e })),
            o(e) && !f.isDefaultPrevented()
              ? C(N, function (e, i) {
                  function o(t) {
                    (T = t.screenX),
                      (R = t.screenY),
                      ...
                      (H = M / D),
                      (k = e),
                      (e.startPos = { x: u * e[0] + A, y: d * e[1] + B }),
                      ($ = U.scrollWidth),
                      (q = U.scrollHeight),
                      (_ = w.cloneNode(!0)),
                      x.addClass(_, "mce-clonedresizable"),
                      x.setAttrib(_, "data-mce-bogus", "all"),
                      (_.contentEditable = !1),
                      (_.unSelectabe = !0),
                      x.setStyles(_, { left: A, top: B, margin: 0 }),
                      _.removeAttribute("data-mce-selected"),
                      U.appendChild(_),
                      x.bind(I, "mousemove", a),
                      x.bind(I, "mouseup", s),
                      F != I &&
                        (x.bind(F, "mousemove", a), x.bind(F, "mouseup", s)),
                      (E = x.add(
                        U,
                        "div",
                  ...
                  return t
                    ...
                    : ((l = x.get("mceResizeHandle" + i)),
                      ...
                      n.ie && (l.contentEditable = !1),
                      x.bind(l, "mousedown", function (e) {
              ...
              : c(),
            w.setAttribute("data-mce-selected", "1");
        }
        function c() {
          var e, t;
        ...
        function u(e) {
          ...
          if (!L && !i.removed)
            return (
              C(
                x.select("img[data-mce-selected],hr[data-mce-selected]"),
                function (e) {
                  e.removeAttribute("data-mce-selected");
                }
              ),
              (o = "mousedown" == e.type ? e.target : r.getNode()),
              (o = x.$(o).closest(z ? "table" : "table,img,hr")[0]),
              t(o, U) &&
              (v(),
              (n = r.getStart(!0)),
              t(n, o) &&
                t(r.getEnd(!0), o) &&
                (!z || (o != n && "IMG" !== n.nodeName)))
                ? void l(o)
                : void c()
            );
        }
        ...
        function p(e) {
          ...
          if (t != w) {
            if (
              (i.fire("ObjectSelected", { target: t }),
              m(),
              0 === t.id.indexOf("mceResizeHandle"))
            )
              return void (e.returnValue = !1);
            ("IMG" == t.nodeName || "TABLE" == t.nodeName) &&
              (c(), (w = t), d(t, "resizestart", h));
          }
        }
        function m() {
          f(w, "resizestart", h);
        ...
        return (
          i.contentStyles.push(
            j +
              " div.mce-resizehandle {position: absolute;border: 1px solid black;background: #FFF;width: 7px;height: 7px;z-index: 10000}" +
              j +
              " .mce-resizehandle:hover {background: #000}" +
              j +
              " img[data-mce-selected], hr[data-mce-selected] {outline: 1px solid black;resize: none}" +
              j +
              " .mce-clonedresizable {position: absolute;" +
              (n.gecko ? "" : "outline: 1px dashed black;") +
          ...
          i.on("init", function () {
            z
              ...
              : (v(),
                n.ie >= 11 &&
                  (i.on("mousedown click", function (e) {
                    var t = e.target.nodeName;
                    !L &&
                      /^(TABLE|IMG|HR)$/.test(t) &&
                      (i.selection.select(e.target, "TABLE" == t),
                      "mousedown" == e.type && i.nodeChanged());
                  }),
      ...
      function n(n) {
        ...
        (this.getBookmark = function (e, i) {
          function o(e, n) {
            var i = 0;
            return (
              t.each(r.select(e), function (e, t) {
                e == n && (i = t);
              }),
              i
            );
            ...
            function t(t) {
              ...
              (n = e[o + "Container"]),
                ...
                1 == n.nodeType &&
                  "TR" == n.nodeName &&
                  ((i = n.childNodes),
                  (n = i[Math.min(t ? r : r - 1, i.length - 1)]),
                  n &&
          ...
          if (
            ...
            (u = r.uniqueId()),
            (d = n.isCollapsed()),
            (m = "overflow:hidden;line-height:0px"),
            l.duplicate || l.item)
          ) {
            if (l.item)
              return (
                (h = l.item(0)), (f = h.nodeName), { name: f, index: o(f, h) }
              );
            c = l.duplicate();
            try {
              l.collapse(),
                ...
                d ||
                  (c.collapse(!1),
                  l.moveToElementText(c.parentElement()),
                  0 === l.compareEndPoints("StartToEnd", c) &&
                    c.move("character", -1),
                  c.pasteHTML(
                    '<span data-mce-type="bookmark" id="' +
                      u +
            ...
            (c = a(l.cloneRange())),
              d ||
                ...
                c.insertNode(
                  r.create(
                    "span",
                    { "data-mce-type": "bookmark", id: u + "_end", style: m },
                    p
                  )
                )),
              (l = a(l)),
              ...
              l.insertNode(
                r.create(
                  "span",
                  { "data-mce-type": "bookmark", id: u + "_start", style: m },
                  p
                )
              );
          }
          ...
          (this.moveToBookmark = function (i) {
            function o(e) {
              ...
              if (t) {
                ...
                3 === r.nodeType && (o = Math.min(t[0], r.nodeValue.length)),
                  1 === r.nodeType && (o = Math.min(t[0], r.childNodes.length)),
            ...
            function a(n) {
              ...
              if (
                ...
                ((a = o.parentNode),
                "start" == n
                  ? (p ? ((a = o.firstChild), (s = 1)) : (s = r.nodeIndex(o)),
                    (u = d = a),
                    (f = h = s))
                  : (p ? ((a = o.firstChild), (s = 1)) : (s = r.nodeIndex(o)),
                    (d = a),
                ...
                for (
                  c = o.previousSibling,
                    l = o.nextSibling,
                    t.each(t.grep(o.childNodes), function (e) {
                      3 == e.nodeType &&
        ...
        (l.prototype = {
          setCursorLocation: function (e, t) {
            ...
            e
              ...
              : (n._moveEndPoint(r, n.editor.getBody(), !0), n.setRng(r));
          },
          getContent: function (e) {
            ...
            return (
              ...
              "text" == e.format
                ...
                : (r.cloneContents
                    ? ((l = r.cloneContents()), l && i.appendChild(l))
                    : r.item !== t || r.htmlText !== t
                    ? ((i.innerHTML =
                        "<br>" + (r.item ? r.item(0).outerHTML : r.htmlText)),
                      i.removeChild(i.firstChild))
                    : (i.innerHTML = r.toString()),
                  /^\s/.test(i.innerHTML) && (a = " "),
                  /\s+$/.test(i.innerHTML) && (s = " "),
                  (e.getInner = !0),
                  (e.content = n.isCollapsed()
                    ? ""
                    : a + n.serializer.serialize(i, e) + s),
                  n.editor.fire("GetContent", e),
                  e.content)
            );
          },
          setContent: function (e, t) {
            ...
            if (
              ...
              (e += '<span id="__caret">_</span>'),
                r.startContainer == o && r.endContainer == o
                  ? (o.body.innerHTML = e)
                  : (r.deleteContents(),
                    0 === o.body.childNodes.length
                      ? (o.body.innerHTML = e)
              ...
              r.item && (o.execCommand("Delete", !1, null), (r = n.getRng())),
                /^\s+/.test(e)
                  ? (r.pasteHTML('<span id="__mce_tmp">_</span>' + e),
            ...
            return (
              ...
              1 == r.nodeType &&
                ...
                ((e && n.collapsed) ||
                  (r =
                    r.childNodes[
                      Math.min(r.childNodes.length - 1, n.startOffset)
                    ])),
            ...
            return n.duplicate || n.item
              ? n.item
                ...
                : ((n = n.duplicate()),
                  ...
                  (r = n.parentElement()),
                  r.ownerDocument !== t.dom.doc && (r = t.dom.getRoot()),
                  r && "BODY" == r.nodeName ? r.lastChild || r : r)
              : ((r = n.endContainer),
                (i = n.endOffset),
                1 == r.nodeType &&
                  r.hasChildNodes() &&
                  ((e && n.collapsed) || (r = r.childNodes[i > 0 ? i - 1 : i])),
                r && 3 == r.nodeType ? r.parentNode : r);
          },
          ...
          collapse: function (e) {
            ...
            n.item &&
              ((r = n.item(0)),
              (n = t.win.document.body.createTextRange()),
          ...
          getRng: function (e) {
              ...
              return (
                l.startContainer
                  ? ((i = a.createRange()),
                    ...
                    i.setEnd(l.endContainer, l.endOffset))
                  : (i = l),
                i
              );
            }
            ...
            return (
              ...
              i.setStart &&
                ...
                i.collapsed &&
                ((o = n.dom.getRoot()), i.setStart(o, 0), i.setEnd(o, 0)),
              n.selectedRange &&
                n.explicitRange &&
                (0 === t(i.START_TO_START, i, n.selectedRange) &&
                0 === t(i.END_TO_END, i, n.selectedRange)
                  ? (i = n.explicitRange)
                  : ((n.selectedRange = null), (n.explicitRange = null))),
              i
            );
          },
          setRng: function (e, t) {
            ...
            if (e)
              if (e.select)
                ...
                if ((r = n.getSel())) {
                  ...
                  t === !1 &&
                    r.extend &&
                    (r.collapse(e.endContainer, e.endOffset),
                    r.extend(e.startContainer, e.startOffset)),
                    (n.selectedRange =
                ...
                e.collapsed ||
                  ...
                  (e.endOffset - e.startOffset < 2 &&
                    ...
                    ((i = e.startContainer.childNodes[e.startOffset]),
                    i &&
                      "IMG" == i.tagName &&
                      n.getSel().setBaseAndExtent(i, 0, i, 1)));
              }
          },
          setNode: function (e) {
            var t = this;
            ...
            return n
              ? n.setStart
                ? ((r = n.commonAncestorContainer),
                  ...
                  3 === i.nodeType &&
                    3 === o.nodeType &&
                    ((i = i.length === a ? e(i.nextSibling, !0) : i.parentNode),
                    (o = 0 === s ? e(o.previousSibling, !1) : o.parentNode),
                    i && i === o))
                    ? i
                    : r && 3 == r.nodeType
                    ? r.parentNode
                    : r)
                : ((r = n.item ? n.item(0) : n.parentElement()),
                  r.ownerDocument !== t.win.document && (r = l),
                  r)
              : l;
          },
          ...
          isForward: function () {
            ...
            return t && t.anchorNode && t.focusNode
              ? ((n = e.createRng()),
                ...
                n.collapse(!0),
                (r = e.createRng()),
                r.setStart(t.focusNode, t.focusOffset),
                r.collapse(!0),
                n.compareBoundaryPoints(n.START_TO_START, r) <= 0)
              : !0;
          },
          normalize: function () {
            var e = this,
            ...
            return (
              a.range &&
                new i(e.dom).normalize(t) &&
                e.setRng(t, e.isForward()),
              t
            );
          },
          selectorChanged: function (e, t) {
            var n = this,
              r;
            return (
              n.selectorChangedData ||
                ((n.selectorChangedData = {}),
                (r = {}),
                n.editor.on("NodeChange", function (e) {
                  var t = e.element,
                    i = n.dom,
          ...
          scrollIntoView: function (e) {
            ...
            (r = o.getViewPort(i.editor.getWin())),
              (n = o.getPos(e).y),
              (s = r.y),
              (l = r.h),
              (n < r.y || n + 25 > s + l) &&
                i.editor.getWin().scrollTo(0, s > n ? n : n - l + 25);
          },
          ...
          _moveEndPoint: function (t, n, r) {
            ...
            "BODY" == i.nodeName &&
              (r ? t.setStart(i, 0) : t.setEnd(i, i.childNodes.length));
          },
          destroy: function () {
          ...
          return n.nodeName != i.nodeName
            ...
            : a(o(n), o(i)) &&
              a(
                ...
                t.parseStyle(t.getAttrib(i, "style"))
              )
    ...
    r(O, [f], function (e) {
      function t(e, t) {
        ...
        return (
          ...
          a.setStyles(o, { position: "absolute", left: -65535 }),
            ...
            if (
              !(
                ("background-color" == t &&
                  ...
                  ((n = a.getStyle(e.getBody(), t, !0)),
                  "#ffffff" == a.toHex(n).toLowerCase())) ||
    ...
    r(I, [m, w, H, P, f, O], function (e, t, n, r, i, o) {
      return function (a) {
        function s(e) {
          return (
            e.nodeType && (e = e.nodeName),
            !!a.schema.getTextBlockElements()[e.toLowerCase()]
          );
        }
        function l(e) {
        ...
        function h() {
          a.addShortcut("meta+b", "bold_desc", "Bold"),
            a.addShortcut("meta+i", "italic_desc", "Italic"),
            a.addShortcut("meta+u", "underline_desc", "Underline");
          for (var e = 1; 6 >= e; e++)
            a.addShortcut("access+" + e, "", ["FormatBlock", !1, "h" + e]);
        ...
        function m(e, t) {
          e &&
            ("string" != typeof e
              ...
              : ((t = t.length ? t : [t]),
                le(t, function (e) {
                  e.deep === re && (e.deep = !e.selector),
                    e.split === re && (e.split = !e.selector || e.inline),
                    e.remove === re &&
                      e.selector &&
                      !e.inline &&
                      (e.remove = "none"),
        ...
        function v(e) {
          var t;
          return (
            a.dom.getParent(e, function (e) {
              return (
                (t = a.dom.getStyle(e, "text-decoration")), t && "none" !== t
              );
            }),
            t
          );
        ...
        function y(e) {
          ...
          1 === e.nodeType &&
            ...
            ((t = v(e.parentNode)),
            a.dom.getStyle(e, "color") && t
              ? a.dom.setStyle(e, "text-decoration", t)
              : a.dom.getStyle(e, "text-decoration") === t &&
                a.dom.setStyle(e, "text-decoration", null));
        }
        function b(t, n, r) {
          function i(e, t) {
            if (((t = t || u), e)) {
            ...
            (l = u.inline || u.block),
                ...
                function r(e) {
                  ...
                  return (
                    ...
                    1 === e.nodeType &&
                      ...
                      ((x = h), (h = "true" === ie(e)), (b = !0)),
                    R(g, "br")
                      ? ((p = 0), void (u.block && q.remove(e)))
                      : u.wrapper && w(e, t, n)
                      ? void (p = 0)
                      : h && !b && u.block && !u.wrapper && s(g) && Y(v, l)
                      ? ((e = q.rename(e, l)), i(e), a.push(e), void (p = 0))
                      : u.selector &&
                        (le(c, function (t) {
                          ("collapsed" in t && t.collapsed !== m) ||
                            (q.is(e, t.selector) &&
                              !d(e) &&
                              (i(e, t), (y = !0)));
                        }),
              ...
              le(a, function (e) {
                ...
                if (u.inline || u.wrapper) {
                  ...
                  u.merge_with_parents &&
                    q.getParent(e.parentNode, function (r) {
                      return w(r, t, n)
                        ? (q.remove(e, 1), (e = 0), te)
                        : void 0;
                    }),
          ...
          if (u)
            if (r)
              ...
              m &&
              u.inline &&
              !q.select("td.mce-item-selected,th.mce-item-selected").length
            )
              V("apply", t, n);
            else {
              ...
              X ||
                !c[0].defaultBlock ||
                q.getParent(g, q.isBlock) ||
                b(c[0].defaultBlock),
                a.selection.setRng(o()),
                (f = j.getBookmark()),
                l(L(j.getRng(te), c), f),
                u.styles &&
                  (u.styles.color || u.styles.textDecoration) &&
                  (ue(g, y, "childNodes"), y(g)),
                j.moveToBookmark(f),
                U(j.getRng(te)),
                a.nodeChanged();
            }
        ...
        function x(e, t, n, r) {
          ...
          function o(n) {
            var i;
            return (
              le(u(n.parentNode).reverse(), function (n) {
                var o;
                i ||
                  "_start" == n.id ||
                  "_end" == n.id ||
                  ((o = w(n, e, t, r)), o && o.split !== !1 && (i = n));
              }),
              i
            );
          }
          ...
          function d(e) {
            ...
            return (
              se(n) && (n = n[e ? "firstChild" : "lastChild"]),
              3 == n.nodeType &&
                0 === n.data.length &&
                (n = e
            ...
            : void (j.isCollapsed() &&
              ...
              !q.select("td.mce-item-selected,th.mce-item-selected").length
                ...
                : ((g = j.getBookmark()),
                  f(j.getRng(te)),
                  j.moveToBookmark(g),
                  m.inline && _(e, t, j.getStart()) && U(j.getRng(!0)),
                  a.nodeChanged()));
        }
        function C(e, t, n) {
          var r = p(e);
          !_(e, t, n) || ("toggle" in r[0] && !r[0].toggle)
            ? b(e, t, n)
            : x(e, t, n);
        }
        function w(e, t, n, r) {
              ...
              if (s.length === re) {
                for (o in s)
                  if (s.hasOwnProperty(o)) {
                    if (
                      ((a = "attributes" === i ? q.getAttrib(e, o) : A(e, o)),
                      r && !a && !t.exact)
                    )
                      return;
          ...
          if (o && e)
            for (s = 0; s < o.length; s++)
              if (
                ((a = o[s]),
                T(e, a) && i(e, a, "attributes") && i(e, a, "styles"))
              ) {
                if ((l = a.classes))
        ...
        function _(e, t, n) {
          ...
          return n
            ? r(n)
            : ((n = j.getNode()),
              r(n) ? te : ((i = j.getStart()), i != n && r(i) ? te : ee));
        }
        function E(e, t) {
          var n,
            r = [],
        ...
        function T(e, t) {
          return R(e, t.inline)
            ...
            ? te
            : t.selector
            ? 1 == e.nodeType && q.is(e, t.selector)
            : void 0;
        }
        function R(e, t) {
          return (
        ...
        function B(e, t) {
          return (
            ("color" == t || "backgroundColor" == t) && (e = q.toHex(e)),
        ...
        function L(t, n, r) {
          function i(e) {
            ...
            if (
              ...
              (s = q.getRoot()),
              3 == r.nodeType && !M(r) && (e ? v > 0 : b < r.nodeValue.length))
            )
              return r;
            for (;;) {
          ...
          function c(t, n, i) {
            function o(e, t) {
              var n,
                ...
                a = e.nodeValue;
              return (
                "undefined" == typeof t && (t = i ? a.length : 0),
                i
                  ? ((n = a.lastIndexOf(" ", t)),
                    (o = a.lastIndexOf("\xa0", t)),
                    (n = n > o ? n : o),
                    -1 === n || r || n++)
                  : ((n = a.indexOf(" ", t)),
                    (o = a.indexOf("\xa0", t)),
            ...
            for (
              s = new e(t, q.getParent(t, G) || a.getBody());
              (l = s[i ? "prev" : "next"]());
            ...
            return u
              ? ((n = i ? 0 : u.length), { container: u, offset: n })
              : void 0;
          }
          function d(e, r) {
            var i, o, a, s;
            for (
              3 == e.nodeType && 0 === e.nodeValue.length && e[r] && (e = e[r]),
                i = u(e),
                o = 0;
              o < i.length;
              o++
              ...
              for (a = 0; a < n.length; a++)
                if (
                  ((s = n[a]),
                  !("collapsed" in s && s.collapsed !== t.collapsed) &&
                    q.is(i[o], s.selector))
                )
                  return i[o];
            return e;
          ...
          function f(e, t) {
            var r,
              i = q.getRoot();
            if (
              (n[0].wrapper || (r = q.getParent(e, n[0].block, i)),
              r ||
                (r = q.getParent(
          ...
          if (
            (1 == g.nodeType &&
              ...
              (g = g.childNodes[v > h ? h : v]),
              3 == g.nodeType && (v = 0)),
            1 == y.nodeType &&
              y.hasChildNodes() &&
              ((h = y.childNodes.length - 1),
              (y = y.childNodes[b > h ? h : b - 1]),
              3 == y.nodeType && (b = y.nodeValue.length)),
            (g = l(g)),
            (y = l(y)),
            (se(g.parentNode) || se(g)) &&
              ((g = se(g) ? g : g.parentNode),
              (g = g.nextSibling || g),
              3 == g.nodeType && (v = 0)),
            (se(y.parentNode) || se(y)) &&
              ((y = se(y) ? y : y.parentNode),
              (y = y.previousSibling || y),
              3 == y.nodeType && (b = y.length)),
            n[0].inline &&
              (t.collapsed &&
                ((m = c(g, v, !0)),
                m && ((g = m.container), (v = m.offset)),
                (m = c(y, b)),
                m && ((y = m.container), (b = m.offset))),
              (p = o(y, b)),
              p.node))
          ) {
            ...
            p.node &&
              p.offset > 0 &&
              3 === p.node.nodeType &&
              " " === p.node.nodeValue.charAt(p.offset - 1) &&
              p.offset > 1 &&
              ((y = p.node), y.splitText(p.offset - 1));
          }
          return (
            (n[0].inline || n[0].block_expand) &&
              ((n[0].inline && 3 == g.nodeType && 0 !== v) || (g = i(!0)),
              (n[0].inline && 3 == y.nodeType && b !== y.nodeValue.length) ||
                (y = i())),
            n[0].selector &&
              n[0].expand !== ee &&
              !n[0].inline &&
              ((g = d(g, "previousSibling")), (y = d(y, "nextSibling"))),
            (n[0].block || n[0].selector) &&
              ((g = f(g, "previousSibling")),
              (y = f(y, "nextSibling")),
              n[0].block && (G(g) || (g = i(!0)), G(y) || (y = i()))),
            1 == g.nodeType && ((v = J(g)), (g = g.parentNode)),
            1 == y.nodeType && ((b = J(y) + 1), (y = y.parentNode)),
            { startContainer: g, startOffset: v, endContainer: y, endOffset: b }
          );
        }
        function P(e, t) {
        ...
        function O(e, t, n, r) {
          ...
          if ("all" != e.remove)
            for (
              le(e.styles, function (i, o) {
                (i = B(D(i, t), o)),
                  "number" == typeof o && ((o = i), (r = 0)),
                  (e.remove_similar || !r || R(A(r, o), i)) &&
                    q.setStyle(n, o, ""),
                  (a = 1);
              }),
                a &&
                ...
                le(e.attributes, function (e, i) {
                  var o;
                  if (
                    ((e = D(e, t)),
                    "number" == typeof i && ((i = e), (r = 0)),
                    !r || R(q.getAttrib(r, i), e))
                  ) {
                    if (
                      "class" == i &&
                      ((e = q.getAttrib(n, i)),
                    ...
                    "class" == i && n.removeAttribute("className"),
                      Z.test(i) && n.removeAttribute("data-mce-" + i),
                      n.removeAttribute(i);
                  }
                }),
                le(e.classes, function (e) {
                  (e = D(e, t)),
                    (!r || q.hasClass(r, e)) && q.removeClass(n, e);
                }),
                o = q.getAttribs(n),
                i = 0;
              i < o.length;
        ...
        function I(e, t) {
          ...
          t.block &&
            (X
              ? r == q.getRoot() &&
                ((t.list_block && R(e, t.list_block)) ||
                  le(ce(e.childNodes), function (e) {
                    Y(X, e.nodeName.toLowerCase())
                      ? i
                        ? i.appendChild(e)
                        : ((i = H(e, X)),
                          q.setAttribs(i, a.settings.forced_root_block_attrs))
                      : (i = 0);
                  }))
              : G(e) &&
                !G(r) &&
                (n(e, ee) ||
                  n(e.firstChild, te, 1) ||
                  e.insertBefore(q.create("br"), e.firstChild),
                n(e, te) ||
                  n(e.lastChild, ee, 1) ||
                  e.appendChild(q.create("br")))),
            (t.selector && t.inline && !R(t.inline, e)) || q.remove(e, 1);
        }
        function F(e, t, n) {
          if (e)
            for (
        ...
        function W(t, n) {
          ...
          return (
            ...
            3 === r.nodeType &&
              ...
              (r = new e(r, a.getBody()).next() || r),
            3 !== r.nodeType ||
              n ||
              0 !== i ||
              (r = new e(r, a.getBody()).prev() || r),
            r
          );
        }
        function V(t, n, r, i) {
          ...
          function d(e, t) {
            ...
            if (e)
              (r = j.getRng(!0)),
                l(e)
                  ? (t !== !1 && (r.setStartBefore(e), r.setEndBefore(e)),
                    q.remove(e))
                  : ((n = u(e)),
                    n.nodeValue.charAt(0) === Q &&
                      (n.deleteData(0, 1),
                      r.startContainer == n &&
                        r.startOffset > 0 &&
                        r.setStart(n, r.startOffset - 1),
                      r.endContainer == n &&
                        r.endOffset > 0 &&
                        r.setEnd(n, r.endOffset - 1)),
                    q.remove(e, 1)),
                j.setRng(r);
          ...
          function h() {
            ...
            for (
              t = e.startContainer,
                ...
                u = t,
                3 == t.nodeType &&
                  (a != t.nodeValue.length && (c = !0), (u = u.parentNode));
              u;
            ...
            if (d)
              if (c)
                ...
                g && q.isEmpty(g)
                  ...
                  : q.insertAfter(m, d),
                  j.setCursorLocation(u, 1),
                  q.isEmpty(d) && q.remove(d);
              }
          }
          function m() {
            var e;
                ...
                ue(
                  ...
                  function (e) {
                    1 != e.nodeType ||
                      e.id === g ||
                      q.isEmpty(e) ||
                      q.setAttrib(e, "data-mce-bogus", null);
                  },
                  "childNodes"
                );
          }
        ...
        function U(t) {
          ...
          if (
            (t.startContainer != t.endContainer ||
              !c(t.startContainer.childNodes[t.startOffset])) &&
            (3 == n.nodeType &&
              r >= n.nodeValue.length &&
              ((r = J(n)), (n = n.parentNode), (i = !0)),
            1 == n.nodeType)
          )
            for (
              s = n.childNodes,
                n = s[Math.min(r, s.length - 1)],
                o = new e(n, q.getParent(n, q.isBlock)),
                (r > s.length - 1 || i) && o.next(),
                a = o.current();
              a;
              a = o.next()
            )
              if (3 == a.nodeType && !M(a))
                return (
                  (l = q.create("a", { "data-mce-bogus": "all" }, Q)),
    ...
    r(F, [D, u, f, k], function (e, t, n, r) {
      ...
      return (
        ...
        function (e) {
          function n() {
            var t = e.getContent({ format: "raw", no_events: 1 }),
              ...
              d = e.schema;
            for (
              t = t.replace(o, ""), u = d.getShortEndedElements();
              (c = n.exec(t));

            )
              (s = n.lastIndex),
                (l = c[0].length),
                (a = u[c[1]] ? s : r.findEndTag(d, t, s)),
                (t = t.substring(0, s - l) + t.substring(a)),
                (n.lastIndex = s - l);
            return i(t);
          }
          function a(t) {
          ...
          return (
            ...
            e.on("SaveContent ObjectResized blur", s),
            e.on("DragEnd", s),
              ...
              r.isDefaultPrevented() ||
                ...
                f &&
                  ...
                  (e.isDirty() ||
                    (a(u[0] && n() != u[0].content),
                    e.isNotDirty ||
                      e.fire("change", { level: u[0], lastLevel: null })),
                  e.fire("TypingUndo"),
                  (f = !1),
                  e.nodeChanged()));
            }),
            e.on("KeyDown", function (e) {
              ...
              if (!e.isDefaultPrevented()) {
                ...
                !(16 > t || t > 20) ||
                  ...
                  l.typing ||
                  n ||
                  (l.beforeChange(), (l.typing = !0), l.add({}, e), (f = !0));
              }
            }),
            ...
            (l = {
              ...
              add: function (t, r) {
                ...
                if (
                  (u[c] && (u[c].beforeBookmark = d),
                  o.custom_undo_redo_levels &&
                    u.length > o.custom_undo_redo_levels)
                ) {
                  for (i = 0; i < u.length - 1; i++) u[i] = u[i + 1];
                  u.length--, (c = u.length);
                }
                (t.bookmark = e.selection.getBookmark(2, !0)),
                  c < u.length - 1 && (u.length = c + 1),
                  u.push(t),
                  (c = u.length - 1);
                var l = { level: t, lastLevel: s, originalEvent: r };
                return (
                  e.fire("AddUndo", l), c > 0 && (a(!0), e.fire("change", l)), t
                );
              },
              undo: function () {
                var t;
                return (
                  l.typing && (l.add(), (l.typing = !1)),
                  c > 0 &&
                    ((t = u[--c]),
                    0 === c && a(!1),
                    e.setContent(t.content, { format: "raw" }),
                    e.selection.moveToBookmark(t.beforeBookmark),
                    e.fire("undo", { level: t })),
                  t
                );
              },
              redo: function () {
                ...
                return (
                  c < u.length - 1 &&
                    ((t = u[++c]),
                    e.setContent(t.content, { format: "raw" }),
                    e.selection.moveToBookmark(t.bookmark),
                    a(!0),
                    e.fire("redo", { level: t })),
                  t
                );
      ...
      return function (i) {
        function o(o) {
          ...
          function p(e) {
            ...
            a.isBlock(e) &&
              ((t = s.getRng()),
              e.appendChild(a.create("span", null, "\xa0")),
              s.select(e),
          ...
          function m(e) {
            ...
            if (t) {
              ...
              for (r = n.length; r--; )
                (t = n[r]),
                  !t.hasChildNodes() ||
                  (t.firstChild == t.lastChild && "" === t.firstChild.nodeValue)
                    ? a.remove(t)
                    : "A" == t.nodeName &&
            ...
            if (t) {
              if (
                (n.ie &&
                  ...
                  "BR" == M.firstChild.tagName &&
                  a.remove(M.firstChild),
                /^(LI|DT|DD)$/.test(t.nodeName))
              ) {
                var d = r(t.firstChild);
                d &&
                  /^(UL|OL|DL)$/.test(d.nodeName) &&
                  t.insertBefore(a.doc.createTextNode("\xa0"), t.firstChild);
              }
              if (
                ((l = a.createRng()), n.ie || t.normalize(), t.hasChildNodes())
              ) {
                ...
                "BR" == t.nodeName
                  ? t.nextSibling && a.isBlock(t.nextSibling)
                    ? ((!H || 9 > H) &&
                        ((u = a.create("br")), t.parentNode.insertBefore(u, t)),
                      l.setStartBefore(t),
                      l.setEndBefore(t))
          ...
          function v(e) {
            ...
            t &&
              t.toLowerCase() === e.tagName.toLowerCase() &&
              a.setAttribs(e, l.forced_root_block_attrs);
          }
          function y(e) {
          ...
          function x(t) {
            var n, r, i;
            if (3 == B.nodeType && (t ? D > 0 : D < B.nodeValue.length))
              return !1;
            if (B.parentNode == M && V && !t) return !0;
            if (t && 1 == B.nodeType && B == M.firstChild) return !0;
            if (
              "TABLE" === B.nodeName ||
              (B.previousSibling && "TABLE" == B.previousSibling.nodeName)
            )
              return (V && !t) || (!V && t);
            for (
              n = new e(B, M),
              ...
              if (1 === r.nodeType) {
                if (
                  ...
                  ((i = r.nodeName.toLowerCase()), d[i] && "br" !== i)
                )
                  return !1;
          ...
          function C(e, t) {
            var n,
              ...
              d = W || "P";
            if (
              ((r = a.getParent(e, a.isBlock)),
              (c = i.getBody().nodeName.toLowerCase()),
              !r || !h(r))
            ) {
              if (((r = r || A), !r.hasChildNodes()))
                return (
                  (n = a.create(d)),
                  v(n),
                  r.appendChild(n),
              ...
              if (o && u.isValidChild(c, d.toLowerCase())) {
                for (
                  n = a.create(d), v(n), o.parentNode.insertBefore(n, o), s = o;
                  s && !a.isBlock(s);
          ...
          function w() {
            function e(e) {
              for (
                var t = I[e ? "firstChild" : "lastChild"];
                t && 1 != t.nodeType;
            ...
            /^(OL|UL|LI)$/.test(n) && (W = "LI"),
              ...
              e(!0) && e()
                ...
                ? "LI" == n
                  ? (a.insertAfter(P, t()),
                    P.appendChild(a.doc.createTextNode(" ")),
                    P.appendChild(I))
                  : I.parentNode.insertBefore(P, I)
                : e()
                ? (a.insertAfter(P, t()), p(P))
                : ((I = t()),
                  (R = T.cloneRange()),
                  R.setStartAfter(M),
                  R.setEndAfter(I),
                  (O = R.extractContents()),
                  "LI" == W && "LI" == O.firstChild.nodeName
                    ? ((P = O.firstChild), a.insertAfter(O, I))
                    : (a.insertAfter(O, I), a.insertAfter(P, I))),
              a.remove(M),
              g(P),
              c.add();
          }
          ...
          function k(e) {
            ...
            r ||
              (e.normalize(),
              (t = e.lastChild),
              (!t || /^(left|right)$/gi.test(a.getStyle(t, "float", !0))) &&
                a.add(e, "br"));
          }
          function S() {
            (P = /^(H[1-6]|PRE|FIGURE)$/.test(F) && "HGROUP" != z ? b(W) : b()),
              l.end_container_on_empty_block && h(I) && a.isEmpty(M)
                ? (P = a.split(I, M))
                : a.insertAfter(P, M),
              g(P);
          }
          ...
          if (((T = s.getRng(!0)), !o.isDefaultPrevented())) {
            ...
            if (
              ...
              (B = T.startContainer),
              (D = T.startOffset),
              (W = (l.force_p_newlines ? "p" : "") || l.forced_root_block),
              (W = W ? W.toUpperCase() : ""),
              (H = a.doc.documentMode),
              (L = o.shiftKey),
              1 == B.nodeType &&
                B.hasChildNodes() &&
                ((V = D > B.childNodes.length - 1),
                (B = B.childNodes[Math.min(D, B.childNodes.length - 1)] || B),
                (D = V && 3 == B.nodeType ? B.nodeValue.length : 0)),
              (A = N(B)))
            ) {
              if ((c.beforeChange(), !a.isBlock(A) && A != a.getRoot()))
                return void ((!W || L) && _());
              if (
                (((W && !L) || (!W && L)) && (B = C(B, D)),
                (M = a.getParent(B, a.isBlock)),
                (I = M ? a.getParent(M.parentNode, a.isBlock) : null),
                (F = M ? M.nodeName.toUpperCase() : ""),
                (z = I ? I.nodeName.toUpperCase() : ""),
                "LI" != z || o.ctrlKey || ((M = I), (F = z)),
                /^(LI|DT|DD)$/.test(F))
              ) {
              ...
              (W && M === i.getBody()) ||
                ...
                x()
                  ? S()
                  : x(!0)
                  ? ((P = M.parentNode.insertBefore(b(), M)), p(P), g(M))
                  : ((R = T.cloneRange()),
                    R.setEndAfter(M),
                    (O = R.extractContents()),
                    E(O),
                    ...
                    k(M),
                    a.isEmpty(M) && y(M),
                    a.isEmpty(P) ? (a.remove(P), S()) : g(P)),
                a.setAttrib(P, "id", ""),
                i.fire("NewBlock", { newBlock: P }),
                c.add());
            }
          }
        }
          ...
          if (((x = n.forced_root_block), t && 1 === t.nodeType && x)) {
            ...
            if (((l = i.getRng()), l.setStart)) {
              ...
              l.item &&
                ...
                (v = l.parentElement().ownerDocument === e.getDoc()),
                (y = l.duplicate()),
                y.collapse(!0),
                (u = -1 * y.move("character", m)),
                y.collapsed ||
                  ((y = l.duplicate()),
                  y.collapse(!1),
            ...
            for (t = s.firstChild, b = s.nodeName.toLowerCase(); t; )
              if (
                (3 === t.nodeType || (1 == t.nodeType && !a[t.nodeName])) &&
                o.isValidChild(b, x.toLowerCase())
              ) {
                ...
                h ||
                  ((h = r.create(x, e.settings.forced_root_block_attrs)),
        ...
        function v(e, t, n, i) {
          ...
          if (
            (/^(mceAddUndoLevel|mceEndUndoLevel|mceBeginUndoLevel|mceRepaint)$/.test(
              ...
              r.focus(),
            (i = l({}, i)),
            (i = r.fire("BeforeExecCommand", { command: e, ui: t, value: n })),
            i.isDefaultPrevented())
          )
            return !1;
          if (((a = e.toLowerCase()), (o = H.exec[a])))
            return (
              o(a, t, n),
              r.fire("ExecCommand", { command: e, ui: t, value: n }),
              !0
            );
          if (
            (s(r.plugins, function (i) {
          ...
          if (r.theme && r.theme.execCommand && r.theme.execCommand(e, t, n))
            return r.fire("ExecCommand", { command: e, ui: t, value: n }), !0;
          try {
            c = r.getDoc().execCommand(e, t, n);
          } catch (u) {}
          return c
            ? (r.fire("ExecCommand", { command: e, ui: t, value: n }), !0)
            : !1;
        }
        function y(e) {
          var t;
          ...
          x({
            ...
            "Cut,Copy,Paste": function (e) {
              ...
              if (i || !t.queryCommandSupported(e)) {
                ...
                n.mac && (a = a.replace(/Ctrl\+/g, "\u2318+")),
                  r.windowManager.alert(a);
              }
            },
            unlink: function () {
              if (D.isCollapsed()) {
            ...
            "JustifyLeft,JustifyCenter,JustifyRight,JustifyFull,JustifyNone":
              function (e) {
                var t = e.substring(7);
                "full" == t && (t = "justify"),
                  s("left,center,right,justify".split(","), function (e) {
            ...
            FontSize: function (e, t, n) {
              ...
              n >= 1 &&
                7 >= n &&
                ((i = d(L.font_size_style_values)),
                (r = d(L.font_size_classes)),
                (n = r ? r[n - 1] || n : i[n - 1] || n)),
                T(e, n);
            },
            ...
            mceCleanup: function () {
              var e = D.getBookmark();
              r.setContent(r.getContent({ cleanup: m }), { cleanup: m }),
                D.moveToBookmark(e);
            },
            ...
            mceInsertContent: function (t, n, o) {
              ...
              var d,
                ...
                _,
                E,
                N = r.schema.getTextInlineElements();
              "string" != typeof o &&
                ((_ = o.merge), (E = o.data), (o = o.content)),
                /^ | $/.test(o) && (o = a(o)),
                (d = r.parser),
                (f = new e({}, r.schema)),
                (w =
                  '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;&#x200B;</span>'),
                (v = { content: o, format: "html", selection: !0 }),
                r.fire("BeforeSetContent", v),
                (o = v.content),
              ...
              var k =
                  b.startContainer ||
                  (b.parentElement ? b.parentElement() : null),
                S = r.getBody();
              k === S &&
                D.isCollapsed() &&
                B.isBlock(S.firstChild) &&
                B.isEmpty(S.firstChild) &&
                ((b = B.createRng()),
                b.setStart(S.firstChild, 0),
                b.setEnd(S.firstChild, 0),
                D.setRng(b)),
                D.isCollapsed() ||
                  (r.getDoc().execCommand("Delete", !1, null), l()),
                (p = D.getNode());
              ...
              if (
                ...
                c(g),
                (x = g.lastChild),
                "mce_marker" == x.attr("id"))
              )
                for (y = x, x = x.prev; x; x = x.walk(!0))
                  if (3 == x.type || !B.isBlock(x.name)) {
                    r.schema.isValidChild(x.parent.name, "span") &&
                      x.parent.insert(y, x, "br" === x.name);
                    break;
                  }
              if (T.invalid) {
                for (
                  D.setContent(w),
                    p = D.getNode(),
                    m = r.getBody(),
                    9 == p.nodeType ? (p = x = m) : (x = p);
                  x !== m;

                )
                  (p = x), (x = x.parentNode);
                (o = p == m ? m.innerHTML : B.getOuterHTML(p)),
                  (o = f.serialize(
                    d.parse(
                      o.replace(
              ...
              u(),
                ...
                (x = y.previousSibling),
                x && 3 == x.nodeType
                  ? (b.setStart(x, x.nodeValue.length),
                    h ||
                      ((C = y.nextSibling),
                      C &&
                        3 == C.nodeType &&
                        (x.appendData(C.data), C.parentNode.removeChild(C))))
                  : (b.setStartBefore(y), b.setEndBefore(y)),
                B.remove(y),
                D.setRng(b),
                r.fire("SetContent", v),
                r.addVisual();
            ...
            mceInsertRawHTML: function (e, t, n) {
              D.setContent("tiny_mce_marker"),
                r.setContent(
                  r.getContent().replace(/tiny_mce_marker/g, function () {
                    return n;
                  })
                );
            },
            ...
            "Indent,Outdent": function (e) {
              ...
              (t = L.indentation),
                (n = /[a-z%]+$/i.exec(t)),
                (t = parseInt(t, 10)),
                y("InsertUnorderedList") || y("InsertOrderedList")
                  ? k(e)
                  : (L.forced_root_block ||
                      B.getParent(D.getNode(), B.isBlock) ||
                      M.apply("div"),
                    s(D.getSelectedBlocks(), function (o) {
                      if ("LI" != o.nodeName) {
                        var a = r.getParam("indent_use_margin", !1)
                          ? "margin"
                          : "padding";
                        (a +=
                          "rtl" == B.getStyle(o, "direction", !0)
                            ? "Right"
                            : "Left"),
                          "outdent" == e
                            ? ((i = Math.max(
                                0,
                                parseInt(o.style[a] || 0, 10) - t
                              )),
                              B.setStyle(o, a, i ? i + n : ""))
                            : ((i = parseInt(o.style[a] || 0, 10) + t + n),
                              B.setStyle(o, a, i));
                      }
                    }));
            },
            mceRepaint: function () {
              if (f)
                try {
                  R(m),
                    D.getSel() && D.getSel().selectAllChildren(r.getBody()),
                    D.collapse(m),
                    A();
                } catch (e) {}
            },
            ...
            mceReplaceContent: function (e, t, n) {
              r.execCommand(
                "mceInsertContent",
                !1,
                n.replace(/\{\$selection\}/g, D.getContent({ format: "text" }))
              );
            },
            mceInsertLink: function (e, t, n) {
              var r;
              "string" == typeof n && (n = { href: n }),
                (r = B.getParent(D.getNode(), "a")),
                (n.href = n.href.replace(" ", "%20")),
                (r && n.href) || M.remove("link"),
                n.href && M.apply("link", n, r);
            },
            selectAll: function () {
              var e = B.getRoot(),
                t;
              D.getRng().setStart
                ? ((t = B.createRng()),
                  ...
                  D.setRng(t))
                : ((t = D.getRng()),
                  t.item || (t.moveToElementText(e), t.select()));
            },
            delete: function () {
              k("Delete");
              var e = r.getBody();
              B.isEmpty(e) &&
                (r.setContent(""),
                e.firstChild && B.isBlock(e.firstChild)
            ...
            InsertLineBreak: function (e, t, n) {
              function i() {
                for (
                  var e = new a(h, v), t, n = r.schema.getNonEmptyElements();
                  (t = e.next());
              ...
              if (1 == h.nodeType && h.hasChildNodes()) {
                ...
                (h = h.childNodes[Math.min(f, h.childNodes.length - 1)] || h),
                  (f = g && 3 == h.nodeType ? h.nodeValue.length : 0);
              }
              ...
              return (
                p &&
                  "PRE" == y &&
                  (!w || 8 > w) &&
                  l.parentNode.insertBefore(B.doc.createTextNode("\r"), l),
                (u = B.create("span", {}, "&nbsp;")),
                ...
                c
                  ...
                  : (d.setStartAfter(l), d.setEndAfter(l)),
                D.setRng(d),
                r.undoManager.add(),
                m
              );
          ...
          x(
            {
              ...
              Outdent: function () {
                ...
                if (L.inline_styles) {
                  if (
                    (e = B.getParent(D.getStart(), B.isBlock)) &&
                    parseInt(e.style.paddingLeft, 10) > 0
                  )
                    return m;
                  if (
                    (e = B.getParent(D.getEnd(), B.isBlock)) &&
                    parseInt(e.style.paddingLeft, 10) > 0
                  )
                    return m;
                }
                return (
                  ...
                  y("InsertOrderedList") ||
                  (!L.inline_styles && !!B.getParent(D.getNode(), "BLOCKQUOTE"))
                );
              },
              "InsertUnorderedList,InsertOrderedList": function (e) {
    ...
    r(U, [f], function (e) {
      function t(e, o) {
        ...
        0 !== e.indexOf("/") ||
          c ||
          (e = (s ? s.protocol || "http" : "http") + "://mce_host" + e),
          /^[\w\-]*:?\/\//.test(e) ||
            ((l = o.base_uri
              ? o.base_uri.path
              : new t(location.href).directory),
            "" === o.base_uri.protocol
              ? (e = "//mce_host" + a.toAbsPath(l, e))
              : ((e = /([^#?]*)([#?]?.*)/.exec(e)),
                (e =
                  ((s && s.protocol) || "http") +
                  "://mce_host" +
          ...
          s &&
            (a.protocol || (a.protocol = s.protocol),
            a.userInfo || (a.userInfo = s.userInfo),
            a.port || "mce_host" !== a.host || (a.port = s.port),
            (a.host && "mce_host" !== a.host) || (a.host = s.host),
            (a.source = "")),
          c && (a.protocol = "");
      }
      var n = e.each,
        ...
        (t.prototype = {
          ...
          toRelative: function (e) {
            ...
            var i = n.getURI(),
              o = e.getURI();
            return i == o ||
              ("/" == i.charAt(i.length - 1) && i.substr(0, i.length - 1) == o)
              ? i
              : ((r = n.toRelPath(n.path, e.path)),
                e.query && (r += "?" + e.query),
                e.anchor && (r += "#" + e.anchor),
                r);
          },
          ...
          toAbsPath: function (e, t) {
            ...
            return (
              ...
              (s =
                0 >= r
                  ? o.reverse().join("/")
                  : e.slice(0, r).join("/") + "/" + o.reverse().join("/")),
              0 !== s.indexOf("/") && (s = "/" + s),
        ...
        (t.extend = i =
          function (e) {
            ...
            (o = !0),
              ...
              (o = !1),
              e.Mixins &&
                (n(e.Mixins, function (t) {
                  t = t;
                  for (var n in t) "init" !== n && (e[n] = t[n]);
                }),
                c.Mixins && (e.Mixins = c.Mixins.concat(e.Mixins))),
              e.Methods &&
                n(e.Methods.split(","), function (t) {
                  e[t] = a;
                }),
              e.Properties &&
                n(e.Properties.split(","), function (t) {
                  var n = "_" + t;
                  e[t] = function (e) {
                    var t = this,
                      r;
              ...
              e.Statics &&
                n(e.Statics, function (e, n) {
                  t[n] = e;
                }),
              e.Defaults &&
                c.Defaults &&
                (e.Defaults = r({}, c.Defaults, e.Defaults));
            for (d in e)
              (f = e[d]),
                "function" == typeof f && c[d] ? (u[d] = s(d, f)) : (u[d] = f);
            ...
            for (o = e.toLowerCase().split(" "), n = o.length; n--; ) {
              ...
              if (r) {
                if (t)
                  for (a = r.length; a--; )
                    r[a].func === t &&
                      ((r = r.slice(0, a).concat(r.slice(a + 1))), (d[e] = r));
                else r.length = 0;
    ...
    r(K, [q], function (e) {
      function t(t) {
        return (
          t._eventDispatcher ||
            (t._eventDispatcher = new e({
              scope: t,
              toggleEvent: function (n, r) {
                e.isNative(n) &&
                  t.toggleNativeEvent &&
                  t.toggleNativeEvent(n, r);
              },
            })),
          t._eventDispatcher
        );
      ...
      return n.extend({
        ...
        set: function (t, n) {
          var r,
            ...
            a = this.data[t];
          if (
            (n instanceof e && (n = n.create(this, t)), "object" == typeof t)
          ) {
          ...
          return (
            o(a, n) ||
              ((this.data[t] = n),
              (i = { target: this, name: t, value: n, oldValue: a }),
        ...
        parseBox: function (e) {
          ...
          if (e)
            return "number" == typeof e
              ? ((e = e || 0), { top: e, left: e, bottom: e, right: e })
              : ((e = e.split(" ")),
                (t = e.length),
                1 === t
                  ? (e[1] = e[2] = e[3] = e[0])
        ...
        function d(e) {
          ...
          function r(t) {
            ...
            if (n !== r) {
              if (
                ((c._lastHoverCtrl = n),
                (a = n.parents().toArray().reverse()),
                a.push(n),
                r)
              ) {
                for (
                  s = r.parents().toArray().reverse(), s.push(r), i = 0;
                  i < s.length && a[i] === s[i];
                  i++
                );
          ...
          if ((u = e._nativeEvents)) {
            for (
              l = e.parents().toArray(), l.unshift(e), o = 0, s = l.length;
              !c && s > o;
              o++
            )
              c = l[o]._eventsRoot;
            for (
              c || (c = l[l.length - 1] || e), e._eventsRoot = c, s = o, o = 0;
              s > o;
              o++
            )
              l[o]._eventsRoot = c;
            ...
            for (d in u) {
              ...
              "wheel" !== d || h
                ? ("mouseenter" === d || "mouseleave" === d
                    ? c._hasMouseEnter ||
                      (a(c.getEl()).on("mouseleave", n).on("mouseover", r),
                      (c._hasMouseEnter = 1))
                    : p[d] || (a(c.getEl()).on(d, t), (p[d] = !0)),
                  (u[d] = !1))
                : f
                ? a(e.getEl()).on("mousewheel", i)
                : a(e.getEl()).on("DOMMouseScroll", i);
            }
          }
        }
        var f = "onmousewheel" in document,
          ...
          v = {
              ...
              (i.settings = e = t.extend({}, i.Defaults, e)),
                ...
                (i.classes = new l(function () {
                  i.state.get("rendered") &&
                    (i.getEl().className = this.toString());
                })),
                (i.classes.prefix = i.classPrefix),
                (o = e.classes),
                o &&
                  (i.Defaults &&
                    ((c = i.Defaults.classes), c && o != c && n(c)),
                  n(o)),
                t.each(
              ...
              return (
                ...
                e
                  ? ((o = n.deltaW),
                    ...
                    e.x !== s && (n.x = e.x),
                    e.y !== s && (n.y = e.y),
                    e.minW !== s && (n.minW = e.minW),
                    e.minH !== s && (n.minH = e.minH),
                    (i = e.w),
                    i !== s &&
                      ((i = i < n.minW ? n.minW : i),
                      (i = i > n.maxW ? n.maxW : i),
                    ...
                    (i = e.innerW),
                    i !== s &&
                      ((i = i < n.minW - o ? n.minW - o : i),
                      (i = i > n.maxW - o ? n.maxW - o : i),
                      (n.innerW = i),
                      (n.w = i + o)),
                    (i = e.innerH),
                    i !== s &&
                      ((i = i < n.minH - a ? n.minH - a : i),
                      (i = i > n.maxH - a ? n.maxH - a : i),
                      (n.innerH = i),
                      (n.h = i + a)),
                    e.contentW !== s && (n.contentW = e.contentW),
                    e.contentH !== s && (n.contentH = e.contentH),
                    (r = t._lastLayoutRect),
                    (r.x !== n.x ||
                      r.y !== n.y ||
                      r.w !== n.w ||
            ...
            repaint: function () {
              ...
              (c = document.createRange
                ...
                e._hasBody &&
                  ...
                  ((u = c(i.innerW)),
                  (r = e.getEl("body")),
                  r && ((n = r.style), (n.width = (u >= 0 ? u : 0) + "px")),
                  (l.innerW = i.innerW)),
                e._hasBody &&
                  i.innerH !== l.innerH &&
                  ((u = c(i.innerH)),
                  (r = r || e.getEl("body")),
                  r &&
                    ((n = n || r.style), (n.height = (u >= 0 ? u : 0) + "px")),
                  (l.innerH = i.innerH)),
              ...
              function n(e) {
                ...
                return "string" != typeof e
                  ...
                  : function (i) {
                      return (
                        t ||
                          r.parentsAndSelf().each(function (r) {
                            var i = r.settings.callbacks;
                            return i && (t = i[e]) ? ((n = r), !1) : void 0;
                          }),
                        t
                          ? t.call(n, i)
                          : ((i.action = e), void this.fire("execute", i))
                      );
                    };
              }
              var r = this;
            ...
            getEl: function (e) {
              ...
              return (
                this._elmCache[t] || (this._elmCache[t] = a("#" + t)[0]),
                this._elmCache[t]
              );
            },
            show: function () {
              ...
              return "undefined" == typeof t
                ...
                : ((n._aria[e] = t),
                  n.state.get("rendered") &&
                    r.setAttribute("role" == e ? e : "aria-" + e, t),
                  n);
            },
            encode: function (e, t) {
              return (
                t !== !1 && (e = this.translate(e)),
            ...
            renderTo: function (e) {
              return (
                a(e || this.getContainerElm()).append(this.renderHtml()),
                this.postRender(),
                this
              );
            },
            ...
            postRender: function () {
              ...
              e.state.get("visible") === !1 &&
                (e.getEl().style.display = "none"),
                e.bindStates(),
                e.state.on("change:visible", function (t) {
                  var n = t.value,
                    r;
                  e.state.get("rendered") &&
                    ((e.getEl().style.display = n === !1 ? "none" : ""),
                    e.getEl().getBoundingClientRect()),
                    (r = e.parent()),
                    r && (r._lastRect = null),
                    e.fire(n ? "show" : "hide"),
                    c.add(e);
            ...
            function (e) {
              v[e] = function (t) {
                return 0 === arguments.length
                  ? this.state.get(e)
                  : ("undefined" != typeof t && this.state.set(e, t), this);
              };
            }
          ),
          (m = e.extend(v))
    ...
    r(re, [], function () {
      return function (e) {
        ...
        function a(e) {
          return o(e) && !e.hidden
            ? !0
            : /^(button|menuitem|checkbox|tab|menuitemcheckbox|option|gridcell)$/.test(
                n(e)
              )
            ? !0
            : !1;
        ...
        function l(e) {
          ...
          for (
            var r = 0;
            r < n.length && ((t = n[r]), !t.settings.ariaRoot);
            r++
          );
          return t;
        }
        ...
        function u(e, t) {
          return (
            0 > e ? (e = t.length - 1) : e >= t.length && (e = 0),
            t[e] && t[e].focus(),
            e
          );
        }
        ...
        return e.extend({
          init: function (e) {
            ...
            n._super(e),
              ...
              (n.bodyClasses = new s(function () {
                n.state.get("rendered") &&
                  (n.getEl("body").className = this.toString());
              })),
          ...
          focus: function (e) {
            var t = this,
              ...
              r,
              i;
            return e && (r = t.keyboardNav || t.parents().eq(-1)[0].keyboardNav)
              ? void r.focusFirst(t)
              : ((i = t.find("*")),
                t.statusbar && i.add(t.statusbar.items()),
                i.each(function (e) {
                  return e.settings.autofocus
                    ? ((n = null), !1)
                    : void (e.canFocus && (n = n || e));
                }),
                n && n.focus(),
                t);
          },
              ...
              o.each(t, function (t) {
                t &&
                  (t instanceof e ||
                    ...
                    (i = o.extend({}, n.settings.defaults, t)),
                    (t.type = i.type =
                      i.type ||
                      t.type ||
                      n.settings.defaultType ||
                      (i.defaults ? i.defaults.type : null)),
                    (t = r.create(i))),
                  a.push(t));
              }),
              a
              ...
              e.items().each(function (t, n) {
                ...
                t.parent(e),
                  t.state.get("rendered") ||
                    ((r = e.getEl("body")),
                    r.hasChildNodes() && n <= r.childNodes.length - 1
                      ? a(r.childNodes[n]).before(t.renderHtml())
                      : a(r).append(t.renderHtml()),
                    t.postRender(),
                    l.add(t));
              }),
          ...
          postRender: function () {
            ...
            return (
              ...
              e.parent() || (e.keyboardNav = new i({ root: e })),
              e
            );
          },
          initLayoutRect: function () {
        ...
        (i = i || {}),
          (c = function (r) {
            ...
            n(r),
              ...
              (m = window.getComputedStyle
                ? window.getComputedStyle(p, null).getPropertyValue("cursor")
                : p.runtimeStyle.cursor),
              (a = e("<div>")
                .css({
                  position: "absolute",
                  top: 0,
          ...
          (d = function (e) {
            return (
              ...
              e.button !== l
                ? u(e)
                : ((e.deltaX = e.screenX - f),
                  (e.deltaY = e.screenY - h),
                  e.preventDefault(),
                  void i.drag(e))
            );
          }),
            ...
            function t(t, a, s, l, c, u) {
              ...
              if ((f = i.getEl("scroll" + t))) {
                if (
                  ((y = a.toLowerCase()),
                  (b = s.toLowerCase()),
                  e(i.getEl("absend")).css(y, i.layoutRect()[l] - 1),
                  !c)
                )
    ...
    r(le, [J], function (e) {
      ...
      return {
        ...
        moveTo: function (t, n) {
          ...
          return (
            i.state.get("rendered")
              ? i.layoutRect({ x: t, y: n }).repaint()
              : ((i.settings.x = t), (i.settings.y = n)),
            i.fire("move", { x: t, y: n }),
            i
          );
        },
      ...
      return {
        ...
        resizeTo: function (t, n) {
          ...
          return (
            ...
            this.layoutRect({ minW: t, minH: n, w: t, h: n }).reflow()
          );
        },
    ...
    r(ue, [se, le, ce, J, h], function (e, t, n, r, i) {
      ...
      function a(e) {
        for (var t = g.length; t--; ) {
          ...
          if (n.settings.autohide) {
            ...
            (e = n.fire("autohide", { target: e.target })),
        ...
        if (!m) {
          ...
          (m = function () {
            (document.all && t == e.clientWidth && n == e.clientHeight) ||
              ((t = e.clientWidth), (n = e.clientHeight), b.hideAll());
          }),
      ...
      function u(e) {
        ...
        e.settings.autofix &&
          (e.state.get("fixed")
            ? e._autoFixY > n &&
              (e.fixed(!1).layoutRect({ y: e._autoFixY }).repaint(),
              t(!1, e._autoFixY - n))
            : ((e._autoFixY = e.layoutRect().y),
              e._autoFixY < n &&
                (e.fixed(!0).layoutRect({ y: 0 }).repaint(),
                t(!0, n - e._autoFixY))));
      }
      function d(e, t) {
        var n,
          ...
          o;
        if (e) v.push(t);
        else for (n = v.length; n--; ) v[n] === t && v.splice(n, 1);
        if (v.length)
          for (n = 0; n < v.length; n++)
            v[n].modal && (r++, (o = v[n])),
              (v[n].getEl().style.zIndex = r),
              (v[n].zIndex = r),
              r++;
        var a = document.getElementById(t.classPrefix + "modal-block");
        o
          ? i(a).css("z-index", o.zIndex - 1)
          : a && (a.parentNode.removeChild(a), (y = !1)),
          (b.currentZIndex = r);
      }
      function f(e) {
        var t;
        ...
        b = e.extend({
          ...
          init: function (e) {
            ...
            t._super(e),
              ...
              e.popover &&
                ((t._preBodyHtml =
                  '<div class="' + t.classPrefix + 'arrow"></div>'),
                t.classes
                  .add("popover")
                  .add("bottom")
          ...
          close: function () {
            var e = this;
            return (
              e.fire("close").isDefaultPrevented() || (e.remove(), d(!1, e)), e
            );
          },
          remove: function () {
            f(this), this._super();
          ...
          postRender: function () {
            ...
            return (
              e.settings.bodyRole &&
                this.getEl("body").setAttribute("role", e.settings.bodyRole),
              e._super()
            );
          },
        });
    ...
    r(de, [ue, se, J, h, oe, Q, u], function (e, t, n, r, i, o, a) {
      function s(e) {
        var t =
          ...
          i;
        a.overrideViewPort !== !1 &&
          (n ||
            ((n = document.createElement("meta")),
            n.setAttribute("name", "viewport"),
            document.getElementsByTagName("head")[0].appendChild(n)),
          (i = n.getAttribute("content")),
          i && "undefined" != typeof d && (d = i),
          n.setAttribute("content", e ? t : d));
      }
      function l(e) {
        for (var t = 0; t < u.length; t++) if (u[t]._fullscreen) return;
        r([document.documentElement, document.body]).removeClass(
          e + "fullscreen"
        );
      }
      function c() {
        function e() {
          ...
          for (e = 0; e < u.length; e++)
            (r = u[e].layoutRect()),
              u[e].moveTo(
                u[e].settings.x || Math.max(0, t.w / 2 - r.w / 2),
                u[e].settings.y || Math.max(0, t.h / 2 - r.h / 2)
              );
        }
        ...
        window.setInterval(function () {
          ...
          (t.w != e || t.h != n) &&
            ((t = { w: e, h: n }), r(window).trigger("resize"));
        }, 0),
      ...
      var u = [],
        ...
        f = e.extend({
          ...
          init: function (e) {
            ...
            n._super(e),
              ...
              n.on("click", function (e) {
                -1 != e.target.className.indexOf(n.classPrefix + "close") &&
                  n.close();
              }),
          ...
          recalc: function () {
            ...
            e._fullscreen &&
              ...
              e.settings.title &&
                ...
                ((i = r.headerW),
                i > r.w &&
                  ((o = r.x - Math.max(0, i / 2)),
                  e.layoutRect({ w: i, x: o }),
                  (a = !0))),
              t &&
                (t.layoutRect({ w: e.layoutRect().innerW }).recalc(),
                (i = t.layoutRect().minW + r.deltaW),
                i > r.w &&
                  ((o = r.x - Math.max(0, i - r.w)),
                  e.layoutRect({ w: i, x: o }),
                  (a = !0))),
              a && e.recalc();
          },
          initLayoutRect: function () {
            ...
            return (
              (t.x = e.settings.x || Math.max(0, a.w / 2 - t.w / 2)),
            ...
            return (
              ...
              i.title &&
                (o =
                  ...
                  r +
                  'close" aria-hidden="true">\xd7</button><div id="' +
                  n +
                  '-dragh" class="' +
                  r +
                  'dragh"></div></div>'),
              i.url &&
                (s = '<iframe src="' + i.url + '" tabindex="-1"></iframe>'),
          ...
          fullscreen: function (e) {
            ...
            if (e != t._fullscreen)
              if (
                ...
                (t._initial = { x: l.x, y: l.y, w: l.w, h: l.h }),
                  (t.borderBox = o.parseBox("0")),
                  (t.getEl("head").style.display = "none"),
                  (l.deltaH -= l.headerH + 2),
                  r([i, document.body]).addClass(s + "fullscreen"),
                  t.classes.add("fullscreen");
                var c = n.getWindowSize();
                t.moveTo(0, 0).resizeTo(c.w, c.h);
              } else
                (t.borderBox = o.parseBox(t.settings.border)),
                  (t.getEl("head").style.display = ""),
                  (l.deltaH += l.headerH),
                  r([i, document.body]).removeClass(s + "fullscreen"),
                  t.classes.remove("fullscreen"),
                  t
                    .moveTo(t._initial.x, t._initial.y)
                    .resizeTo(t._initial.w, t._initial.h);
            return t.reflow();
          },
          postRender: function () {
            var e = this,
    ...
    r(pe, [D, w, m, E, v, u, f], function (e, t, n, r, i, o, a) {
      return function (s) {
        ...
        function d(e) {
          ...
          e.dataTransfer &&
            (s.selection.isCollapsed() &&
              "IMG" == e.target.tagName &&
              X.select(e.target),
            (t = s.selection.getContent()),
            t.length > 0 &&
              ((n = re + escape(s.id) + "," + escape(t)),
              e.dataTransfer.setData(ie, n)));
        }
        function f(e) {
          var t;
          return e.dataTransfer &&
            ((t = e.dataTransfer.getData(ie)), t && t.indexOf(re) >= 0)
            ? ((t = t.substr(re.length).split(",")),
        ...
        function p() {
          ...
          function i(e, t) {
            ...
            for (n = e.nextSibling; n && n != t; n = n.nextSibling)
              if ((3 != n.nodeType || 0 !== j.trim(n.data).length) && n !== t)
                return !1;
            return n === t;
          }
          function o(e, t, i) {
            var o, a, s;
            for (
              s = v.schema.getNonEmptyElements(), o = new n(i || e, e);
              (a = o[t ? "next" : "prev"]());
          ...
          function l(e) {
            ...
            if (
              !e.collapsed &&
              ((n = v.getParent(
                t.getNode(e.startContainer, e.startOffset),
                v.isBlock
              )),
              (r = v.getParent(
                t.getNode(e.endContainer, e.endOffset),
                v.isBlock
              )),
              (l = s.schema.getTextBlockElements()),
              n != r &&
                l[n.nodeName] &&
                l[r.nodeName] &&
                "false" !== v.getContentEditable(n) &&
                "false" !== v.getContentEditable(r))
            )
              return (
                e.deleteContents(),
                (i = o(n, !1)),
                (a = o(r, !0)),
                v.isEmpty(r) || j(n).append(r.childNodes),
                j(r).remove(),
                i
                  ? 1 == i.nodeType
                    ? "BR" == i.nodeName
                      ? (e.setStartBefore(i), e.setEndBefore(i))
                      : (e.setStartAfter(i), e.setEndAfter(i))
                    : (e.setStart(i, i.data.length), e.setEnd(i, i.data.length))
                  : a &&
                    (1 == a.nodeType
                      ? (e.setStartBefore(a), e.setEndBefore(a))
                      : (e.setStart(a, 0), e.setEnd(a, 0))),
                y.setRng(e),
                !0
              );
          }
          function c(e, n) {
            ...
            if (
              ((r = t.getNode(e.startContainer, e.startOffset)),
              (l = v.getParent(r, v.isBlock)),
              (a = o(s.getBody(), n, r)),
              (c = v.getParent(a, v.isBlock)),
              !r || !a)
            )
              return e;
            if (c && l != c)
              if (n) {
                ...
                1 == r.nodeType
                  ? "BR" == r.nodeName
                    ? e.setStartBefore(r)
                    : e.setStartAfter(r)
                  : e.setStart(r, r.data.length),
                  1 == a.nodeType ? e.setEnd(a, 0) : e.setEndBefore(a);
              } else {
                if (!i(c, l)) return e;
                1 == a.nodeType
                  ? "BR" == a.nodeName
          ...
          function m(e) {
            var t, n, r;
            p(e) ||
              (a.each(s.getBody().getElementsByTagName("*"), function (e) {
                "SPAN" == e.tagName && e.setAttribute("mce-data-marked", 1),
                  !e.hasAttribute("data-mce-style") &&
                    e.hasAttribute("style") &&
                    s.dom.setAttrib(e, "style", s.dom.getAttrib(e, "style"));
              }),
              (t = new b(function () {})),
              t.observe(s.getDoc(), {
                childList: !0,
              ...
              s.getDoc().execCommand(e ? "ForwardDelete" : "Delete", !1, null),
              (n = s.selection.getRng()),
              (r = n.startContainer.parentNode),
              a.each(t.takeRecords(), function (e) {
                if (v.isChildOf(e.target, s.getBody())) {
                  ...
                  a.each(e.addedNodes, function (e) {
                    if (
                      "SPAN" == e.nodeName &&
                      !e.getAttribute("mce-data-marked")
                    ) {
                      var t, i;
              ...
              t.disconnect(),
              a.each(s.dom.select("span[mce-data-marked]"), function (e) {
          ...
          b ||
            ...
            s.on("keypress", function (t) {
              if (
                ...
                var n, r, i, o, a, l;
                (n = s.selection.getRng()),
                  (l = String.fromCharCode(t.charCode)),
                  t.preventDefault(),
                  (r = j(n.startContainer)
                    .parents()
                    .filter(function (e, t) {
                  ...
                  r.length
                    ? ((i = v.createFragment()),
                      r.each(function (e, t) {
                        (t = t.cloneNode(!1)),
                          i.hasChildNodes()
                            ? (t.appendChild(i.firstChild), i.appendChild(t))
                            : ((a = t), i.appendChild(t)),
                          i.appendChild(t);
                      }),
                      a.appendChild(s.getDoc().createTextNode(l)),
                      (o = v.getParent(n.startContainer, v.isBlock)),
                      v.isEmpty(o) ? j(o).empty().append(i) : n.insertNode(i),
              ...
              s.on("cut", function (e) {
                u(e) ||
                  ...
                  e.clipboardData.setData(
                    "text/html",
                    s.selection.getContent()
                  ),
                  e.clipboardData.setData(
                    "text/plain",
                    s.selection.getContent({ format: "text" })
                  ),
                  window.setTimeout(function () {
                    m(!0);
                  }, 0));
        ...
        function m() {
          function e(e) {
            var t = G.create("body"),
              n = e.cloneContents();
            return (
              t.appendChild(n), X.serializer.serialize(t, { format: "html" })
            );
          }
          function n(n) {
            if (!n.setStart) {
          ...
          s.on("keydown", function (e) {
            ...
            if (!u(e) && (t == Y || t == K)) {
              ...
              e.preventDefault(),
                s.setContent(""),
                i.firstChild && G.isBlock(i.firstChild)
                  ? s.selection.setCursorLocation(i.firstChild, 0)
                  : s.selection.setCursorLocation(i, 0),
                s.nodeChanged();
            }
          });
        }
        ...
        function v() {
          s.settings.content_editable ||
            (G.bind(s.getDoc(), "focusin", function () {
              X.setRng(X.getRng());
            }),
            G.bind(s.getDoc(), "mousedown mouseup", function (e) {
              e.target == s.getDoc().documentElement &&
                (s.getBody().focus(),
                "mousedown" == e.type
                  ? X.placeCaretAt(e.clientX, e.clientY)
                  : X.setRng(X.getRng()));
            }));
        }
        function y() {
            ...
            if (!u(e) && e.keyCode === K) {
              ...
              if (X.isCollapsed() && 0 === X.getRng(!0).startOffset) {
                var t = X.getNode(),
                  n = t.previousSibling;
                if ("HR" == t.nodeName)
                  return G.remove(t), void e.preventDefault();
                n &&
                  n.nodeName &&
                  "hr" === n.nodeName.toLowerCase() &&
                  (G.remove(n), e.preventDefault());
              }
            }
          });
        }
        ...
        function x() {
          s.on("click", function (e) {
            ...
            /^(IMG|HR)$/.test(t.nodeName) &&
              (e.preventDefault(),
              X.getSel().setBaseAndExtent(t, 0, t, 1),
              s.nodeChanged()),
              "A" == t.nodeName &&
                G.hasClass(t, "mce-item-anchor") &&
                (e.preventDefault(), X.select(t));
          });
        }
        function C() {
          function e() {
          ...
          function t() {
            return (
              !X.isCollapsed() &&
              G.getParent(X.getStart(), G.isBlock) !=
                G.getParent(X.getEnd(), G.isBlock)
            );
          }
          s.on("keypress", function (n) {
            var r;
            return u(n) || (8 != n.keyCode && 46 != n.keyCode) || !t()
              ? void 0
              : ((r = e()),
                s.getDoc().execCommand("delete", !1, null),
                r(),
                n.preventDefault(),
                !1);
          }),
        ...
        function E() {
          c() > 7 ||
            (l("RespectVisibilityInDesign", !0),
            s.contentStyles.push(".mceHideBrInPre pre br {display: none}"),
            G.addClass(s.getBody(), "mceHideBrInPre"),
            Q.addNodeFilter("pre", function (e) {
              for (var t = e.length, n, i, o, a; t--; )
                for (n = e[t].getAll("br"), i = n.length; i--; )
                  (o = n[i]),
                    (a = o.prev),
                    a && 3 === a.type && "\n" != a.value.charAt(a.value - 1)
                      ? (a.value += "\n")
        ...
        function N() {
          G.bind(s.getBody(), "mouseup", function () {
            var e,
              t = X.getNode();
            "IMG" == t.nodeName &&
              ((e = G.getStyle(t, "width")) &&
                (G.setAttrib(t, "width", e.replace(/[^0-9%]+/g, "")),
                G.setStyle(t, "width", "")),
              (e = G.getStyle(t, "height")) &&
                (G.setAttrib(t, "height", e.replace(/[^0-9%]+/g, "")),
                G.setStyle(t, "height", "")));
          });
        }
        function k() {
          s.on("keydown", function (t) {
            ...
            if (
              ...
              "BLOCKQUOTE" === a.tagName &&
                (s.formatter.toggle("blockquote", null, a),
                (n = G.createRng()),
                n.setStart(r, 0),
                n.setEnd(r, 0),
                X.setRng(n));
        ...
        function S() {
          function e() {
            s._refreshContentEditable(),
              l("StyleWithCSS", !1),
              l("enableInlineTableEditing", !1),
              J.object_resizing || l("enableObjectResizing", !1);
          }
        ...
        function B() {
          s.on("keydown", function (e) {
            ...
            u(e) ||
              e.keyCode != K ||
              ((t = s.getDoc().selection.createRange()),
              t &&
                t.item &&
                (e.preventDefault(),
                s.undoManager.beforeChange(),
                G.remove(t.item(0)),
                s.undoManager.add()));
          });
        }
        function D() {
          ...
          c() >= 10 &&
            ((e = ""),
            q("p div h1 h2 h3 h4 h5 h6".split(" "), function (t, n) {
              e += (n > 0 ? "," : "") + t + ":empty";
            }),
            ...
            Z.addNodeFilter("noscript", function (e) {
              for (var t = e.length, n, o, a; t--; )
                (n = e[t]),
                  (o = e[t].firstChild),
                  o
                    ? (o.value = i.decode(o.value))
                    : ((a = n.attributes.map["data-mce-innertext"]),
                      a &&
        ...
        function H() {
          ...
          function t(t) {
            ...
            t.button
              ? ((r = e(t.x, t.y)),
                r &&
                  (r.compareEndPoints("StartToStart", a) > 0
          ...
          function n() {
            ...
            a &&
              ...
              a.select(),
              G.unbind(r, "mouseup", n),
              G.unbind(r, "mousemove", t),
              (a = o = 0);
          }
          var r = G.doc,
            i = r.body,
          ...
          (r.documentElement.unselectable = !0),
            G.bind(r, "mousedown contextmenu", function (i) {
        ...
        function I() {
          s.inline ||
            (s.contentStyles.push("body {min-height: 150px}"),
            s.on("click", function (e) {
              var t;
              if ("HTML" == e.target.nodeName) {
                if (o.ie > 11) return void s.getBody().focus();
                (t = s.selection.getRng()),
                  s.getBody().focus(),
        ...
        function W() {
          s.on("click", function (e) {
            var t = e.target;
            do if ("A" === t.tagName) return void e.preventDefault();
            while ((t = t.parentNode));
          }),
            s.contentStyles.push(
        ...
        k(),
          ...
          L(),
          ne &&
            (p(), v(), x(), R(), V(), _(), U(), o.iOS ? (O(), I(), W()) : g()),
          te && o.ie < 11 && (y(), w(), E(), N(), B(), D(), M(), H()),
          o.ie >= 11 && (I(), _()),
          o.ie && (g(), z(), $()),
          ee && (y(), b(), C(), S(), T(), A(), P(), F(), _());
      };
    }),
    r(me, [K, b, f], function (e, t, n) {
      function r(e, t) {
        return "selectionchange" == t
          ? e.getDoc()
          : !e.inline &&
            /^mouse|click|contextmenu|drop|dragover|dragend/.test(t)
          ? e.getDoc().documentElement
          : e.settings.event_root
          ? (e.eventRoot || (e.eventRoot = o.select(e.settings.event_root)[0]),
            e.eventRoot)
          : e.getBody();
      }
      function i(e, t) {
        ...
        if ((e.delegates || (e.delegates = {}), !e.delegates[t]))
          if (e.settings.event_root) {
            ...
            (i = function (n) {
              for (
                var r = n.target, i = e.editorManager.editors, a = i.length;
                a--;

              ) {
                var s = i[a].getBody();
                (s === r || o.isChildOf(r, s)) &&
                  (i[a].hidden || i[a].fire(t, n));
              }
            }),
              (a[t] = i),
              o.bind(n, t, i);
        ...
        s = {
            ...
            n.settings.readonly ||
              ("focus" != e &&
                ...
                (t
                  ...
                  : n.initialized &&
                    (n.dom.unbind(r(n, e), e, n.delegates[e]),
          ...
          unbindAllNativeEvents: function () {
            ...
            e.inline ||
              ...
              e.dom.unbind(e.getWin()),
              e.dom.unbind(e.getDoc())),
    ...
    r(ge, [f, u], function (e, t) {
      ...
      return function (a) {
        function s(e, s, l, c) {
          var u, d, f;
          (f = { func: l, scope: c || a, desc: a.translate(s) }),
            n(r(e, "+"), function (e) {
              e in o
                ? (f[e] = !0)
                : /^[0-9]{2,}$/.test(e)
                ? (f.keyCode = parseInt(e, 10))
                : ((f.charCode = e.charCodeAt(0)),
                  (f.keyCode = i[e] || e.toUpperCase().charCodeAt(0)));
            }),
            (u = [f.keyCode]);
          for (d in o) f[d] ? u.push(d) : (f[d] = !1);
          return (
            (f.id = u.join(",")),
            f.access && ((f.alt = !0), t.mac ? (f.ctrl = !0) : (f.shift = !0)),
            f.meta && (t.mac ? (f.meta = !0) : ((f.ctrl = !0), (f.meta = !1))),
            f
          );
        }
        var l = this,
          ...
          (e.altKey || e.ctrlKey || e.metaKey) &&
            ...
            n(c, function (t) {
              return t.ctrl == e.ctrlKey &&
                ...
                ? (e.preventDefault(),
                  "keydown" == e.type && t.func.call(t.scope),
                  !0)
                : void 0;
            });
        }),
      ...
      return function (r) {
        ...
        function s(e, t, n) {
          ...
          (a = new XMLHttpRequest()),
            a.open("POST", r.url),
            (a.withCredentials = r.credentials),
            (a.onload = function () {
              var e;
              return 200 != a.status
                ? void n("HTTP Error: " + a.status)
                : ((e = JSON.parse(a.responseText)),
                  e && "string" == typeof e.location
                    ? void t(o(r.basePath, e.location))
                    : void n("Invalid JSON: " + a.responseText));
            }),
            (s = new FormData()),
        ...
        var c = {};
        return (
          (r = t.extend({ credentials: !1, handler: s }, r)), { upload: l }
        );
      };
    }),
    r(xe, [ve], function (e) {
    ...
    r(Ce, [ve, d, xe, u], function (e, t, n, r) {
      ...
      return function (o) {
        function a(a) {
          function l(e, t) {
            var r, a;
            return 0 === e.src.indexOf("blob:")
              ? ((a = o.getByUri(e.src)),
                void (a && t({ image: e, blobInfo: a })))
              : ((r = n.parseDataUri(e.src).data),
                (a = o.findFirst(function (e) {
                  return e.base64() === r;
                })),
                void (a
                  ? t({ image: e, blobInfo: a })
          ...
          var c, u;
          return (
            (c = t.filter(a.getElementsByTagName("img"), function (e) {
              var t = e.src;
              return r.fileApi
                ? e.hasAttribute("data-mce-bogus")
                  ...
                  ? !1
                  : t && t != r.transparentSrc
                  ? 0 === t.indexOf("data:") || 0 === t.indexOf("blob:")
                  : !1
                : !1;
            })),
      ...
      function (
        ...
        function k(e, t, i) {
          ...
          (a = o.documentBaseUrl = i.documentBaseURL),
              ...
              A(
                {
                  ...
                  indent: "simple",
                  indent_before:
                    "p,h1,h2,h3,h4,h5,h6,blockquote,div,title,style,pre,script,td,th,ul,ol,li,dl,dt,dd,area,table,thead,tfoot,tbody,tr,section,article,hgroup,aside,figure,option,optgroup,datalist",
                  indent_after:
                    "p,h1,h2,h3,h4,h5,h6,blockquote,div,title,style,pre,script,td,th,ul,ol,li,dl,dt,dd,area,table,thead,tfoot,tbody,tr,section,article,hgroup,aside,figure,option,optgroup,datalist",
                  validate: !0,
            ...
            (o.inline = t.inline),
            t.cache_suffix &&
              (C.cacheSuffix = t.cache_suffix.replace(/^[\?\&]+/, "")),
            t.override_viewport === !1 && (C.overrideViewPort = !1),
          ...
          (k.prototype = {
            render: function () {
              ...
              function t() {
                ...
                if (
                  (r.language &&
                    ...
                    !r.language_url &&
                    (r.language_url =
                      n.editorManager.baseURL + "/langs/" + r.language + ".js"),
                  r.language_url && e.add(r.language_url),
                  r.theme &&
                    "function" != typeof r.theme &&
                    "-" != r.theme.charAt(0) &&
                    !T.urls[r.theme])
                ) {
                  var t = r.theme_url;
                  (t = t
                    ? n.documentBaseURI.toAbsolute(t)
                    : "themes/" + r.theme + "/theme" + o + ".js"),
                    T.load(r.theme, t);
                }
                w.isArray(r.plugins) && (r.plugins = r.plugins.join(" ")),
                  B(r.external_plugins, function (e, t) {
              ...
              if (n.getElement() && C.contentEditable) {
                r.inline
                  ? (n.inline = !0)
                  : ((n.orgVisibility = n.getElement().style.visibility),
                    (n.getElement().style.visibility = "hidden"));
                var a = n.getElement().form || S.getParent(i, "form");
                a &&
                  ((n.formElement = a),
                  r.hidden_input &&
                    !/TEXTAREA|INPUT/i.test(n.getElement().nodeName) &&
                    (S.insertAfter(
                      S.create("input", { type: "hidden", name: i }),
                      i
                    ),
                    (n.hasHiddenInput = !0)),
                  (n.formEventDelegate = function (e) {
                    n.fire(e.type, e);
                  }),
                  S.bind(a, "submit reset", n.formEventDelegate),
                  n.on("reset", function () {
                  ...
                  "xml" == r.encoding &&
                    n.on("GetContent", function (e) {
                      e.save && (e.content = S.encode(e.content));
                    }),
                  r.add_form_submit_trigger &&
                    n.on("submit", function () {
                      n.initialized && n.save();
                    }),
                  r.add_unload_trigger &&
                    ((n._beforeUnload = function () {
                      !n.initialized ||
                        n.destroyed ||
                        n.isHidden() ||
                        n.save({ format: "raw", no_events: !0, set_dirty: !1 });
                    }),
            ...
            init: function () {
              function e(n) {
                var r = R.get(n),
                  i,
                  o;
                (i = R.urls[n] || t.documentBaseUrl.replace(/\/$/, "")),
                  (n = H(n)),
                  r &&
                    -1 === M(m, n) &&
                    (B(R.dependencies(n), function (t) {
                      e(t);
                    }),
                    (o = new r(t, i, t.$)),
                    (t.plugins[n] = o),
              ...
              var t = this,
                ...
                m = [];
              if (
                (this.editorManager.i18n.setCode(n.language),
                (t.rtl = n.rtl_ui || this.editorManager.i18n.rtl),
                ...
                n.theme &&
                  ("function" != typeof n.theme
                    ...
                    : (t.theme = n.theme)),
                B(n.plugins.replace(/\-/g, "").split(/[ ,]/), e),
                n.render_ui &&
                  t.theme &&
                  ((t.orgDisplay = r.style.display),
                  "function" != typeof n.theme
                    ? ((i = n.width || r.style.width || r.offsetWidth),
                      (o = n.height || r.style.height || r.offsetHeight),
                      (a = n.min_height || 100),
                      (h = /^[0-9\.]+(|px)$/i),
                      h.test("" + i) && (i = Math.max(parseInt(i, 10), 100)),
                      h.test("" + o) && (o = Math.max(parseInt(o, 10), a)),
                      (l = t.theme.renderUI({
                        targetNode: r,
                        width: i,
                        height: o,
                      ...
                      n.content_editable ||
                        ((o =
                          (l.iframeHeight || o) +
                          ("number" == typeof o ? l.deltaHeight || 0 : "")),
                        a > o && (o = a)))
                    : ((l = n.theme(t, r)),
                      l.editorContainer.nodeType &&
                        (l.editorContainer = l.editorContainer.id =
                          l.editorContainer.id || t.id + "_parent"),
                      l.iframeContainer.nodeType &&
                        (l.iframeContainer = l.iframeContainer.id =
                          l.iframeContainer.id || t.id + "_iframecontainer"),
                      (o = l.iframeHeight || r.offsetHeight)),
                  (t.editorContainer = l.editorContainer)),
                n.content_css &&
                  B(D(n.content_css), function (e) {
                    t.contentCSS.push(t.documentBaseURI.toAbsolute(e));
                  }),
                n.content_style && t.contentStyles.push(n.content_style),
                n.content_editable)
              )
                return (r = s = l = null), t.initContentBody();
              for (
                t.iframeHTML = n.doctype + "<html><head>",
                  n.document_base_url != t.documentBaseUrl &&
                    (t.iframeHTML +=
              ...
              (d = n.body_id || "tinymce"),
                -1 != d.indexOf("=") &&
                  ((d = t.getParam("body_id", "", "hash")), (d = d[t.id] || d)),
                (f = n.body_class || ""),
                -1 != f.indexOf("=") &&
                  ((f = t.getParam("body_class", "", "hash")),
                  (f = f[t.id] || "")),
              ...
              var y = S.create("iframe", {
                ...
                title: t.editorManager.translate(
              ...
              if (
                ...
                S.setAttrib(y, "src", u || 'javascript:""'),
                (t.contentAreaContainer = l.iframeContainer),
                (t.iframeElement = y),
                (s = S.add(l.iframeContainer, y)),
                I)
              )
                try {
                  t.getDoc();
              ...
              l.editorContainer &&
                ((S.get(l.editorContainer).style.display = t.orgDisplay),
                (t.hidden = S.isHidden(l.editorContainer))),
                (t.getElement().style.display = "none"),
                S.setAttrib(t.id, "aria-hidden", !0),
                u || t.initContentBody(),
                (r = s = l = null);
            },
            initContentBody: function (t) {
              ...
              r.inline || (n.getElement().style.visibility = n.orgVisibility),
                t ||
                  r.content_editable ||
                  (h.open(), h.write(n.iframeHTML), h.close()),
                r.content_editable &&
                  (n.on("remove", function () {
                    var e = this.getBody();
                    S.removeClass(e, "mce-content-body"),
                      S.removeClass(e, "mce-edit-focus"),
                      S.setAttrib(e, "contentEditable", null);
                  }),
                  S.addClass(s, "mce-content-body"),
                  (n.contentDocument = h = r.content_document || document),
                  (n.contentWindow = r.content_window || window),
                  (n.bodyElement = s),
                  (r.content_document = r.content_window = null),
                  (r.root_name = s.nodeName.toLowerCase())),
                (p = n.getBody()),
                (p.disabled = !0),
                r.readonly ||
                  (n.inline &&
                    "static" == S.getStyle(p, "position", !0) &&
                    (p.style.position = "relative"),
                  (p.contentEditable = n.getParam(
                    "content_editable_state",
                    !0
                  ))),
                (p.disabled = !1),
                (n.editorUpload = new N(n)),
                (n.schema = new y(r)),
                (n.dom = new e(h, {
                  keep_values: !0,
                    ...
                    for (var r = e.length, i, o = n.dom, a, s; r--; )
                      if (
                        ...
                        if (
                          ...
                          continue;
                        "style" === t
                          ? ((a = o.serializeStyle(o.parseStyle(a), i.name)),
                            a.length || (a = null),
                            i.attr(s, a),
                            i.attr(t, a))
                          : "tabindex" === t
                          ? (i.attr(s, a), i.attr(t, null))
                          : i.attr(s, n.convertURL(a, t, i.name));
                      }
                  }
                ),
                ...
                n.parser.addNodeFilter("p,h1,h2,h3,h4,h5,h6,div", function (e) {
                  for (
                    var t = e.length, r, i = n.schema.getNonEmptyElements();
                    t--;

                  )
                    (r = e[t]),
                      r.isEmpty(i) &&
                        (r.append(new o("br", 1)).shortEnded = !0);
                }),
                ...
                n.fire("PreInit"),
                r.browser_spellcheck ||
                  r.gecko_spellcheck ||
                  ((h.body.spellcheck = !1),
                  S.setAttrib(p, "spellcheck", "false")),
                n.fire("PostRender"),
                (n.quirks = new x(n)),
                r.directionality && (p.dir = r.directionality),
                r.nowrap && (p.style.whiteSpace = "nowrap"),
                r.protect &&
                  n.on("BeforeSetContent", function (e) {
                ...
                n.load({ initial: !0, format: "html" }),
                (n.startContent = n.getContent({ format: "raw" })),
                (n.initialized = !0),
                n.bindPendingEventDelegates(),
                n.fire("init"),
                n.focus(!0),
                n.nodeChanged({ initial: !0 }),
                n.execCallback("init_instance_callback", n),
                n.contentStyles.length > 0 &&
                  ((m = ""),
                  B(n.contentStyles, function (e) {
                    m += e + "\r\n";
                  }),
                  n.dom.addStyle(m)),
                B(n.contentCSS, function (e) {
                ...
                r.auto_focus &&
                  setTimeout(function () {
                    ...
                    (e =
                      r.auto_focus === !0
                        ? n
                        : n.editorManager.get(r.auto_focus)),
                      e.destroyed || e.focus();
                  }, 100),
                (s = h = p = null);
            },
            focus: function (e) {
              ...
              if (!e) {
                if (
                  ...
                  r || (C.opera || t.getBody().focus(), t.getWin().focus()),
                  O || r)
                ) {
              ...
              if (n)
                return (
                  ...
                  "string" == typeof n &&
                    ...
                    (t.callbackLookup[e] = { func: n, scope: r })),
            ...
            show: function () {
              ...
              e.hidden &&
                ...
                e.inline
                  ...
                  : (S.show(e.getContainer()), S.hide(e.id)),
                e.load(),
                e.fire("show"));
            },
            hide: function () {
              var e = this,
                t = e.getDoc();
              e.hidden ||
                (I && t && !e.inline && t.execCommand("SelectAll"),
                e.save(),
                e.inline
                  ? ((e.getBody().contentEditable = !1),
                    e == e.editorManager.focusedEditor &&
                      (e.editorManager.focusedEditor = null))
                  : (S.hide(e.getContainer()),
                    S.setStyle(e.id, "display", e.orgDisplay)),
                (e.hidden = !0),
                e.fire("hide"));
            },
            isHidden: function () {
            ...
            save: function (e) {
              ...
              if (n && t.initialized)
                return (
                  ...
                  (r = e.content),
                  /TEXTAREA|INPUT/i.test(n.nodeName)
                    ? (n.value = r)
                    : (t.inline || (n.innerHTML = r),
                      (i = S.getParent(t.id, "form")) &&
                        B(i.elements, function (e) {
            ...
            setContent: function (e, t) {
              ...
              return (
                ...
                (e = t.content),
                0 === e.length || /^\s+$/.test(e)
                  ? ((i = n.settings.forced_root_block),
                    i &&
                    n.schema.isValidChild(
                      r.nodeName.toLowerCase(),
                      i.toLowerCase()
                    )
                      ? ((e = I && 11 > I ? "" : '<br data-mce-bogus="1">'),
                        (e = n.dom.createHTML(
                          i,
                          n.settings.forced_root_block_attrs,
                          e
                        )))
                      : I || (e = '<br data-mce-bogus="1">'),
                    n.dom.setHTML(r, e),
                    n.fire("SetContent", t))
                  : ("raw" !== t.format &&
                      (e = new s({}, n.schema).serialize(
                        n.parser.parse(e, { isRootContent: !0 })
                      )),
                    (t.content = H(e)),
                    n.dom.setHTML(r, t.content),
                    t.no_events || n.fire("SetContent", t)),
                t.content
              );
            },
            getContent: function (e) {
              ...
              return (
                ...
                (n =
                  "raw" == e.format
                    ...
                    : t.serializer.serialize(r, e)),
                "text" != e.format ? (e.content = H(n)) : (e.content = n),
            ...
            getContainer: function () {
              ...
              return (
                e.container ||
                  (e.container = S.get(e.editorContainer || e.id + "_parent")),
                e.container
              );
            },
            ...
            getElement: function () {
              return (
                this.targetElm || (this.targetElm = S.get(this.id)),
                this.targetElm
              );
            },
            getWin: function () {
            ...
            getDoc: function () {
              ...
              return (
                e.contentDocument ||
                  ((t = e.getWin()), t && (e.contentDocument = t.document)),
                e.contentDocument
              );
            },
            getBody: function () {
            ...
            addVisual: function (e) {
              ...
              (e = e || n.getBody()),
                ...
                B(i.select("table,a", e), function (e) {
                  var t;
                  switch (e.nodeName) {
                    case "TABLE":
                      return (
                        (o = r.visual_table_class || "mce-item-table"),
                        (t = i.getAttrib(e, "border")),
                        void ((t && "0" != t) || !n.hasVisual
                          ? i.removeClass(e, o)
                          : i.addClass(e, o))
                      );
                    case "A":
                      return void (
                        i.getAttrib(e, "href", !1) ||
                        ((t = i.getAttrib(e, "name") || e.id),
                        (o = r.visual_anchor_class || "mce-item-anchor"),
                        t && n.hasVisual
                          ? i.addClass(e, o)
                          : i.removeClass(e, o))
                      );
            ...
            remove: function () {
              ...
              e.removed ||
                ...
                e.hasHiddenInput && S.remove(e.getElement().nextSibling),
                e.inline ||
                  (I && 10 > I && e.getDoc().execCommand("SelectAll", !1, null),
                  S.setStyle(e.id, "display", e.orgDisplay),
                  (e.getBody().onload = null)),
                e.fire("remove"),
                e.editorManager.remove(e),
                S.remove(e.getContainer()),
            ...
            destroy: function (e) {
              ...
              if (!t.destroyed) {
                ...
                e ||
                  ...
                  n &&
                    (n._mceOldSubmit &&
                      ((n.submit = n._mceOldSubmit), (n._mceOldSubmit = null)),
                    S.unbind(n, "submit reset", t.formEventDelegate)),
            ...
            _isHidden: function () {
              var e;
              return O
                ? ((e = this.selection.getSel()),
                  !e || !e.rangeCount || 0 === e.rangeCount)
                : 0;
            },
          }),
          A(k.prototype, _),
    ...
    r(Ne, [], function () {
      ...
      return {
        setCode: function (e) {
          e &&
            ((t = e),
            (this.rtl = this.data[e] ? "rtl" === this.data[e]._dir : !1));
        },
        getCode: function () {
          return t;
        },
    ...
    r(ke, [b, u], function (e, t) {
      function n(e) {
        ...
        function l(e, t) {
          if (t && t.startContainer) {
            if (
              !e.isChildOf(t.startContainer, e.getRoot()) ||
              !e.isChildOf(t.endContainer, e.getRoot())
            )
              return;
            return {
        ...
        function d(n) {
          ...
          d.on("init", function () {
            (d.inline || t.ie) &&
              ("onbeforedeactivate" in document && t.ie < 9
                ? d.dom.bind(d.getBody(), "beforedeactivate", function (e) {
                ...
                : d.on("nodechange mouseup keyup", function (e) {
                    ...
                    ("nodechange" == e.type && e.selectionChange) ||
                      (t && t.id == d.id + "_ifr" && (t = d.getBody()),
                      d.dom.isChildOf(t, d.getBody()) &&
                        (d.lastRng = d.selection.getRng()));
                  }),
              t.webkit &&
                !r &&
            ...
            d.on("focusin", function () {
              ...
              d.selection.lastFocusBookmark &&
                (d.selection.setRng(c(d, d.selection.lastFocusBookmark)),
                (d.selection.lastFocusBookmark = null)),
                t != d &&
                  (t && t.fire("blur", { focusedEditor: d }),
                  e.setActive(d),
                  (e.focusedEditor = d),
                  d.fire("focus", { blurredEditor: t }),
                  d.focus(!0)),
                (d.lastRng = null);
            }),
            d.on("focusout", function () {
              window.setTimeout(function () {
                ...
                u(s()) ||
                  ...
                  d.selection && (d.selection.lastFocusBookmark = null));
              }, 0);
            }),
            i ||
              ((i = function (t) {
                ...
                n &&
                  ...
                  (n.selection &&
                    t.target != n.getBody() &&
                    (n.selection.lastFocusBookmark = l(n.dom, n.lastRng)),
        ...
        function f(t) {
          e.focusedEditor == t.editor && (e.focusedEditor = null),
            e.activeEditor ||
              (a.unbind(document, "selectionchange", r),
              a.unbind(document, "focusin", i),
              a.unbind(document, "mouseup", o),
              (r = i = o = null));
        }
      ...
      var r,
        ...
        a = e.DOM;
      return (
        (n.isEditorUIElement = function (e) {
    ...
    r(Se, [Ee, h, b, U, u, f, K, Ne, ke], function (e, t, n, r, i, o, a, s, l) {
      ...
      function u(e, n) {
        n !== x &&
          (n ? t(window).on("resize", c) : t(window).off("resize", c), (x = n));
      }
      function d(e) {
        var t = b.editors,
          n;
        ...
        return (
          b.activeEditor == e && (b.activeEditor = t[0]),
          b.focusedEditor == e && (b.focusedEditor = null),
          n
        );
      }
      function f(e) {
        return (
          e &&
            ...
            (d(e), e.unbindAllNativeEvents(), e.destroy(!0), (e = null)),
          e
        );
      }
      var h = n.DOM,
      ...
      return (
                ...
                case "specific_textareas":
                  m(h.select("textarea"), function (e) {
                    (t.editor_deselector && o(e, t.editor_deselector)) ||
                      ((!t.editor_selector || o(e, t.editor_selector)) &&
                        r(n(e), t, e));
                  });
              }
              t.oninit &&
          ...
          remove: function (e) {
              ...
              i;
            {
              if (e)
                return "string" == typeof e
                  ? ((e = e.selector || e),
                    void m(h.select(e), function (e) {
                      (i = r[e.id]), i && t.remove(i);
                    }))
                  : ((i = e),
                    r[i.id]
                      ? (d(i) && t.fire("RemoveEditor", { editor: i }),
                        r.length || h.unbind(window, "beforeunload", y),
                        i.remove(),
                        u(r, r.length > 0),
                        i)
                      : null);
            ...
            switch (t) {
              ...
              case "mceToggleEditor":
                return o
                  ...
                  : (i.execCommand("mceAddEditor", 0, r), !0);
            }
        ...
        g(b, a),
        b.setup(),
        (window.tinymce = window.tinyMCE = b),
        b
      );
    }),
    r(Te, [Se, f], function (e, t) {
      ...
      e.on("AddEditor", function (e) {
        ...
        t.on("preInit", function () {
          ...
          function i(e) {
            (s = t.dom),
              l.convert_fonts_to_spans &&
                n(s.select("font,u,strike", e.node), function (e) {
          ...
          l.inline_styles &&
            ...
            (o = {
              ...
              u: function (n, r) {
                "html4" === t.settings.schema &&
                  e(r, { textDecoration: "underline" });
              },
              strike: function (t, n) {
    ...
    r(Re, [K, f], function (e, t) {
      var n = {
        send: function (e) {
          function r() {
            !e.async || 4 == i.readyState || o++ > 1e4
              ? (e.success && 1e4 > o && 200 == i.status
                  ? e.success.call(e.success_scope, "" + i.responseText, i, e)
                  : e.error &&
                    e.error.call(
                      e.error_scope,
                      o > 1e4 ? "TIMED_OUT" : "GENERAL",
                      i,
                      e
                    ),
                (i = null))
          ...
          if (
            ...
            if (
              (i.overrideMimeType && i.overrideMimeType(e.content_type),
              i.open(e.type || (e.data ? "POST" : "GET"), e.url, e.async),
              e.crossDomain && (i.withCredentials = !0),
              e.content_type &&
                i.setRequestHeader("Content-Type", e.content_type),
              e.requestheaders &&
                t.each(e.requestheaders, function (e) {
                  i.setRequestHeader(e.key, e.value);
                }),
              i.setRequestHeader("X-Requested-With", "XMLHttpRequest"),
              (i = n.fire("beforeSend", { xhr: i, settings: e }).xhr),
              i.send(e.data),
              !e.async)
            )
              return r();
      ...
      function e(t, n) {
        ...
        if (((o = typeof t), "string" == o))
          return (
            (i = "\bb	t\nn\ff\rr\"\"''\\\\"),
            n +
              t.replace(/([\u0080-\uFFFF\x00-\x1f\"\'\\])/g, function (e, t) {
                return '"' === n && "'" === e
                  ? e
                  : ((r = i.indexOf(t)),
                    r + 1
    ...
    r(Me, [], function () {
      ...
      function n() {
        function n(e) {
          var n, r;
          return (
            (r = e !== t ? u + e : i.indexOf(",", u)),
            -1 === r || r > i.length
              ? null
              : ((n = i.substring(u, r)), (u = r + 1), n)
          );
        }
        var r,
          i,
        ...
        if (c) {
          for (var r in a)
            (t = a[r]),
              (n +=
                (n ? "," : "") +
                r.length.toString(32) +
                "," +
                r +
                "," +
                t.length.toString(32) +
                "," +
                t);
          o.setAttribute(l, n);
          try {
      ...
      var n,
        r = e.extend({
          ...
          bindStates: function () {
            ...
            var n = this;
            return (
              n.state.on("change:disabled", function (t) {
                e(t.value);
              }),
      ...
      return e.extend({
        ...
        renderHtml: function () {
          ...
          return (
            ...
            i
              ? ((r = "none"),
                "string" != typeof i && (i = window.getSelection ? i[0] : i[1]),
                (i = " style=\"background-image: url('" + i + "')\""))
              : (i = ""),
            o && e.classes.add("btn-has-text"),
        ...
        bindStates: function () {
          ...
          var t = this;
          return (
            t.state.on("change:text", function (t) {
              e(t.value);
            }),
    ...
    r(Ve, [Ie, ne, J, h], function (e, t, n, r) {
      return e.extend({
                ...
                t
                  ...
                  .each(function (n) {
                    ...
                    return (
                      ...
                      t.state.set("value", i),
                      r != i && t.fire("change"),
                      n.hasEventListeners("submit") && n.toJSON
                        ? (n.fire("submit", { data: n.toJSON() }), !1)
                        : void 0
                    );
                  });
            }),
        ...
        showMenu: function () {
          ...
          e.menu ||
            ...
            r.length
              ? (r = { type: "menu", items: r })
              : (r.type = r.type || "menu"),
            (e.menu = t.create(r).parent(e).renderTo(e.getContainerElm())),
            e.fire("createmenu"),
            e.menu.reflow(),
        ...
        repaint: function () {
          ...
          return (
            l.all &&
              ...
              (s = e.layoutRect().h - 2 + "px"),
            r(t.firstChild).css({ width: a, lineHeight: s }),
            e._super(),
            e
          );
        },
        postRender: function () {
          var e = this;
          return (
            r(this.getEl("inp")).on("change", function (t) {
        ...
        renderHtml: function () {
          var e = this,
            ...
            l = "";
          return (
            "spellcheck" in n && (l += ' spellcheck="' + n.spellcheck + '"'),
      ...
      return e.extend({
        showPanel: function () {
          ...
          e.panel.moveRel(
            e.getEl(),
            n.popoverAlign ||
              (e.isRtl() ? ["bc-tr", "bc-tc"] : ["bc-tl", "bc-tc"])
          );
        },
        hidePanel: function () {
          var e = this;
        ...
        postRender: function () {
          ...
          return (
            e.on("click", function (r) {
              (r.aria && "down" == r.aria.key) ||
                r.control != e ||
                n.getParent(r.target, "." + e.classPrefix + "open") ||
      ...
      function e(e) {
        function i(e, i, o) {
          ...
          return (
            ...
            u == d
              ? ((l = u), { h: 0, s: 0, v: 100 * l })
              : ((c = e == u ? i - o : o == u ? e - i : o - e),
                (a = e == u ? 3 : o == u ? 1 : 5),
                (a = 60 * (a - c / (d - u))),
                (s = (d - u) / d),
                (l = d),
                { h: r(a), s: r(100 * s), v: r(100 * l) })
          );
        }
        function o(e, i, o) {
          var a, s, l, c;
          ...
          return (
            "object" == typeof e
              ...
              : (t = /#([0-F])([0-F])([0-F])/gi.exec(e)) &&
                ((d = parseInt(t[1] + t[1], 16)),
                (f = parseInt(t[2] + t[2], 16)),
                (h = parseInt(t[3] + t[3], 16))),
            (d = 0 > d ? 0 : d > 255 ? 255 : d),
            (f = 0 > f ? 0 : f > 255 ? 255 : f),
            (h = 0 > h ? 0 : h > 255 ? 255 : h),
            u
      ...
      return e.extend({
        ...
        postRender: function () {
          ...
          function i(e, t) {
            var i = (360 - e.h) / 360;
            n.css(d, { top: 100 * i + "%" }),
              t || n.css(h, { left: e.s + "%", top: 100 - e.v + "%" }),
              (f.style.background = new r({ s: 100, v: 100, h: e.h }).toHex()),
              s.color().parse({ s: e.s, v: e.v, h: e.h });
          }
          function o(t) {
            var n;
            (n = e(f, t)),
          ...
          (u = s.getEl("h")),
            ...
            s._super(),
            (s._svdraghelper = new t(s._id + "-sv", { start: o, drag: o })),
            (s._hdraghelper = new t(s._id + "-h", { start: a, drag: a })),
            s._repaint();
        },
        rgb: function () {
        ...
        value: function (e) {
          var t = this;
          return arguments.length
            ? (t.color().parse(e), void (t._rendered && t._repaint()))
            : t.color().toHex();
        },
        color: function () {
                  ...
                  if (1 == o[a].nodeType && !e(o[a])) {
                    ...
                    if (
                      (s.isDefaultPrevented() ||
                        i.push({ name: s.name, element: o[a] }),
          ...
          e.settings.formItemDefaults ||
            ...
            r.each(function (r) {
              ...
              o &&
                ...
                "undefined" == typeof r.settings.flex && (r.settings.flex = 1),
                e.replace(r, i),
                i.add(r));
            });
        },
        ...
        bindStates: function () {
          function e() {
            ...
            if (t.settings.labelGapCalc !== !1)
              for (
                o =
                  "children" == t.settings.labelGapCalc
                    ? t.find("formitem")
                    : t.items(),
                  o.filter("formitem").each(function (t) {
                    var r = t.items()[0],
                      i = r.getEl().clientWidth;
                    (e = i > e ? i : e), n.push(r);
                  }),
                  i = t.settings.labelGap || 0,
                  r = n.length;
                r--;
      ...
      return e.extend({
        init: function (e) {
          ...
          (e.spellcheck = !1),
            ...
            s && (s = t.makeMap(s, /[, ]/)),
            (!s || s[e.filetype]) &&
              ((a = i.file_picker_callback),
              !a || (s && !s[e.filetype])
                ? ((a = i.file_browser_callback),
                  !a ||
                    (s && !s[e.filetype]) ||
                    (o = function () {
                ...
                : (o = function () {
                    ...
                    (i = t.extend({ filetype: e.filetype }, i)),
                      a.call(
                        r,
                        function (e, t) {
          ...
          for (
            r = e.items().filter(":visible"),
              ...
              ("row-reversed" == f || "column-reverse" == f) &&
                ((r = r.set(r.toArray().reverse())), (f = f.split("-")[0])),
              "column" == f
                ? ((k = "y"),
                  (E = "h"),
                  (N = "minH"),
            ...
            (h = r[t]),
              ...
              (g = m.flex),
              (d -= n - 1 > t ? c : 0),
              g > 0 && ((u += g), p[S] && v.push(h), (p.flex = g)),
              (d -= p[N]),
              (y = o[P] + p[L] + o[O]),
              y > _ && (_ = y);
          if (
            ((C = {}),
            0 > d ? (C[N] = i[N] - d + i[A]) : (C[N] = i[R] - d + i[A]),
            (C[L] = _ + i[I]),
            (C[B] = i[R] - d),
            (C[F] = _),
            (C.minW = W(C.minW, i.maxW)),
            (C.minH = W(C.minH, i.maxH)),
            (C.minW = z(C.minW, i.startMinWidth)),
            (C.minH = z(C.minH, i.startMinHeight)),
            !i.autoResize || (C.minW == i.minW && C.minH == i.minH))
          ) {
            ...
            for (
              x = d / u,
                ...
                0 === u &&
                  ("end" == l
                    ? (w = d + o[T])
                    : "center" == l
                    ? ((w = Math.round(i[R] / 2 - (i[R] - d) / 2) + o[T]),
                      0 > w && (w = o[T]))
                    : "justify" == l &&
                      ((w = o[T]), (c = Math.floor(d / (r.length - 1))))),
                C[D] = o[P],
                t = 0,
                n = r.length;
              n > t;
              ...
              (h = r[t]),
                ...
                (y = p.maxFlexSize || p[N]),
                "center" === s
                  ? (C[D] = Math.round(i[M] / 2 - p[H] / 2))
                  : "stretch" === s
                  ? ((C[H] = z(p[L] || 0, i[M] - o[P] - o[O])), (C[D] = o[P]))
                  : "end" === s && (C[D] = i[M] - p[H] - o.top),
                p.flex > 0 && (y += p.flex * x),
                (C[E] = y),
                (C[k] = w),
                h.layoutRect(C),
              ...
              s(i.parents, function (e) {
                return (
                  s(t, function (t) {
                    return (
                      n
                        ? o.matchNode(e, n, { value: t.value }) && (a = t.value)
                        : o.matchNode(e, t.value) && (a = t.value),
                      a ? !1 : void 0
                    );
                  }),
                  a ? !1 : void 0
              ...
              itemDefaults: {
                ...
                textStyle: function () {
                  return this.settings.format
                    ? e.formatter.getCssText(this.settings.format)
                    : void 0;
                },
                onPostRender: function () {
                  var t = this;
        ...
        function o(t) {
          return function () {
            ...
            (t = "redo" == t ? "hasRedo" : "hasUndo"),
              r.disabled(!n()),
              e.on("Undo Redo AddUndo TypingUndo ClearUndos", function () {
                r.disabled(!n());
              });
          };
        }
      ...
      return e.extend({
        recalc: function (e) {
          ...
          if (
            ...
            var M = 0,
              H = t.flexWidths;
            if (H) for (d = 0; d < H.length; d++) M += H[d];
            else M = r;
            var L = T / M;
            for (d = 0; r > d; d++) E[d] += H ? H[d] * L : L;
            for (p = g.top, f = 0; n > f; f++) {
              for (
                h = g.left, s = N[f] + D, d = 0;
                r > d &&
                ((B = A ? f * r + r - 1 - d : f * r + d), (u = i[B]), u);
                d++
              )
                (m = u.settings),
                  (c = u.layoutRect()),
                  (a = Math.max(E[d], c.startMinWidth)),
                  (c.x = h),
                  (c.y = p),
                  (v = m.alignH || (x ? x[d] || x[0] : null)),
                  "center" == v
                    ? (c.x = h + a / 2 - c.w / 2)
                    : "right" == v
                    ? (c.x = h + a - c.w)
                    : "stretch" == v && (c.w = a),
                  (v = m.alignV || (C ? C[d] || C[0] : null)),
                  "center" == v
                    ? (c.y = p + s / 2 - c.h / 2)
                    : "bottom" == v
                    ? (c.y = p + s - c.h)
          ...
          if (e.settings.multiline) {
            ...
            r.width > n.maxW && ((n.minW = n.maxW), e.classes.add("multiline")),
              ...
              (n.startMinH =
                n.h =
                n.minH =
                  Math.min(n.maxH, t.getSize(e.getEl()).height));
          }
          return n;
        },
        repaint: function () {
          ...
          return (
            e.settings.multiline ||
              (e.getEl().style.lineHeight = e.layoutRect().h + "px"),
            e._super()
          );
        },
        renderHtml: function () {
      ...
      var i = e.extend({
          ...
          return e.menu && e.menu.visible()
            ...
            : (e.menu ||
                ...
                n.length
                  ...
                  : (n.type = n.type || "menu"),
                n.renderTo
                  ? (e.menu = n.parent(e).show().renderTo())
                  : (e.menu = t.create(n).parent(e).renderTo()),
                e.fire("createmenu"),
                e.menu.reflow(),
                e.menu.on("cancel", function (t) {
        ...
        renderHtml: function () {
          ...
          return (
            ...
            o
              ? ((i = "none"),
                "string" != typeof o && (o = window.getSelection ? o[0] : o[1]),
                (o = " style=\"background-image: url('" + o + "')\""))
              : (o = ""),
        ...
        postRender: function () {
          ...
          return (
            e.on("click", function (t) {
              t.control === e &&
                r(t.target, e.getEl()) &&
                (e.showMenu(), t.aria && e.menu.items()[0].focus());
            }),
              ...
              n &&
                ...
                (r
                  ...
                  .each(function (e) {
                    e.hideMenu &&
                      e != n &&
                      (e.menu && e.menu.visible() && (o = !0), e.hideMenu());
                  }),
      ...
      return e.extend({
        ...
        init: function (e) {
          ...
          t._super(e),
            ...
            (n = t.state.get("text")),
            ("-" === n || "|" === n) &&
              (t.classes.add("menu-item-sep"),
              t.aria("role", "separator"),
              t.state.set("text", "-")),
            e.selectable &&
              (t.aria("role", "menuitemcheckbox"),
              ...
              r
                ...
                : ((r = n.menu),
                  ...
                  i.settings.itemDefaults &&
                    (r.itemDefaults = i.settings.itemDefaults),
                  (r = e.menu = t.create(r).parent(e).renderTo()),
                  r.reflow(),
        ...
        renderHtml: function () {
          ...
          return (
            ...
            i.image &&
              ((s = "none"),
              (l = " style=\"background-image: url('" + i.image + "')\"")),
            c && (c = e(c)),
            ...
            e.on("mouseenter click", function (n) {
              n.control === e &&
                (t.menu || "click" !== n.type
                  ...
                  : (e.fire("select"), e.parent().hideAll()));
            }),
            e._super(),
            e
          );
        ...
        active: function (e) {
          return (
            "undefined" != typeof e && this.aria("checked", e), this._super(e)
          );
        },
        remove: function () {
          this._super(), this.menu && this.menu.remove();
        ...
        preRender: function () {
          ...
          return (
            e.items().each(function (t) {
              var n = t.settings;
              return n.icon || n.image || n.selectable
                ? ((e._hasIcons = !0), !1)
                : void 0;
            }),
            e._super()
      ...
      return e.extend({
        init: function (e) {
          function t(r) {
            for (var a = 0; a < r.length; a++) {
              if ((i = r[a].selected || e.value === r[a].value))
                return (
                  (o = o || r[a].text), n.state.set("value", r[a].value), !0
                );
          ...
          n._super(e),
            ...
            r &&
              ("undefined" != typeof e.value && t(r),
              !i &&
                r.length > 0 &&
                ((o = r[0].text), n.state.set("value", r[0].value)),
              n.state.set("menu", r)),
            n.state.set("text", e.text || o || r[0].text),
    ...
    r(pt, [], function () {
      ...
      function r(e, t) {
        ...
        return (
          ...
          (i = o(e.x + e.w, t.x + t.w)),
          (s = o(e.y + e.h, t.y + t.h)),
          0 > i - n || 0 > s - r ? null : { x: n, y: r, w: i - n, h: s - r }
        );
      }
      function i(e, t, n) {
      ...
      return e.extend({
        renderHtml: function () {
          ...
          return (
            ...
            "both" == e.settings.direction &&
              e.classes.add("resizehandle-both"),
            (e.canFocus = !1),
            '<div id="' +
              e._id +
              '" class="' +
    ...
    r(gt, [Ie, oe, J], function (e, t, n) {
      ...
      function i(e, t) {
        ...
        "v" == e.settings.orientation
          ? ((a = "top"), (o = "height"), (i = "h"))
          : ((a = "left"), (o = "width"), (i = "w")),
          (r = (e.layoutRect()[i] || 100) - n.getSize(e.getEl("handle"))[o]),
          (s = r * ((t - e._minValue) / (e._maxValue - e._minValue)) + "px"),
          (e.getEl("handle").style[a] = s),
      ...
      return e.extend({
        ...
        postRender: function () {
          ...
          (l = e._minValue),
            ...
            (s = e.value()),
            "v" == e.settings.orientation
              ? ((d = "screenY"), (f = "top"), (h = "height"), (p = "h"))
              : ((d = "screenX"), (f = "left"), (h = "width"), (p = "w")),
            e._super(),
            (e._dragHelper = new t(e._id, {
              handle: e._id + "-handle",
              start: function (t) {
                (i = t[d]),
                  (o = parseInt(e.getEl("handle").style[f], 10)),
                  (u =
                    (e.layoutRect()[p] || 100) -
                    n.getSize(e.getEl("handle"))[h]),
                  e.fire("dragstart", { value: s });
              },
              drag: function (t) {
                var n = t[d] - i,
                  h = e.getEl("handle");
                (a = r(o + n, 0, u)),
                  ...
                  e
                    .tooltip()
                    .text("" + e.settings.previewFilter(s))
                    .show()
                    .moveRel(h, "bc tc"),
                  e.fire("drag", { value: s });
              },
      ...
      return e.extend({
        ...
        repaint: function () {
          ...
          return (
            ...
            (o = r.firstChild),
            (a = r.lastChild),
            n(o).css({ width: i.w - t.getSize(a).width, height: i.h - 2 }),
            n(a).css({ height: i.h - 2 }),
            e
          );
        },
        activeMenu: function (e) {
        ...
        renderHtml: function () {
          ...
          return (
            ...
            r
              ? ((i = "none"),
                "string" != typeof r && (r = window.getSelection ? r[0] : r[1]),
                (r = " style=\"background-image: url('" + r + "')\""))
              : (r = ""),
              ...
              if (e.control == this)
                for (; n; ) {
                  if (
                    ...
                    return (
                      e.stopImmediatePropagation(), void (t && t.call(this, e))
                    );
                  n = n.parentNode;
                }
            }),
      ...
      return e.extend({
        ...
        renderHtml: function () {
          var e = this,
            ...
            i = "";
          return (
            "spellcheck" in n && (i += ' spellcheck="' + n.spellcheck + '"'),
            n.maxLength && (i += ' maxlength="' + n.maxLength + '"'),
            n.size && (i += ' size="' + n.size + '"'),
            n.subtype && (i += ' type="' + n.subtype + '"'),
      ...
      return function (n, r) {
        ...
        (i.show = function (t, s) {
          ...
          (i.hide = function () {
            ...
            return (
              e &&
                -1 != e.className.indexOf("throbber") &&
