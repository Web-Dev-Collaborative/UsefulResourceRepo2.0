...
JustGage = function (config) {
  ...
  obj.config = {
    ...
    humanFriendlyDecimal: obj.kvLookup(
    ...
    shadowVerticalOffset: obj.kvLookup(
    ...
    startAnimationTime: obj.kvLookup(
      "startAnimationTime",
      config,
      dataset,
      700
    ...
    startAnimationType: obj.kvLookup(
      "startAnimationType",
      config,
      dataset,
      ">"
    ...
    refreshAnimationTime: obj.kvLookup(
    ...
    refreshAnimationType: obj.kvLookup(
    ...
    minLabelMinFontSize: obj.kvLookup(
      "minLabelMinFontSize",
      config,
      dataset,
      10
    ...
    maxLabelMinFontSize: obj.kvLookup(
      "maxLabelMinFontSize",
      config,
      dataset,
      10
    ...
    relativeGaugeSize: obj.kvLookup(
      "relativeGaugeSize",
      config,
      dataset,
      false
  ...
  if (obj.config.counter === true) {
    ...
    eve.on("raphael.anim.frame." + obj.level.id, function () {
      ...
      if (obj.config.textRenderer) {
        obj.txtValue.attr(
          "text",
          obj.config.textRenderer(Math.floor(currentValue[0]))
        );
      } else if (obj.config.humanFriendly) {
        obj.txtValue.attr(
          "text",
        ...
        obj.txtValue.attr(
          "text",
          formatNumber(Math.floor(currentValue[0])) + obj.config.symbol
        );
      } else {
        obj.txtValue.attr(
          "text",
          (currentValue[0] * 1).toFixed(obj.config.decimals) + obj.config.symbol
        );
      }
      setDy(obj.txtValue, obj.params.valueFontSize, obj.params.valueY);
      currentValue = null;
...
//
JustGage.prototype.kvLookup = function (
  key,
  tablea,
  tableb,
  defval,
