(function ($) {
  ...
  ResponsiveTable.prototype.updateStickyTableHeader = function () {
    ...
    var shouldBeVisible =
      scrollTop > offsetTop && scrollTop < offsetTop + that.$table.height();
        ...
        $toggle
          ...
          .change(function () {
            ...
            var $checkbox = $(this),
              ...
              $cells = that.$tableWrapper.find(
                "#" + val + ", #" + val + "-clone, [data-columns~=" + val + "]"
              );
      ...
      $(this)
        ...
        .each(function () {
          ...
          for (var k = idStart; k < idStart + colSpan; k++) {
            ...
            // get column header
            var $colHdr = that.$tableScrollWrapper.find(
              "#" + that.idPrefix + k
            );
  ...
  $.fn.responsiveTable = function (option) {
    return this.each(function () {
      ...
      if (!data) {
        $this.data(
          "responsiveTable",
          (data = new ResponsiveTable(this, options))
        );
      }
