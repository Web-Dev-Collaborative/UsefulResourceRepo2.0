...
!(function (a) {
  ...
  var b = a(window),
    ...
    j = "directive",
    k = ".cropper",
    l = /^(e|n|w|s|ne|nw|sw|se|all|crop|move|zoom)$/i,
    m = /^(x|y|width|height|rotate)$/i,
    n = /^(naturalWidth|naturalHeight|width|height|aspectRatio|ratio|rotate)$/i,
    o = "cropper-modal",
    p = "cropper-hidden",
    q = "cropper-invisible",
    r = "cropper-move",
    ...
    w = "mouseup mouseleave touchend touchleave touchcancel",
    x = "wheel mousewheel DOMMouseScroll",
    y = "resize" + k,
    z = "dblclick",
    A = "build" + k,
    B = "built" + k,
    ...
    I = function (b, c) {
      (this.$element = a(b)),
        (this.defaults = a.extend({}, I.DEFAULTS, a.isPlainObject(c) ? c : {})),
        (this.ready = e),
        (this.built = e),
        (this.cropped = e),
        (this.disabled = e),
  ...
  (I.prototype = {
    ...
    load: function () {
      ...
      f.is("img")
        ? (c = f.attr("src"))
        : f.is("canvas") && g.getContext && (c = g.toDataURL()),
        c &&
    ...
    build: function () {
      ...
      this.ready &&
        ...
        b.isDefaultPrevented() ||
          ((this.$cropper = e = a(I.TEMPLATE)),
          f.addClass(p),
          this.$clone.removeClass(q).prependTo(e),
          ...
          g.autoCrop ? (this.cropped = d) : this.$dragger.addClass(p),
          g.dragCrop && this.setDragMode("crop"),
          g.modal && this.$canvas.addClass(o),
          !g.dashed && this.$dragger.find(".cropper-dashed").addClass(p),
          !g.movable && this.$dragger.find(".cropper-face").addClass(p),
          !g.resizable &&
            this.$dragger.find(".cropper-line, .cropper-point").addClass(p),
          (this.$dragScope = g.multiple ? this.$cropper : c),
          this.addListeners(),
          this.initPreview(),
          (this.built = d),
          this.update(),
    ...
    update: function (a) {
      this.initContainer(),
        ...
        this.initDragger(),
        a
          ? (this.setData(a, d), this.setDragMode("crop"))
    ...
    addListeners: function () {
      var c = this.$element,
        d = this.defaults;
      c.on(C, d.dragstart).on(D, d.dragmove).on(E, d.dragend),
        this.$cropper
          .on(u, a.proxy(this.dragstart, this))
          .on(z, a.proxy(this.dblclick, this)),
        d.zoomable && this.$cropper.on(x, a.proxy(this.wheel, this)),
        this.$dragScope
          .on(v, a.proxy(this.dragmove, this))
          .on(w, a.proxy(this.dragend, this)),
        b.on(y, a.proxy(this.resize, this));
    },
    removeListeners: function () {
      var a = this.$element,
        c = this.defaults;
      a.off(C, c.dragstart).off(D, c.dragmove).off(E, c.dragend),
        this.$cropper.off(u, this.dragstart).off(z, this.dblclick),
        c.zoomable && this.$cropper.off(x, this.wheel),
        this.$dragScope.off(v, this.dragmove).off(w, this.dragend),
        b.off(y, this.resize);
    },
    ...
    renderImage: function (a) {
      ...
      "zoom" === a &&
        ...
        (b.left = L(M(b.left, b._width - b.width), 0)),
        (b.top = L(M(b.top, b._height - b.height), 0)),
        this.$clone.css({
          width: J(b.width),
          height: J(b.height),
          marginLeft: J(b.left),
          marginTop: J(b.top),
          transform: H(b.rotate),
        }),
    ...
    initDragger: function () {
      ...
      (b =
        ...
        c.aspectRatio
          ? (isFinite(c.maxWidth)
              ? ((b.maxWidth = L(b.maxWidth, c.maxWidth * f)),
                (b.maxHeight = b.maxWidth / e))
              : isFinite(c.maxHeight) &&
                ((b.maxHeight = L(b.maxHeight, c.maxHeight * f)),
                (b.maxWidth = b.maxHeight * e)),
            c.minWidth > 0
              ? ((b.minWidth = M(0, c.minWidth * f)),
                (b.minHeight = b.minWidth / e))
              : c.minHeight > 0 &&
                ((b.minHeight = M(0, c.minHeight * f)),
                (b.minWidth = b.minHeight * e)))
          : ((b.maxWidth = L(b.maxWidth, c.maxWidth * f)),
            (b.maxHeight = L(b.maxHeight, c.maxHeight * f)),
            (b.minWidth = M(0, c.minWidth * f)),
            (b.minHeight = M(0, c.minHeight * f))),
        (b.minWidth = L(b.maxWidth, b.minWidth)),
        (b.minHeight = L(b.maxHeight, b.minHeight)),
        (b.height *= 0.8),
        (b.width *= 0.8),
    ...
    renderDragger: function () {
      ...
      a.width > a.maxWidth
        ...
        (a.left = L(M(a.left, 0), b.width - a.width)),
        (a.top = L(M(a.top, 0), b.height - a.height)),
        (a.oldLeft = a.left),
        (a.oldTop = a.top),
        (this.dragger = a),
    ...
    clear: function () {
      this.cropped &&
        ((this.cropped = e),
        this.setData({ x: 0, y: 0, width: 0, height: 0, rotate: 0 }),
        this.$canvas.removeClass(o),
        this.$dragger.addClass(p));
    },
    destroy: function () {
      var a = this.$element;
      this.ready && (this.unbuild(), a.removeClass(p), a.removeData("cropper"));
    },
    replace: function (b) {
      var c,
        d = this,
      ...
      b &&
        b !== this.url &&
        (e.is("img")
          ? (e.attr("src", b), this.load())
          : e.is("canvas") &&
            f.getContext &&
            ((c = f.getContext("2d")),
            a(G(b)).one("load", function () {
              (f.width = this.width),
    ...
    setData: function (b, c) {
      ...
      this.built &&
        typeof b !== i &&
        ((b === f || a.isEmptyObject(b)) &&
          (e = a.extend({}, this.defaultDragger)),
        a.isPlainObject(b) &&
          !a.isEmptyObject(b) &&
          (c || (this.defaults.data = b),
          (b = this.transformData(b)),
          F(b.x) && b.x <= d.width - g.left && (e.left = b.x + g.left),
          F(b.y) && b.y <= d.height - g.top && (e.top = b.y + g.top),
          h
            ? F(b.width) && b.width <= e.maxWidth && b.width >= e.minWidth
            ...
            : (F(b.width) &&
              ...
              F(b.height) &&
                ...
                b.height >= e.minHeight &&
                (e.height = b.height)),
          F(b.rotate) && this.rotate(b.rotate)),
        (this.dragger = e),
        this.renderDragger());
    },
    getData: function () {
    ...
    setAspectRatio: function (a) {
      ...
      (a = O(a)),
        (b || (!isNaN(a) && a > 0)) &&
          ((this.defaults.aspectRatio = b ? g : a),
    ...
    getDataURL: function (a, b) {
      ...
      return (
        this.cropped &&
          ...
          e
            .getContext("2d")
            .drawImage(d, c.x, c.y, c.width, c.height, 0, 0, c.width, c.height),
          (f = e.toDataURL(a, b))),
        f
      );
    },
    setDragMode: function (a) {
      ...
      if (!this.disabled) {
        switch (a) {
          case "crop":
            c.dragCrop && ((f = d), b.data(j, a));
            break;
          case "move":
            c.movable && ((g = d), b.data(j, a));
            break;
          default:
            b.removeData(j);
        }
        b.toggleClass(s, f).toggleClass(r, g);
      }
    },
    enable: function () {
      (this.disabled = e), this.$cropper.removeClass(t);
    },
    disable: function () {
      (this.disabled = d), this.$cropper.addClass(t);
    },
    rotate: function (a) {
      var b;
      !this.disabled &&
        this.defaults.rotatable &&
        ((b = this.image.rotate + (O(a) || 0)),
        (this.image.rotate = b % 360),
    ...
    zoom: function (a) {
      ...
      !this.disabled &&
        ...
        (e = c / b._width),
        e > 10 ||
          (1 > e && ((c = b._width), (d = b._height)),
          this.setDragMode(1 >= e ? "crop" : "move"),
          (b.oldWidth = b.width),
          (b.oldHeight = b.height),
          (b.width = c),
          (b.height = d),
          (b.ratio = b.width / b.naturalWidth),
          this.renderImage("zoom")));
    },
    dblclick: function () {
      this.disabled ||
        this.setDragMode(this.$canvas.hasClass(s) ? "move" : "crop");
    },
    wheel: function (a) {
      var b,
        c = a.originalEvent,
    ...
    dragstart: function (b) {
      ...
      if (!this.disabled) {
        ...
        if (((c = c || a(i.target).data(j)), l.test(c))) {
          if (
            (b.preventDefault(),
            (f = a.Event(C)),
          ...
          (this.directive = c),
            ...
            (this.startX = i.pageX),
            (this.startY = i.pageY),
            "crop" === c && ((this.cropping = d), this.$canvas.addClass(o));
        }
      }
    },
    dragmove: function (b) {
    ...
    dragend: function (b) {
      ...
      if (!this.disabled && this.directive) {
        ...
        this.cropping &&
          ((this.cropping = e),
          this.$canvas.toggleClass(o, this.cropped && this.defaults.modal)),
          (this.directive = "");
      }
    },
    dragging: function () {
      ...
      switch ((s && ((t.X = t.y * s), (t.Y = t.x / s)), b)) {
        ...
        case "se":
          ...
          break;
        case "move":
          (c.left += t.x), (c.top += t.y), this.renderImage("move"), (q = e);
          break;
        case "zoom":
          r.zoomable &&
            (this.zoom(
              (function (a, b, c, d, e, f) {
                return (K(e * e + f * f) - K(c * c + d * d)) / K(a * a + b * b);
              })(
                c.width,
                c.height,
                N(this.startX - this.startX2),
                N(this.startY - this.startY2),
                N(this.endX - this.endX2),
                N(this.endY - this.endY2)
              )
            ),
        ...
        case "crop":
          t.x &&
            ...
            t.x > 0
              ...
              ? ((b = "sw"), (l -= j))
              : ((b = "nw"), (l -= j), (m -= k)),
            this.cropped || ((this.cropped = d), this.$dragger.removeClass(p)));
      }
      q &&
        ((i.width = j),
        (i.height = k),
    ...
    (I.setDefaults = function (b) {
      a.extend(I.DEFAULTS, b);
    }),
    (I.other = a.fn.cropper),
      ...
      return (
        this.each(function () {
          var e,
            f = a(this),
            g = f.data("cropper");
          g || f.data("cropper", (g = new I(this, b))),
            "string" == typeof b &&
              a.isFunction((e = g[b])) &&
              (c = e.apply(g, d));
        }),
    ...
    (a.fn.cropper.constructor = I),
    (a.fn.cropper.setDefaults = I.setDefaults),
    (a.fn.cropper.noConflict = function () {
      return (a.fn.cropper = I.other), this;
    });
});
