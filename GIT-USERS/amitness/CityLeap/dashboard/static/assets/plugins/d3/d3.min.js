!(function () {
  ...
  function st(n, t, e) {
    return (
      isNaN(n) && (n = 0),
      isNaN(t) && (t = 0),
      new ft(e, Math.cos((n *= Fa)) * t, Math.sin(n) * t)
    );
  }
  function ft(n, t, e) {
  ...
  function gt(n, t, e) {
    return n > 0
      ? new lt(Math.atan2(e, t) * Ha, Math.sqrt(t * t + e * e), n)
      : new lt(0 / 0, 0 / 0, n);
  }
  function pt(n) {
  ...
  function wt(n, t, e) {
    ...
    var r = vt((0.4124564 * n + 0.3575761 * t + 0.1804375 * e) / Ja),
      u = vt((0.2126729 * n + 0.7151522 * t + 0.072175 * e) / Ga),
      i = vt((0.0193339 * n + 0.119192 * t + 0.9503041 * e) / Ka);
  ...
  function Lt() {
    var n = Tt(),
      t = Rt() - n;
    t > 24
      ? (isFinite(t) && (clearTimeout(ic), (ic = setTimeout(Lt, t))), (uc = 0))
      : ((uc = 1), ac(Lt));
  }
  function Tt() {
    var n = Date.now();
      ...
      var g,
        ...
        y = {
          ...
          polygonEnd: function () {
            ...
            var n = He(m, p);
            g.length
              ? (b || (i.polygonStart(), (b = !0)), ze(g, Pe, n, e, i))
              : n &&
  ...
  function or(n) {
    ...
    return (
      ...
      (t.clipAngle = function (n) {
        return arguments.length
          ? ((x = null == n ? ((_ = n), Pc) : Oe((_ = +n) * Fa)), u())
          : _;
      }),
      (t.clipExtent = function (n) {
        return arguments.length
          ? ((w = n),
            (b = n ? Ie(n[0][0], n[0][1], n[1][0], n[1][1]) : At),
            u())
          : w;
      }),
      (t.scale = function (n) {
  ...
  function jr(n) {
    ...
    for (
      ...
      (o = l.N), a.push(l), Ur(l), (l = o);
    a.push(l), $r(l);
    var s,
      f = a.length;
    for (s = 1; f > s; ++s)
      (l = a[s]), (c = a[s - 1]), Qr(l.edge, c.site, l.site, u);
    (c = a[0]),
      (l = a[f - 1]),
      (l.edge = Gr(c.site, l.site, null, u)),
      Xr(c),
      Xr(l);
  }
  function Fr(n) {
  ...
  function $r(n) {
    var t = n.circle;
    t &&
      (t.P || (ul = t.N), il.remove(t), al.push(t), eu(t), (n.circle = null));
  }
  function Br(n) {
    for (
      var t, e = tl, r = Ye(n[0][0], n[0][1], n[1][0], n[1][1]), u = e.length;
      u--;
  ...
  function Gr(n, t, e, r) {
    ...
    return (
      ...
      e && Qr(u, n, t, e),
      r && Qr(u, t, n, r),
      el[n.i].edges.push(new nu(u, n, t)),
      el[t.i].edges.push(new nu(u, t, n)),
      u
    );
  }
  function Kr(n, t, e) {
  ...
  function ou(n, t) {
    var e,
      ...
      u,
      i = n.sort(au).pop();
    for (tl = [], el = new Array(n.length), rl = new tu(), il = new tu(); ; )
      if (((u = ul), i && (!u || i.y < u.y || (i.y === u.y && i.x < u.x))))
        (i.x !== e || i.y !== r) &&
          ((el[i.i] = new Yr(i)), Fr(i), (e = i.x), (r = i.y)),
          (i = n.pop());
      else {
        if (!u) break;
        jr(u.arc);
  ...
  function hu(n, t, e, r, u, i) {
    if (!n(t, e, r, u, i)) {
      var o = 0.5 * (e + u),
        a = 0.5 * (r + i),
        c = t.nodes;
      c[0] && hu(n, c[0], e, r, o, a),
        c[1] && hu(n, c[1], o, r, u, a),
        c[2] && hu(n, c[2], e, a, o, i),
        c[3] && hu(n, c[3], o, a, u, i);
    }
  }
    ...
    return (
      a[0] != c[0] || a[1] != c[1]
        ? (r.push("translate(", null, ",", null, ")"),
          u.push({ i: 1, x: du(a[0], c[0]) }, { i: 3, x: du(a[1], c[1]) }))
        : c[0] || c[1]
        ? r.push("translate(" + c + ")")
        : r.push(""),
      l != s
      ...
      f != h
        ? u.push({ i: r.push(r.pop() + "skewX(", null, ")") - 2, x: du(f, h) })
  ...
  function Zu(n) {
    for (var t = n.source, e = n.target, r = Xu(t, e), u = [t]; t !== r; )
      (t = t.parent), u.push(t);
  ...
  function Xu(n, t) {
    if (n === t) return n;
    for (
      var e = Vu(n), r = Vu(t), u = e.pop(), i = r.pop(), o = null;
      u === i;
      ...
      if (
        ...
        for (
          ...
          if (1 == p)
            for (
              c = r._pack_prev;
              c !== a._pack_prev && !Mi(c, i);
              c = c._pack_prev, d++
            );
          p
            ? (d > v || (v == d && u.r < r.r) ? yi(r, (u = a)) : yi((r = c), u),
              o--)
            : (mi(r, i), (u = i), t(i));
        }
      var m = (s + f) / 2,
  ...
  function wi(n, t, e, r) {
    ...
    if (((n.x = t += r * n.x), (n.y = e += r * n.y), (n.r *= r), u))
      for (var i = -1, o = u.length; ++i < o; ) wi(u[i], t, e, r);
  }
  function Si(n, t, e) {
    var r = n.r + e.r,
      u = t.x - n.x,
  ...
  function Ji(n, t) {
    var e = Wi(t[2]);
    return n in _l
      ? Math.abs(e - Wi(Math.max(va(t[0]), va(t[1])))) + +("e" !== n)
      : e - 2 * ("%" === n);
  }
  function Gi(n, t, e, r) {
    function u(n) {
  ...
  function Ki(n, t, e) {
    ...
    return (
      ...
      (r.exponent = function (o) {
        return arguments.length
          ? ((u = Qi((t = o))), (i = Qi(1 / t)), n.domain(e.map(u)), r)
          : t;
      }),
      (r.copy = function () {
  ...
  function go(n) {
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((o = "function" == typeof n ? (i = n) : (i = zl.get(n) || po).key),
            t)
          : o;
      }),
  ...
  function bo(n, t) {
    return n.length < 3
      ? po(n)
      : n[0] +
          wo((n.push(n[0]), n), So([n[n.length - 2]].concat(n, [n[1]]), t));
  }
  function _o(n, t) {
  ...
  function ko(n) {
    ...
    var t = 1,
      ...
      o = [u, u, u, (r = n[1])[0]],
      a = [i, i, i, r[1]],
      c = [u, ",", i, "L", Co(Tl, o), ",", Co(Tl, a)];
    for (n.push(n[e - 1]); ++t <= e; )
      (r = n[t]), o.shift(), o.push(r[0]), a.shift(), a.push(r[1]), zo(c, o, a);
  ...
  function Eo(n) {
    ...
    for (e.push(Co(Tl, i) + "," + Co(Tl, o)), --r; ++r < u; )
      (t = n[r]), i.shift(), i.push(t[0]), o.shift(), o.push(t[1]), zo(e, i, o);
    return e.join("");
  }
  function Ao(n) {
    for (var t, e, r = -1, u = n.length, i = u + 4, o = [], a = []; ++r < 4; )
      (e = n[r % u]), o.push(e[0]), a.push(e[1]);
    for (t = [Co(Tl, o), ",", Co(Tl, a)], --r; ++r < i; )
      (e = n[r % u]),
        o.shift(),
        o.push(e[0]),
        a.shift(),
  ...
  function Lo(n) {
    for (
      ...
      r[t] = (o + (o = qo((u = i), (i = n[t + 1])))) / 2;
    return (r[t] = o), r;
  }
  function To(n) {
    for (var t, e, r, u, i = [], o = Lo(n), a = -1, c = n.length - 1; ++a < c; )
      (t = qo(n[a], n[a + 1])),
        va(t) < Ta
          ? (o[a] = o[a + 1] = 0)
          : ((e = o[a] / t),
  ...
  function Po(n) {
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((c = "function" == typeof n ? (a = n) : (a = zl.get(n) || po).key),
            (l = a.reverse || a),
            (s = a.closed ? "M" : "L"),
            t)
          : c;
          ...
          function (u) {
            function a(e) {
              return i.active > r
                ? s(!1)
                : ((i.active = r),
                  o.event && o.event.start.call(n, g, t),
            ...
            function l(t) {
              ...
              for (var e = t / f, u = h(e), o = d.length; o > 0; )
                d[--o].call(n, u);
              return e >= 1 ? s(!0) : void 0;
            }
            function s(u) {
              return (
                o.event && o.event[u ? "end" : "interrupt"].call(n, g, t),
                --i.count ? delete i[r] : delete n[e],
                1
              );
            }
            var f,
    ...
    (ka.transition = function (n) {
      for (
        var t,
          ...
          u = Xo(n),
          i = [],
          o = Pl || { time: Date.now(), ease: ku, delay: 0, duration: 250 },
          a = -1,
          c = this.length;
        ++a < c;
  ...
  (ta.touch = function (n, t, e) {
    if ((arguments.length < 3 && ((e = t), (t = _().changedTouches)), t))
      for (var r, u = 0, i = t.length; i > u; ++u)
        if ((r = t[u]).identifier === e) return B(n, r);
  }),
    (ta.behavior.drag = function () {
      ...
      var e = w(n, "drag", "dragstart", "dragend"),
        r = null,
        u = t(y, ta.mouse, G, "mousemove", "mouseup"),
        i = t(W, ta.touch, J, "touchmove", "touchend");
      return (
        (n.origin = function (t) {
  ...
  (ta.interpolateZoom = function (n, t) {
    ...
    (ta.behavior.zoom = function () {
      ...
      function h() {
        ...
        m
          ? clearTimeout(m)
          : ((p = t((v = d || ta.mouse(this)))), I(this), a(n)),
  ...
  (ta.timer = function (n, t, e) {
    ...
    rc ? (rc.n = i) : (ec = i),
      (rc = i),
      uc || ((ic = clearTimeout(ic)), (uc = 1), ac(Lt));
  }),
  ...
  var lc =
    ...
    sc = ta.map({
      ...
      r: function (n, t) {
        return (n = ta.round(n, Dt(n, t))).toFixed(
          Math.max(0, Math.min(20, Dt(n * (1 + 1e-15), t)))
        );
      },
    }),
    fc = (ta.time = {}),
  ...
  (ta.geo.bounds = (function () {
    ...
    (ta.geo.centroid = function (n) {
      ...
      return Ra > u &&
        ...
        Ra > u)
        ? [0 / 0, 0 / 0]
        : [Math.atan2(e, t) * Ha, tt(r / Math.sqrt(u)) * Ha];
    });
  var Sc,
    kc,
    Ec,
  ...
  (ta.geo.path = function () {
    ...
    return (
      ...
      (n.projection = function (n) {
        return arguments.length
          ? ((u = (e = n) ? n.stream || er(n) : At), t())
          : e;
      }),
      (n.context = function (n) {
        return arguments.length
          ? ((i = null == (r = n) ? new Be() : new nr(n)),
    ...
    (ta.geo.projection = ir),
    (ta.geo.projectionMutator = or),
    ...
    (ta.geo.rotation = function (n) {
      ...
      return (
        (n = sr((n[0] % 360) * Fa, n[1] * Fa, n.length > 2 ? n[2] * Fa : 0)),
        (t.invert = function (t) {
          return (
    ...
    (nl.clip = function (n) {
      for (
        ...
        for (
          ...
          (o = t[e]),
            Lr(o, s, u)
              ? (Lr(i, s, u) || n.push(Tr(i, o, s, u)), n.push(o))
              : Lr(i, s, u) && n.push(Tr(i, o, s, u)),
            (i = o);
        a && n.push(n[0]), (s = u);
      }
      return n;
        ...
        if (
          ...
          do {
            ...
            if (n === u.L) {
              if (
                ((t = u.R),
                t.C && ((t.C = !1), (u.C = !0), ru(this, u), (t = u.R)),
                (t.L && t.L.C) || (t.R && t.R.C))
              ) {
                (t.R && t.R.C) ||
                  ((t.L.C = !1), (t.C = !0), uu(this, t), (t = u.R)),
                  (t.C = u.C),
                  (u.C = t.R.C = !1),
                  ru(this, u),
                  (n = this._);
              ...
              ((t = u.L),
              t.C && ((t.C = !1), (u.C = !0), uu(this, u), (t = u.L)),
              (t.L && t.L.C) || (t.R && t.R.C))
            ) {
              (t.L && t.L.C) ||
                ((t.R.C = !1), (t.C = !0), ru(this, t), (t = u.L)),
                (t.C = u.C),
                (u.C = t.L.C = !1),
                uu(this, u),
                (n = this._);
    ...
    (ta.geom.voronoi = function (n) {
      function t(n) {
        var t = new Array(n.length),
          ...
          o = a[1][1];
        return (
          ou(e(n), a).cells.forEach(function (e, a) {
            var c = e.edges,
              l = e.site,
              s = (t[a] = c.length
                ? c.map(function (n) {
      ...
      return n
        ...
        : ((t.links = function (n) {
          ...
          (t.triangles = function (n) {
            var t = [];
            return (
              ou(e(n)).cells.forEach(function (e, r) {
                for (
                  var u,
                    i,
                    o = e.site,
  ...
  (ta.geom.delaunay = function (n) {
    ...
    (ta.geom.quadtree = function (n, t, e, r, u) {
      ...
      return (o = arguments.length)
        ? ((a = lu), (c = su), 3 === o && ((u = e), (r = t), (e = t = 0)), i(n))
        : ((i.x = function (n) {
    ...
    (ta.interpolateRgb = pu),
    (ta.interpolateObject = vu),
    (ta.interpolateNumber = du),
    (ta.interpolateString = mu);
  var ll = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,
  ...
  (ta.ease = function (n) {
    ...
    return (
      (e = hl.get(e) || fl),
      (r = gl.get(r) || At),
      xu(r(e.apply(null, ea.call(arguments, 1))))
    );
  }),
    (ta.interpolateHcl = Tu),
    (ta.interpolateHsl = Ru),
    (ta.interpolateLab = Du),
    (ta.interpolateRound = Pu),
    ...
    (ta.layout.force = function () {
      ...
      return (
        (a.tick = function () {
          ...
          if (g)
            for (Gu((t = ta.geom.quadtree(m)), r, o), e = -1; ++e < b; )
          ...
          return (
            e ||
              (e = ta.behavior
                .drag()
                .origin(At)
                .on("dragstart.force", $u)
                .on("drag.force", t)
                .on("dragend.force", Bu)),
            arguments.length
              ? (this.on("mouseover.force", Wu)
                  .on("mouseout.force", Ju)
                  .call(e),
                void 0)
              : e
          );
  ...
  ta.layout.stack = function () {
    ...
    return (
      ...
      (n.order = function (t) {
        return arguments.length
          ? ((e = "function" == typeof t ? t : Ml.get(t) || ci), n)
          : e;
      }),
      (n.offset = function (t) {
        return arguments.length
          ? ((r = "function" == typeof t ? t : xl.get(t) || li), n)
          : r;
      }),
      (n.x = function (t) {
        return arguments.length ? ((i = t), n) : i;
    ...
    (ta.layout.tree = function () {
      function n(n, u) {
        var s = o.call(this, n, u),
          f = s[0],
          h = t(f);
        if ((ni(h, e), (h.parent.m = -h.z), Qu(h, r), l)) Qu(f, i);
        else {
          var g = f,
            p = f,
            v = f;
        ...
        if (t) {
          for (
            ...
            (c = Ei(c)),
              ...
              r > 0 && (Ni(zi(o, n, e), n, r), (l += r), (s += r)),
              (f += o.m),
              (l += u.m),
              (h += c.m),
              (s += i.m);
          o && !Ai(i) && ((i.t = o), (i.m += f - s)),
            u && !Ei(c) && ((c.t = u), (c.m += l - h), (e = n));
        }
        return e;
      }
      function i(n) {
          ...
          if (null != x) {
            ...
            p === H
              ? N.push(
                  ...
                  l,
                  " 0 ",
                  (1 - g) ^ fo(O[1][0], O[1][1], Y[1][0], Y[1][1]),
                  ",",
                  g,
                  " ",
                  Y[1],
  ...
  (Fl.call = ka.call),
    ...
    (Fl.node = ka.node),
    (Fl.size = ka.size),
    (ta.transition = function (n) {
      return arguments.length ? (Dl ? n.transition() : n) : Na.transition();
    }),
    (ta.transition.prototype = Fl),
    (Fl.select = function (n) {
      var t,
        e,
        r,
        u = this.id,
  ...
  var Ol = "bottom",
    Yl = { top: 1, right: 1, bottom: 1, left: 1 };
    ...
    function n(i) {
      i.each(function () {
        ...
        var s,
          f = ta.transition(i),
          h = ta.transition(o);
        c && ((s = ji(c)), h.attr("x", s[0]).attr("width", s[1] - s[0]), e(f)),
          l &&
            ((s = ji(l)), h.attr("y", s[0]).attr("height", s[1] - s[0]), r(f)),
          t(f);
      });
    }
    function t(n) {
  ...
  var Il = {
    ...
    Vl = (fc.format = mc.timeFormat),
    Xl = Vl.utc,
    $l = Xl("%Y-%m-%dT%H:%M:%S.%LZ");
  (Vl.iso =
