  ...
  (e.getListeners = function (n) {
    ...
    (e.addListener = function (r, e) {
      ...
      for (t in n)
        n.hasOwnProperty(t) &&
          -1 === i(n[t], e) &&
          n[t].push(s ? e : { listener: e, once: !1 });
      return this;
    }),
    (e.on = n("addListener")),
    (e.addOnceListener = function (e, t) {
      return this.addListener(e, { listener: t, once: !0 });
    }),
    (e.once = n("addOnceListener")),
    (e.defineEvent = function (e) {
    ...
    (e.removeListener = function (r, s) {
      ...
      for (e in t)
        t.hasOwnProperty(e) &&
          ((n = i(t[e], s)), -1 !== n && t[e].splice(n, 1));
      return this;
    }),
    (e.off = n("removeListener")),
    (e.addListeners = function (e, t) {
    ...
    (e.manipulateListeners = function (r, t, i) {
      ...
      if ("object" != typeof t || t instanceof RegExp)
        ...
        for (e in t)
          t.hasOwnProperty(e) &&
            (n = t[e]) &&
            ("function" == typeof n ? s.call(this, e, n) : o.call(this, e, n));
      return this;
    }),
    ...
    (e.emitEvent = function (r, o) {
      ...
      for (t in n)
        if (n.hasOwnProperty(t))
          for (i = n[t].length; i--; )
            (e = n[t][i]),
              e.once === !0 && this.removeListener(r, e.listener),
              (s = e.listener.apply(this, o || [])),
              s === this._getOnceReturnValue() &&
                this.removeListener(r, e.listener);
      return this;
    }),
