...
window.ParsleyConfig.i18n.tr = jQuery.extend(
  window.ParsleyConfig.i18n.tr || {},
  {
    ...
    minlength:
      "Girdiğiniz değer çok kısa. Bu alan %s değerine eşit ya da fazla olmalıdır.",
    maxlength:
      "Girdiğiniz değer çok uzun. Bu alan %s değerine eşit ya da az olmalıdır.",
    length:
      "Girdiğiniz değerin uzunluğu geçersiz. Bu alanın uzunluğu %s ve %s arasında olmalıdır.",
