define("parsley/ui", ["parsley/utils"], function (ParsleyUtils) {
  ...
  ParsleyUI.prototype = {
    ...
    reflow: function (fieldInstance) {
      ...
      if (
        ...
        true !== fieldInstance._ui.failedOnce
      )
    ...
    manageStatusClass: function (fieldInstance) {
      if (
        fieldInstance.hasConstraints() &&
        fieldInstance.needsValidation() &&
        true === fieldInstance.validationResult
      )
