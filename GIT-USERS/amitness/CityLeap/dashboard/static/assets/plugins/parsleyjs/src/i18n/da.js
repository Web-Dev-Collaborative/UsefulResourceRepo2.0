...
window.ParsleyConfig.i18n.da = jQuery.extend(
  window.ParsleyConfig.i18n.da || {},
  {
    ...
    length:
      "Længden af denne værdi er ikke korrekt. Værdien skal være mellem %s og %s tegn lang.",
