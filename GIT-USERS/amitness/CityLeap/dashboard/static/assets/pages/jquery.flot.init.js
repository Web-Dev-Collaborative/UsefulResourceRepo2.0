...
!(function ($) {
  ...
  (FlotChart.prototype.createPlotGraph = function (
    ...
    //creates Pie Chart
    (FlotChart.prototype.createPieGraph = function (
      selector,
      labels,
      datas,
      colors
    ...
    //creates Pie Chart
    (FlotChart.prototype.createDonutGraph = function (
      selector,
      labels,
      datas,
      colors
    ...
    (FlotChart.prototype.createCombineGraph = function (
      selector,
      ticks,
      labels,
      datas
    ...
    (FlotChart.prototype.init = function () {
      ...
      function updatePlot() {
        ...
        setTimeout(
          updatePlot,
          $("html").hasClass("mobile-device") ? 1000 : 1000
        );
      }
