...
def main():
    ...
    script_dir = os.path.join(SOURCE_ROOT, "vendor", "libchromiumcontent", "script")
    ...
    execute_stdout(
        [sys.executable, update, "-t", args.target_arch, "--defines", args.defines]
    )
...
def parse_args():
    ...
    parser.add_argument("--target_arch", help="Specify the arch to build for")
    parser.add_argument("--defines", default="", help="The definetions passed to gyp")
    parser.add_argument(
        "-v",
        "--verbose",
        action="store_true",
