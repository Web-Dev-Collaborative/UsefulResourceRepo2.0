...
exports.createReview = function (req, res) {
    ...
    // get the booking Id from the query
    ...
    Booking.findById(bookingId)
        ...
        .exec(async (err, foundBooking) => {
            ...
            // check the time of the booking HAS TO be before the end date of the booking so that we can book review
