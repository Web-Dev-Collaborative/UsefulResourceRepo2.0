...
exports.setRelation = function(req, res, next){
    ...
    const relationship = req.body.relationship_rel ? req.body.relationship_rel : "Unassigned";
    var heroesArr = [];
...
exports.createHero = function(req, res, next){
    ...
    const relationship = req.body.relationship ? req.body.relationship : "Unassigned";
    var heroesArr = [];
