    ...
    renderRelationShips(relationships){
        ...
        if(relationships){
            return relationships.map(relationship => {
                return(
                    <li key = {relationship._id}> {relationship.name} - {relationship.relationship}</li>
                );
            });
        }
        else {
        ...
        return(
            <div className="col span-1-of-3">
                <div className="card__main__base">
                    ...
                    <div className="card__main__base__picture">
                    ...
                    <div className="card__main__base__relationships--button" >
                        <button onClick={this.openModal.bind(this)}> Set Relationship</button>
                        <Modal
