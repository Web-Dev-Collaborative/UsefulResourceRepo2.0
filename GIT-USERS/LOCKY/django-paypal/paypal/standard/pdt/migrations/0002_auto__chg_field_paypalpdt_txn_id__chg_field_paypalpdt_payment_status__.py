...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.alter_column(
            "paypal_pdt",
            "payment_status",
            self.gf("django.db.models.fields.CharField")(max_length=17),
        )
    ...
    def backwards(self, orm):
        ...
        db.alter_column(
            "paypal_pdt",
            "txn_id",
            self.gf("models.CharField")("Transaction ID", max_length=19),
        )

        # Changing field 'PayPalPDT.payment_status'
        db.alter_column(
            "paypal_pdt", "payment_status", self.gf("models.CharField")(max_length=9)
        )
        ...
        db.alter_column(
            "paypal_pdt",
            "txn_type",
            self.gf("models.CharField")("Transaction Type", max_length=128),
        )
    ...
    models = {
        "pdt.paypalpdt": {
            ...
            "currency_code": (
                "django.db.models.fields.CharField",
                [],
                {"default": "'USD'", "max_length": "32", "blank": "True"},
            ),
            "custom": (
                "django.db.models.fields.CharField",
                [],
            ...
            "txn_id": (
                "django.db.models.fields.CharField",
                [],
                {"db_index": "True", "max_length": "19", "blank": "True"},
            ),
            "txn_type": (
                "django.db.models.fields.CharField",
                [],
