...
def get_permission_choices():
    ...
    AUTO_PERMISSIONS = getattr(
        settings, "AUTOGENERATED_PERMISSIONS", ("add", "change", "delete")
    )
...
class Group(models.Model):
    ...
    permissions = ListField(
        models.CharField(max_length=500, choices=get_permission_choices()),
    ...
    username = models.CharField(
        ...
        validators=[
            validators.RegexValidator(
                re.compile("^\d{21}$"), _("User Id should be 21 digits."), "invalid"
            )
        ],
    )
