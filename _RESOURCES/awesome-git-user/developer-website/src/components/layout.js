    ...
    return (
        <div className="layout">
            ...
            <div id="sidebar" className={sidebarClass}>
                <Link to="/"><h3 className="sidebar-link">home</h3></Link>
                <Link to="/about"><h3 className="sidebar-link">about</h3></Link>
                <Link to="/portfolio"><h3 className="sidebar-link">portfolio</h3></Link>
                <Link to="/posts"><h3 className="sidebar-link">posts</h3></Link>
